...
const AudiencesCharts = ({ dataColors, series }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="bar" height="309" className="apex-charts" />
        </React.Fragment>
    )
}
...
const AudiencesSessionsCharts = ({ dataColors, series }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="heatmap" height="400" className="apex-charts" />
        </React.Fragment>
    )
}
...
const CountriesCharts = ({ dataColors, series }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="bar" height="436" className="apex-charts" />
        </React.Fragment>
    )
}
...
const UsersByDeviceCharts = ({ dataColors, series }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="donut" height="219" className="apex-charts" />
        </React.Fragment>
    )
}
