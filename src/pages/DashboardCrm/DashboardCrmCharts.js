...
const SalesForecastCharts = ({ dataColors, series }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="bar" height="341" className="apex-charts" />
        </React.Fragment>
    )
}
...
const DealTypeCharts = ({ dataColors, series }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="radar" height="341" className="apex-charts" />
        </React.Fragment>
    )
}
...
const BalanceOverviewCharts = ({ dataColors, series }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="area" height="290" className="apex-charts" />
        </React.Fragment>
    )
}
