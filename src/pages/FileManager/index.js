...
const FileManager = () => {
    ...
    return (
        <React.Fragment>
            ...
            <DeleteModal show={deleteModal} onDeleteClick={() => handleDeleteFolder()} onCloseClick={() => setDeleteModal(false)} />
                                ...
                                <SimpleBar className="mt-3 mx-n4 px-4 file-menu-sidebar-scroll">
                                    <ul className="list-unstyled file-manager-menu">
                                        ...
                                        <li>
                                            ...
                                            >
                                                <i className="ri-image-2-line align-bottom me-2"></i> <span className="file-list-link">Media</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                            ...
                                            >
                                                <i className="ri-history-line align-bottom me-2"></i> <span className="file-list-link">Recents</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                            ...
                                            >
                                                <i className="ri-star-line align-bottom me-2"></i> <span className="file-list-link">Important</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                                            ...
                                                            <div className="d-flex gap-3 justify-content-center">
                                                                ...
                                                                <UncontrolledDropdown dir="start">
                                                                    ...
                                                                    <DropdownMenu className="dropdown-menu-end">
                                                                        ...
                                                                        <DropdownItem className="edit-list" onClick={() => handleFileClick(item)}>
                                                                            Rename
                                                                        </DropdownItem>
                                                                        <DropdownItem divider />
                                                                        <DropdownItem className="remove-list" onClick={() => onClickFileDelete(item)}>
                                                                            Delete
                                                                        </DropdownItem>
                                                                    </DropdownMenu>
                                                                </UncontrolledDropdown>
                        ...
                        <div className="file-manager-detail-content p-3 py-0 border">
                            <SimpleBar className="mx-n3 pt-3 px-3 file-detail-content-scroll">
                                <div id="folder-overview">
                                    ...
                                    <SimpleDonutCharts
                                        dataColors='["--vz-primary", "--vz-primary-rgb, 0.75", "--vz-primary-rgb, 0.60", "--vz-primary-rgb, 0.40"]'
                                        ...
                                        <div className="alert alert-danger d-flex align-items-center mb-0">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                ...
                                                <button className="btn btn-sm btn-danger">
                                                    <i className="ri-upload-cloud-line align-bottom"></i> Upgrade Now
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="file-overview" className="h-100">
                                    <div className="d-flex h-100 flex-column">
                                        ...
                                        <div className="pb-3 border-bottom border-bottom-dashed mb-3">
                                            ...
                                            <button type="button" className="btn btn-icon btn-sm btn-ghost-success float-end fs-16">
                                                <i className="ri-share-forward-line"></i>
                                            </button>
                                            <h5 className="fs-16 mb-1 file-name">{sidebarData.fileName}</h5>
                                            <p className="text-muted mb-0 fs-12">
                                                <span className="file-size">{sidebarData.size}</span>,{' '}
                                                <span className="create-date">{sidebarData.createDate}</span>
                                            </p>
                                        </div>
                                        <div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td className="file-path">
                                                                <div className="user-select-all text-truncate">*:\projects\src\assets\images</div>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
            ...
            <Modal
                ...
                tabIndex="-1"
            >
                <ModalHeader className="p-3 bg-soft-primary" id="createFolderModalLabel" toggle={() => setModalFolder(!modalFolder)}>
                    {' '}
                ...
                <ModalBody>
                    ...
                    >
                        ...
                        <div className="hstack gap-2 justify-content-end">
                            <button type="button" className="btn btn-ghost-danger" onClick={() => setModalFolder(false)}>
            ...
            <Modal id="createFileModal" isOpen={modalFile} toggle={fileToggle} modalClassName="zoomIn" centered tabIndex="-1">
                <ModalHeader toggle={fileToggle} className="p-3 bg-soft-primary">
                ...
                <ModalBody>
                    ...
                    >
                        ...
                        <div className="hstack gap-2 justify-content-end">
                            <button type="button" className="btn btn-ghost-danger" onClick={() => setModalFile(false)}>
                                <i className="ri-close-line align-bottom"></i> Close
                            </button>
