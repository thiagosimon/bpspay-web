                ...
                <Card className="card card-animate card-height-100">
                    <CardBody className="card-body">
                        <div className="d-flex justify-content-between">
                            <div>
                                <p className="fw-semibold text-muted mb-0">Successful conversions</p>
                            ...
                            <div>
                                <div className="avatar-sm flex-shrink-0">
                                    <span className="avatar-title bg-soft-success rounded-circle fs-2">
                                        <FeatherIcon icon="check-circle" className="text-success"></FeatherIcon>
                                    </span>
                                </div>
                            </div>
                        </div>
            ...
            <Col className="col-lg-4">
                <Card className="card card-animate card-height-100">
                    <CardBody className="card-body">
                        <div className="d-flex justify-content-between">
                            <div>
                                <p className="fw-semibold text-muted mb-0">Failed conversions</p>
                                <h1 className="mt-4 ff-secondary fw-bold">
                            ...
                            <div>
                                <div className="avatar-sm flex-shrink-0">
                                    <span className="avatar-title bg-soft-danger rounded-circle fs-2">
                                        <FeatherIcon icon="alert-octagon" className="text-danger"></FeatherIcon>
                                    </span>
                                </div>
                            </div>
                        </div>
