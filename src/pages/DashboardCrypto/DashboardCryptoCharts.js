...
const PortfolioCharts = ({ dataColors, series }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="donut" height="224" className="apex-charts" />
        </React.Fragment>
    )
}
...
const MarkerCharts = ({ dataColors, series }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="candlestick" height="294" className="apex-charts" />
        </React.Fragment>
    )
}
