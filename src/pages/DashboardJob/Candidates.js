...
import { Col, Card, CardBody, CardHeader, Row, UncontrolledTooltip } from 'reactstrap'
...
const Candidates = () => {
    ...
    const searchCandidate = ele => {
        ...
        if (search) {
            ...
            setCandidateList(
                candidateListData.filter(data => data.name.toUpperCase().includes(search) || data.username.toUpperCase().includes(search))
            )
        } else {
                    ...
                    <Row className="row g-0">
                        <Col className="col-lg-6">
                            <CardBody className="card-body border-end">
                                ...
                                <SimpleBar data-simplebar style={{ maxHeight: '190px' }} className="px-3 mx-n3">
                        ...
                        <Col className="col-lg-6">
                            <CardBody className="card-body text-center">
                                <div className="avatar-md mb-3 mx-auto">
                                    <img src={info.img || avtar10} alt="" id="candidate-img" className="img-thumbnail rounded-circle shadow-none" />
                                </div>
                                ...
                                <div className="d-flex gap-2 justify-content-center mb-3">
                                    ...
                                    <button type="button" className="btn avatar-xs p-0" id="dribbble">
                                        <span className="avatar-title rounded-circle bg-light text-body">
                                            <i className="ri-dribbble-fill"></i>
                                        </span>
                                        <UncontrolledTooltip placement="top" target="dribbble">
                                            {' '}
                                            Dribbble{' '}
                                        </UncontrolledTooltip>
                                    </button>
