                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="flex-shrink-0">
                                                    <h5 className={'fs-14 mb-0 text-' + invoicewidget.percentageClass}>
                                                        <i className="ri-arrow-right-up-line fs-13 align-middle"></i> {invoicewidget.percentage}
                                                    </h5>
                                                </div>
                                            </div>
                                            <div className="d-flex align-items-end justify-content-between mt-4">
                                                ...
                                                <div className="avatar-sm flex-shrink-0">
                                                    <span className="avatar-title bg-light rounded fs-3">
                                                        <FeatherIcon icon={invoicewidget.feaIcon} className="text-primary icon-dual-primary" />
                                                    </span>
                                                </div>
                                            </div>
                                        </CardBody>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-shrink-0">
                                            <div className="d-flex gap-2 flex-wrap">
                                                {isMultiDeleteButton && (
                                                    <button className="btn btn-danger me-1" onClick={() => setDeleteModalMulti(true)}>
                                                        <i className="ri-delete-bin-2-line"></i>
                                                    </button>
                                                )}
                                                <Link to="/apps-invoices-create" className="btn btn-primary">
