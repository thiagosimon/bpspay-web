...
import { CardBody, Row, Col, Card, Container, Form, Input, Label, Table, FormFeedback } from 'reactstrap'
                                                ...
                                                <Col lg={8}>
                                                    ...
                                                    <div className="mb-2">
                                                        <Input
                                                            ...
                                                            placeholder="Full Name"
                                                            invalid={
                                                                validation.errors.shipping_name && validation.touched.shipping_name ? true : false
                                                            }
                                                        />
                                                    ...
                                                    <div className="mb-2">
                                                        <Input
                                                            ...
                                                            placeholder="(123)456-7890"
                                                            invalid={
                                                                validation.errors.shipping_phone && validation.touched.shipping_phone ? true : false
                                                            }
                                                        />
                                                    ...
                                                    <div>
                                                        <Input
                                                            ...
                                                            onChange={validation.handleChange}
                                                            invalid={
                                                                validation.errors.shipping_taxno && validation.touched.shipping_taxno ? true : false
                                                            }
                                                        />
                                    ...
                                    <div className="table-responsive">
                                        <Table className="invoice-table table-borderless table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colSpan="5">
                                                        <Link to="#" className="btn btn-soft-primary fw-medium" id="add-item">
