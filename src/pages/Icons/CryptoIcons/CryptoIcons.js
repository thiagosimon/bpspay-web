                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <p className="text-muted mb-0">
                                        Use <code>&lt;img src=" assets/images/svg/crypto-icons/**.svg"&gt;</code> class.
                                    </p>
                                </CardHeader>
                                <CardBody>
                                    <Row className="icon-demo-content">
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <div className="text-muted hstack gap-2">
                                                <img src={generic} alt="" className="avatar-xxs" /> generic
                                            </div>
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <div className="text-muted hstack gap-2">
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <div className="text-muted hstack gap-2">
                                                <img src={meetone} alt="" className="avatar-xxs" /> meetone
                                            </div>
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <div className="text-muted hstack gap-2">
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <div className="text-muted hstack gap-2">
                                                <img src={safemoon} alt="" className="avatar-xxs" /> safemoon
                                            </div>
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <div className="text-muted hstack gap-2">
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <div className="text-muted hstack gap-2">
                                                <img src={sberbank} alt="" className="avatar-xxs" /> sberbank
                                            </div>
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <div className="text-muted hstack gap-2">
                                        ...
                                        <Col xl={3} lg={4} sm={6}>
                                            <div className="text-muted hstack gap-2">
                                                <img src={spacehbit} alt="" className="avatar-xxs" /> spacehbit
                                            </div>
                                        </Col>
                                        <Col xl={3} lg={4} sm={6}>
                                            <div className="text-muted hstack gap-2">
