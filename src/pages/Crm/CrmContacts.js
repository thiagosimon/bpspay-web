                    ...
                    return (
                        <ul className="list-inline hstack gap-2 mb-0">
                            ...
                            <li className="list-inline-item">
                                <UncontrolledDropdown>
                                    <DropdownToggle href="#" className="btn-soft-primary btn-sm dropdown" tag="button">
                                    ...
                                    <div className="d-flex align-items-center flex-wrap gap-2">
                                        ...
                                        <div className="flex-shrink-0">
                                            <div className="hstack text-nowrap gap-2">
                                                ...
                                                <UncontrolledDropdown>
                                                    <DropdownToggle href="#" className="btn btn-soft-secondary" tag="button">
                                        ...
                                        >
                                            <ModalBody>
                                                ...
                                                <Row className="g-3">
                                                    ...
                                                    <Col lg={6}>
                                                        <div>
                                                            <Label htmlFor="lead_score-field" className="form-label">
                                                                Lead Score
                                                            </Label>
                                                            ...
                                                            <Input
                                                                ...
                                                                invalid={validation.touched.lead_score && validation.errors.lead_score ? true : false}
                                                            />
                                                    ...
                                                    <Col lg={12}>
                                                        <div>
                                                            <Label htmlFor="taginput-choices" className="form-label font-size-13 text-muted">
                                                                Tags
                                                            </Label>
                                                            <Select
                                                                isMulti
                            ...
                            <Card id="contact-view-detail">
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted mb-4">
                                        Hello, I'm {info.name || 'Tonya Noble'}, The most effective objective is one that is tailored to the job you
                                        are applying for. It states what kind of career you are seeking, and what skills and experiences.
                                    </p>
                                        ...
                                        <Table className="table table-borderless mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {(info.tags || ['Lead', 'Partner']).map((item, key) => (
                                                            <span className="badge badge-soft-primary me-1" key={key}>
                                                                {item}
                                                            </span>
                                                        ))}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <small className="text-muted">
                                                            {handleValidTime(info.last_contacted || '2021-04-13T18:30:00.000Z')}
                                                        </small>
                                                    </td>
                                                </tr>
                                            </tbody>
