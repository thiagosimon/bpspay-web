                ...
                Cell: company => (
                    <>
                        <div className="d-flex align-items-center">
                            ...
                            <div className="flex-grow-1 ms-2 name">{company.row.original.name}</div>
                        </div>
                    </>
                )
            },
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <ExportCSVModal show={isExportCSV} onCloseClick={() => setIsExportCSV(false)} data={companies} />
                                    ...
                                    <div className="d-flex align-items-center flex-wrap gap-2">
                                        ...
                                        <div className="flex-shrink-0">
                                            <div className="hstack text-nowrap gap-2">
                                                ...
                                                <button className="btn btn-soft-primary" onClick={() => setIsExportCSV(true)}>
                                                    Export
                                                </button>
                                                <UncontrolledDropdown>
                                                    <DropdownToggle href="#" className="btn-soft-primary btn-icon" tag="button">
                                        ...
                                        >
                                            <ModalBody>
                                                ...
                                                <Row className="g-3">
                                                    ...
                                                    <Col lg={4}>
                                                        <div>
                                                            ...
                                                            <Input
                                                                ...
                                                                invalid={validation.touched.star_value && validation.errors.star_value ? true : false}
                                                            />
                                                    ...
                                                    <Col lg={4}>
                                                        <div>
                                                            <Label htmlFor="employee-field" className="form-label">
                                                                Employee
                                                            </Label>
                                                            <Input
                                                                name="employee"
                                                                ...
                                                                invalid={validation.touched.employee && validation.errors.employee ? true : false}
                                                            />
                                                    ...
                                                    <Col lg={12}>
                                                        <div>
                                                            <Label htmlFor="since-field" className="form-label">
                                                                Since
                                                            </Label>
                                                            <Input
                                                                name="since"
                                                                ...
                                                                invalid={validation.touched.since && validation.errors.since ? true : false}
                                                            />
                                ...
                                <CardBody className="text-center">
                                    <div className="position-relative d-inline-block">
                                        <div className="avatar-md">
                                            <div className="avatar-title bg-light rounded-circle">
                                                <img
                                                    src={process.env.REACT_APP_API_URL + '/images/' + (info.image_src || 'brands/mail_chimp.png')}
                                                    alt=""
                                    ...
                                    <ul className="list-inline mb-0">
                                        <li className="list-inline-item avatar-xs">
                                            <Link to="#" className="avatar-title bg-soft-success text-success fs-15 rounded">
                                                <i className="ri-global-line"></i>
                                            </Link>
                                        </li>
                                        <li className="list-inline-item avatar-xs">
                                            <Link to="#" className="avatar-title bg-soft-danger text-danger fs-15 rounded">
                                                <i className="ri-mail-line"></i>
                                            </Link>
                                        </li>
                                        <li className="list-inline-item avatar-xs">
                                            <Link to="#" className="avatar-title bg-soft-warning text-warning fs-15 rounded">
                                        ...
                                        <table className="table table-borderless mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {info.star_value || '4.0'} <i className="ri-star-fill text-warning align-bottom"></i>
                                                    </td>
                                                </tr>
                                                <tr>
