...
//Import actions
import { getLeads as onGetLeads, addNewLead as onAddNewLead, updateLead as onUpdateLead, deleteLead as onDeleteLead } from '../../../store/actions'
//redux
                ...
                Cell: leads => (
                    <>
                        <div className="d-flex align-items-center">
                            ...
                            <div className="flex-grow-1 ms-2 name">{leads.row.original.name}</div>
                        </div>
                    </>
                )
            },
                                        ...
                                        >
                                            <ModalBody>
                                                ...
                                                <Row className="g-3">
                                                    ...
                                                    <Col lg={6}>
                                                        <div>
                                                            <Label htmlFor="leads_score-field" className="form-label">
                                                                Leads Score
                                                            </Label>
                                                            <Input
                                                                name="score"
                                                                ...
                                                                invalid={validation.touched.score && validation.errors.score ? true : false}
                                                            />
                                                    ...
                                                    <Col lg={12}>
                                                        <div>
                                                            <Label htmlFor="taginput-choices" className="form-label">
                                                                Tags
                                                            </Label>
