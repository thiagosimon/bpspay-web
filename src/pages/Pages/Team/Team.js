                                ...
                                <Col className="col-sm-auto ms-auto">
                                    <div className="list-grid-nav hstack gap-1">
                                        <Button
                                            color="secondary"
                                            id="grid-view-button"
                                            className="btn btn-soft-secondary nav-link btn-icon fs-14 active filter-button"
                                        >
                                        ...
                                        <Button
                                            color="secondary"
                                            id="list-view-button"
                                            className="btn btn-soft-secondary nav-link  btn-icon fs-14 filter-button"
                                        >
                                            <i className="ri-list-unordered"></i>
                                        </Button>
                                        <Dropdown isOpen={dropdownOpen} toggle={toggledropDown}>
                                            <DropdownToggle type="button" className="btn btn-soft-secondary btn-icon fs-14">
                                        ...
                                        <Button color="primary" onClick={() => handleTeamClicks()}>
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col lg={12}>
                                                            <div className="hstack gap-2 justify-content-end">
                                                                ...
                                                                <button type="submit" className="btn btn-primary" id="addNewMember">
