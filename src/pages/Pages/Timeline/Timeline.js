                                ...
                                <div className="timeline">
                                        ...
                                        <div className="content">
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <h5 className="fs-15">
                                                        @Erica245 <small className="text-muted fs-13 fw-normal">- 10 min Ago</small>
                                                    </h5>
                                                    <p className="text-muted mb-2">
                                                        Wish someone a sincere ‘good luck in your new job’ with these sweet messages. Make sure you
                                                        pick out a good luck new job card to go with the words, and pop a beautiful bunch of flowers
                                                        from our gift range in your basket, to make them feel super special.
                                                    </p>
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            ...
                                            <p className="text-muted">
                                                Every team project can have a velzon. Use the velzon to share information with your team to understand
                                    ...
                                    <div className="timeline-item right">
                                        ...
                                        <div className="content">
                                            <h5>
                                                Donald Palmer <small className="text-muted fs-13 fw-normal">- Has changed 2 attributes</small>
                                            </h5>
                                            <p className="text-muted fst-italic mb-2">
                                                " This is an awesome admin dashboard template. It is extremely well structured and uses state of the
                                                art components (e.g. one of the only templates using boostrap 5.1.3 so far). I integrated it into a
                                                Rails 6 project. Needs manual integration work of course but the template structure made it easy. "
                                            </p>
                                            <div className="hstack gap-2">
                                    ...
                                    <div className="timeline-item left">
                                        ...
                                        <div className="content">
                                            ...
                                            <p className="text-muted">
                                                Powerful, clean & modern responsive bootstrap 5 admin template. The maximum file size for uploads in
                                                this demo :
                                            </p>
                                    ...
                                    <div className="timeline-item right">
                                        ...
                                        <div className="content">
                                            <h5>
                                                New ticket received{' '}
                                                <span className="badge bg-soft-success text-success fs-10 align-middle ms-1">Completed</span>
                                            </h5>
                                            <p className="text-muted mb-2">
                                                It is important for us that we receive email notifications when a ticket is created as our IT staff
                                                are mobile and will not always be looking at the dashboard for new tickets.
                                            </p>
                                            ...
                                            <Col xs={12}>
                                                <div className="timeline-box">
                                                    <div className="timeline-text">
                                                        <h5>Trip planning</h5>
                                                        <p className="text-muted">
                                                            In the trip planner, keep only one or two activities in a day if the purpose of the trip
                                                            is to relax and take it easy during the vacation :
                                                        </p>
                                                        <Row className="border border-dashed rounded gx-2 p-2">
                                                            <Col xs={3}>
                                                                <Link to="#">
                                                                    <img src={small7} alt="" className="img-fluid rounded" />
                                                                </Link>
                                                            </Col>
                                                            <Col xs={3}>
                                                                <Link to="#">
                                                            ...
                                                            <Col xs={3}>
                                                                <Link to="#">
                                                                    <img src={small10} alt="" className="img-fluid rounded" />
                                                                </Link>
                                                            </Col>
                                                            <Col xs={3}>
                                                                <Link to="#">
                                                                    <img src={small9} alt="" className="img-fluid rounded" />
                                                                </Link>
                                                            </Col>
                                                        </Row>
                                                    </div>
                                                ...
                                                <div className="timeline-box">
                                                    <div className="timeline-text">
                                                        ...
                                                        <p className="text-muted mb-0">
                                                            ...
                                                            and to explain any new understanding or fresh insights about the problem after you've
                                            ...
                                            <Col xs={12}>
                                                <div className="timeline-box">
                                                    <div className="timeline-text">
                                                        ...
                                                        <p className="text-muted mb-0">
                                                            A client meeting, meaning, direct collaboration and communication with a customer, is the
                                                            best way to understand their needs and how you can help support them.
                                                        </p>
                                                    </div>
                                                </div>
                                            </Col>
                        ...
                        <Col lg={12}>
                            <div>
                                ...
                                <div className="horizontal-timeline my-3">
                                    <Swiper className="timelineSlider" navigation={true} thumbs={{ swiper: thumbsSwiper }} slidesPerView={5}>
                                        <div className="swiper-wrapper">
                                            <SwiperSlide>
                                                <div className="card pt-2 border-0 item-box text-center card-border-effect-none">
