                                ...
                                <Card className="pricing-box ribbon-box right">
                                    ...
                                    <CardBody className="bg-light m-2 p-4">
                                                ...
                                                <TabContent activeTab={activeTab}>
                                                    <TabPane tabId="1">
                                                        <h2 className="month mb-0">
                                                            ${price1.rate} <small className="fs-13 text-muted">/Month</small>
                                                        </h2>
                                                    </TabPane>
                                                    <TabPane tabId="2">
                                                        <h2 className="annual mb-0">
                                                            ...
                                                            ${price1.rateYear} <small className="fs-13 text-muted">/Year</small>
                                                        </h2>
                                                    </TabPane>
                                                </TabContent>
                                            </div>
                                        ...
                                        <div className="mt-3 pt-2">
                                            <Link to="#" className={`btn btn-${price1.planButtonClassname} ${price1.btnstatus} w-100`}>
                                                {price1.btntxt}
                                            </Link>
                                        </div>
                                    </CardBody>
                        ...
                        {(pricing3 || []).map((price3, key) => (
                            <Col lg={6} key={key}>
                                <Card className="pricing-box ribbon-box ribbon-fill text-center">
                                    {price3.ribbon === true ? <div className="ribbon ribbon-primary">New</div> : ''}
                                    <Row className="g-0">
                                        <Col lg={6}>
                                            <CardBody className="h-100">
                                                ...
                                                <div className="py-4">
                                                    <h2>
                                                        ...
                                                        {price3.rate}
                                                        <span className="fs-13 text-muted"> /Per month</span>
                                                    </h2>
                                                </div>

                                                <div className="text-center plan-btn mt-2">
                                                    <Link to="#" className="btn btn-primary w-sm waves-effect waves-light">
                                                        Sign up
                                                    </Link>
                                                </div>
                                            </CardBody>
                                            ...
                                            <CardBody className="border-start mt-4 mt-lg-0">
                                                ...
                                                <CardBody className="pb-0">
                                                    <ul className="list-unstyled vstack gap-3 mb-0">
                                                        <li>
                                                            Users: <span className="text-success fw-semibold">{price3.users}</span>
                                                        </li>
                                                        <li>
                                                            Storage: <span className="text-success fw-semibold">{price3.storage} GB</span>
                                                        </li>
                                                        <li>
                                                            Domain: <span className="text-success fw-semibold">{price3.domain}</span>
                                                        </li>
                                                        <li>
                                                            Support: <span className="text-success fw-semibold">{price3.support}</span>
                                                        </li>
                                                    </ul>
                                                </CardBody>
                                            </CardBody>
