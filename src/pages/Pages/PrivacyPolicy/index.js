                                ...
                                <CardBody className="p-4">
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-grow-1">
                                            ...
                                            <p className="text-muted">
                                                ...
                                                This Privacy Policy document contains types of information that is collected and recorded by Website
                                            ...
                                            <p className="text-muted">
                                                ...
                                                with regards to the information that they shared and/or collect in Website Name. This policy is not
                                    ...
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-grow-1">
                                            ...
                                            <p className="text-muted">
                                                <b>
                                                    Website Name's Privacy Policy does not apply to other advertisers or websites. Thus, we are
