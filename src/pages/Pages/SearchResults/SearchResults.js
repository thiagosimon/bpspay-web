                                    ...
                                    <Row className="justify-content-center mb-4">
                                        <Col lg={6}>
                                            <Row className="g-2">
                                                ...
                                                <div className="col-auto">
                                                    <button type="submit" className="btn btn-primary btn-lg waves-effect waves-light">
                                        ...
                                        <Col lg={12}>
                                            <h5 className="fs-16 fw-semibold text-center mb-0">
                                                Showing results for "<span className="text-primary fw-medium fst-italic">Admin Dashboard</span> "
                                            </h5>
                                        </Col>
                                    </Row>
                                ...
                                <CardBody className="p-4">
                                    <TabContent activeTab={activeTab} className="text-muted">
                                        <TabPane tabId="1">
                                            <div className="pb-3">
                                                <h5 className="mb-1">
                                                    <Link to="#">Velzon - Responsive Bootstrap 5 Admin Dashboard</Link>
                                                </h5>
                                                <p className="text-success mb-2">https://themesbrand.com/velzon/index.html</p>
                                                <p className="text-muted mb-2">
                                                    Velzon admin is super flexible, powerful, clean, modern & responsive admin template based on{' '}
                                                    <span className="fw-semibold">bootstrap 5</span> stable with unlimited possibilities. You can
                                                    simply change to any layout or mode by changing a couple of lines of code. You can start small and
                                                    large projects or update design in your existing project using Velzon it is very quick and easy as
                                                    it is beautiful, adroit, and delivers the ultimate user experience.
                                                </p>
                                                <ul className="list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0">
                                                    <li className="list-inline-item me-3">
                                                        <i className="ri-thumb-up-line align-middle me-1"></i>10
                                                    </li>
                                                    <li className="list-inline-item me-3">
                                                        <i className="ri-question-answer-line align-middle me-1"></i>8
                                                    </li>
                                            ...
                                            <div className="py-3">
                                                <h5 className="mb-1">
                                                    <Link to="#">Skote - Admin & Dashboard Template by Themesbrand</Link>
                                                </h5>
                                                <p className="text-success mb-2">https://themesbrand.com/skote/</p>
                                                <p className="text-muted mb-2">
                                                    Skote is an admin dashboard template that is a beautifully crafted, clean & minimal designed admin
                                                    template with Dark, Light Layouts with RTL options. You can build any type of web application like
                                                    Saas based interface, eCommerce, Crypto, CRM, CMS, Project management apps, Admin Panels, etc.
                                                </p>
                                                <ul className="list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0">
                                                    <li className="list-inline-item me-3">
                                                        <i className="ri-thumb-up-line align-middle me-1"></i>485
                                                    </li>
                                                    <li className="list-inline-item me-3">
                                                        <i className="ri-question-answer-line align-middle me-1"></i>167
                                                    </li>
                                                    <li className="list-inline-item">
                                                        <div className="d-flex align-items-center">
                                                            <div className="flex-shrink-0">
                                            ...
                                            <div className="py-3">
                                                <h5 className="mb-1">
                                                    <Link to="#">Minia - React Js Admin & Dashboard Template</Link>
                                                </h5>
                                                <p className="text-success mb-2">https://themesbrand.com/minia/react/</p>
                                                <p className="text-muted mb-2">
                                                    Minia react is a simple and beautiful admin template built with Bootstrap ^5.1.3. It has{' '}
                                                    <span className="fw-semibold">5+ different layouts and 3 modes</span> ( Dark, Light & RTL ) which
                                                    are managed by SCSS only. You can simply change to any layouts or mode by changing a couple of
                                                    lines code.
                                                </p>
                                                <ul className="list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0">
                                                    <li className="list-inline-item me-3">
                                                        <i className="ri-thumb-up-line align-middle me-1"></i>69
                                                    </li>
                                                    <li className="list-inline-item me-3">
                                                        <i className="ri-question-answer-line align-middle me-1"></i>43
                                                    </li>
                                                    <li className="list-inline-item">
                                                        <div className="d-flex align-items-center">
                                                            <div className="flex-shrink-0">
                                            ...
                                            <div className="py-3">
                                                <h5 className="mb-1">
                                                    <Link to="#">Doson - Angular Admin & Dashboard Template by Themesbrand</Link>
                                                </h5>
                                                <p className="text-success mb-2">https://themesbrand.com/dason/angular/</p>
                                                <p className="text-muted mb-2">
                                                    Dason is a simple and beautiful admin template built with Bootstrap ^5.1.3. It has 5+ different
                                                    layouts and 3 modes ( Dark, Light & RTL ) which are managed by SCSS only. You can simply change to
                                                    any layouts or mode by changing a couple of lines code.
                                                </p>
                                                <ul className="list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0">
                                                    <li className="list-inline-item me-3">
                                                        <i className="ri-thumb-up-line align-middle me-1"></i>102
                                                    </li>
                                                    <li className="list-inline-item me-3">
                                                        <i className="ri-question-answer-line align-middle me-1"></i>36
                                                    </li>
                                                    <li className="list-inline-item">
                                                        <div className="d-flex align-items-center">
                                                            <div className="flex-shrink-0">
                                                                ...
                                                                <SwiperSlide key={key}>
                                                                    <div className="d-flex align-items-center border border-dashed rounded p-2">
                                                                        ...
                                                                        <div className="flex-grow-1 ms-2">
                                                                            <Link to="#" className="stretched-link fw-medium">
                                                                                {item.title}
                                                                            </Link>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div className="d-sm-flex">
                                                                    ...
                                                                    <div className="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                                                        <ul className="list-inline mb-2">
                                                                            <li className="list-inline-item">
                                                                                <span className={`badge badge-soft-${item.badgeClass} fs-11`}>
                                                                                    {item.badgeText}
                                                                                </span>
                                                                            </li>
                                                                        </ul>
                                        ...
                                        <TabPane tabId="4">
                                            <Row>
                                                ...
                                                <div className="text-center">
                                                    <button id="loadmore" className="btn btn-link text-success mt-2">
