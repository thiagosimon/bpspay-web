                                        ...
                                        <Card>
                                            <CardBody>
                                                ...
                                                <h5 className="mb-0 fs-16">
                                                    <Link to="#!">
                                                        {item.category} <span className="badge badge-soft-success">{item.quantity}</span>
                                                    </Link>
                                                </h5>
                                            </CardBody>
                                        </Card>
                            ...
                            <Card className="bg-primary" style={{ backgroundImage: `url(${BgPattern})` }}>
                                <CardBody className="p-4">
                                    ...
                                    <p className="text-white-75 mb-3">
                                        Take advantage of the first text-based NFT. Select a text or write your own and let it live forever on the
                                        Ethereum blockchain you or future owners can add text to an existing ChainText token..
                                    </p>
                                    <div className="hstack gap-2">
                                        <Link to="/apps-nft-create" className="btn btn-secondary">
                                            Create NFT
                                        </Link>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card className="overflow-hidden shadow-none border-0">
                                <CardBody className="bg-soft-primary text-primary fw-semibold d-flex">
                                    <div className="marquee">
                                        <div>
                                            <span>
                                                NFT art is a digital asset that is collectable, unique, and non-transferrable, Cortes explained. Every
                                                NFT is unique in it's creative design and cannot be duplicated, making them limited and rare. NFTs get
                                                their value because the transaction proves ownership of the art.
                                            </span>
                                            <span>
                                                NFT art is a digital asset that is collectable, unique, and non-transferrable, Cortes explained. Every
                                                NFT is unique in it's creative design and cannot be duplicated, making them limited and rare. NFTs get
                                    ...
                                    <CardBody>
                                        ...
                                        <div className="mt-3">
                                            <p className="fw-medium mb-0 float-end">
                                                <i className="mdi mdi-heart text-danger align-middle"></i> {item.likes}{' '}
                                            </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <div className="d-lg-flex align-items-center mb-4">
                                ...
                                <div className="flex-shrink-0 mt-4 mt-lg-0">
                                    <Link to="/apps-nft-creators" className="btn btn-soft-primary">
                                        View All <i className="ri-arrow-right-line align-bottom"></i>
                                    </Link>
                                </div>
                            </div>
                            ...
                            <Col key={key}>
                                <Card className="explore-box card-animate">
                                    <div className="bookmark-icon position-absolute top-0 end-0 p-2">
                                        <button type="button" className="btn btn-icon active" data-bs-toggle="button" aria-pressed="true">
                                            <i className="mdi mdi-cards-heart fs-16"></i>
                                        </button>
                                    </div>
                                    ...
                                    <div className="card-footer border-top border-top-dashed">
                                        <div className="d-flex align-items-center">
                                            <div className="flex-grow-1 fs-14">
                                                <i className="ri-price-tag-3-fill text-warning align-bottom me-1"></i> Highest:{' '}
                            ...
                            <Col key={key}>
                                <Card>
                                    ...
                                    <CardBody className="text-center">
                                        ...
                                        <div>
                                            <button className={item.isFollow ? 'btn btn-primary btn-sm' : 'btn btn-soft-primary btn-sm'}>
