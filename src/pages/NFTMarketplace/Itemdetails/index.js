                            ...
                            <Row className="g-4">
                                ...
                                <Col lg={8}>
                                    <div>
                                        ...
                                        <span className="badge badge-soft-primary mb-3 fs-12">
                                            <i className="ri-eye-line me-1 align-bottom"></i> 8,634 people views this
                                        </span>
                                        ...
                                        <div className="hstack gap-3 flex-wrap">
                                            ...
                                            <div className="text-muted">
                                                Seller : <span className="text-body fw-medium">Rickey Teran</span>
                                            </div>
                                            <div className="vr"></div>
                                            <div className="text-muted">
                                                Published : <span className="text-body fw-medium">29 April, 2022</span>
                                            </div>
                                        </div>
                                            ...
                                            <Col lg={3} sm={6}>
                                                <div className="p-2 border border-dashed rounded text-center">
                                                    <div>
                                                        ...
                                                        <h5 className="fs-17 text-primary mb-0">
                                                            <i className="mdi mdi-ethereum me-1"></i> 83.06 ETH
                                                        </h5>
                                                    </div>
                                                </div>
                                            </Col>
                                        ...
                                        <div className="mt-4 text-muted">
                                            ...
                                            <p>
                                                Cultural patterns are the similar behaviors within similar situations we witness due to shared
                                                beliefs, values, norms and social practices that are steady over time. In art, a pattern is a
                                                repetition of specific visual elements. The dictionary.com definition of "pattern" is: an arrangement
                                                of repeated or corresponding parts, decorative motifs, etc.
                                            </p>
                                        </div>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div className="d-flex align-items-center">
                                                                            ...
                                                                            <Link to="/apps-nft-item-details" className="link-dark">
                                                                                <span className="mb-0 ms-2">Brave Tigers NFT</span>
                                                                            </Link>
                                                                        </div>
                                                                    </th>
                                                                    <td>0.235 ETH</td>
                                                                    <td>
                                                                        <div className="d-flex align-items-center">
                                                                            ...
                                                                            <div className="ms-2">
                                                                                <Link to="#!">
                                                                                    <h6 className="mb-1">Alexis Clarke</h6>
                                                                                </Link>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div className="d-flex align-items-center">
                                                                            ...
                                                                            <Link to="/apps-nft-item-details" className="link-dark">
                                                                                <span className="mb-0 ms-2">Creative filtered portrait</span>
                                                                            </Link>
                                                                        </div>
                                                                    </th>
                                                                    <td>571.24 ETH</td>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div className="d-flex align-items-center">
                                                                            ...
                                                                            />
                                                                            <Link to="/apps-nft-item-details" className="link-dark">
                                                                                <span className="mb-0 ms-2">Evolved Reality</span>
                                                                            </Link>
                                                                        </div>
                                                                    </th>
                                                                    <td>130.39 ETH</td>
                                                                    <td>
                                                                        <div className="d-flex align-items-center">
                                                                            ...
                                                                            <div className="ms-2">
                                                                                <Link to="#!">
                                                                                    <h6 className="mb-1">Herbert Stokes</h6>
                                                                                </Link>
                                                                                <p className="text-muted mb-0">Creators</p>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <tr>
                                                                    <th scope="row">
                                                                        <div className="d-flex align-items-center">
                                                                            ...
                                                                            <Link to="/apps-nft-item-details" className="link-dark">
                                                                                <span className="mb-0 ms-2">Robotic Body Art</span>
                                                                            </Link>
                                                                        </div>
                                                                    </th>
                                                                    <td>81.72 ETH</td>
                                                                    <td>
                                                                        <div className="d-flex align-items-center">
                                                                            ...
                                                                            <div className="ms-2">
                                                                                <Link to="#!">
                                                                                    <h6 className="mb-1">Michael Morris</h6>
                                                                                </Link>
                                                                                <p className="text-muted mb-0">Creators</p>
                                                                            </div>
                                                                        </div>
                                                ...
                                                <TabPane id="nav-detail" tabId="3">
                                                    <div>
                                                        ...
                                                        <p>
                                                            ...
                                                            "pattern" is: an arrangement of repeated or corresponding parts, decorative motifs, etc.
                                                        </p>
                                                        <div>
                                                            <p className="mb-2">
                                                                <i className="mdi mdi-circle-medium me-1 text-muted align-middle"></i> On digital or
                                                                printed media
                                                            </p>
                                                            <p className="mb-2">
                                                                <i className="mdi mdi-circle-medium me-1 text-muted align-middle"></i> For commercial
                                                                and personal projects
                                                            </p>
                                                            <p className="mb-2">
                                                                <i className="mdi mdi-circle-medium me-1 text-muted align-middle"></i> From anywhere
                                                                in the world
                                                            </p>
                                                            <p className="mb-0">
                                                                <i className="mdi mdi-circle-medium me-1 text-muted align-middle"></i> Full copyrights
                                                                sale
                                                            </p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <div className="pb-3">
                                                            ...
                                                            <div className="text-center">
                                                                <div className="text-muted">
                                                                    Total <span className="fw-medium">7.32k</span> reviews
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <Col>
                                                                    <div className="p-2">
                                                                        <div className="progress animated-progress progress-sm">
                                                                            <div
                                                                                className="progress-bar bg-priamry"
                                                                                role="progressbar"
                                                                                style={{ width: '50.16%' }}
                                                                                aria-valuenow="50.16"
                                                                                aria-valuemin="0"
