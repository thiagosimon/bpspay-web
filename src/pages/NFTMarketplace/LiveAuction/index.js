                                            ...
                                            <ul className="nav nav-pills filter-btns" role="tablist">
                                                <li className="nav-item" role="presentation">
                                                    <button
                                                        ...
                                                        className={displayCategory === 'All' ? 'nav-link fw-medium active' : 'nav-link fw-medium'}
                                                    >
                                                        All Items
                                                    </button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button
                                                        ...
                                                        className={displayCategory === 'upto-15' ? 'nav-link fw-medium active' : 'nav-link fw-medium'}
                                                    >
                                                        Up to 15%
                                                    </button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button
                                                        ...
                                                        className={displayCategory === 'upto-30' ? 'nav-link fw-medium active' : 'nav-link fw-medium'}
                                                    >
                                                        Up to 30%
                                                    </button>
                                                </li>
                                                <li className="nav-item" role="presentation">
                                                    <button
                                                        ...
                                                        className={displayCategory === 'upto-40' ? 'nav-link fw-medium active' : 'nav-link fw-medium'}
                                                    >
                                                        Up to 40%
                                                    </button>
                                                </li>
                                            ...
                                            <Card className="explore-box card-animate">
                                                ...
                                                <CardBody>
                                                    ...
                                                    <h5 className="text-primary">
                                                        <i className="mdi mdi-ethereum"></i> {item.price} ETH{' '}
                                                    </h5>
                                            ...
                                            <tbody>
                                                {topCreator.map((item, key) => (
                                                    <tr key={key}>
                                                        ...
                                                        <td>
                                                            <button
                                                                className={item.isFollow ? 'btn btn-sm btn-primary' : 'btn btn-sm btn-soft-primary'}
                                                            >
