...
const ToDoList = () => {
    ...
    return (
        <React.Fragment>
            ...
            <DeleteModal show={deleteModal} onDeleteClick={() => handleDeleteTodo()} onCloseClick={() => setDeleteModal(false)} />
                    ...
                    <div className="chat-wrapper d-lg-flex gap-1 mx-n4 mt-n4 p-1">
                        <div className="file-manager-sidebar border">
                            <div className="p-4 d-flex flex-column h-100">
                                <div className="mb-3">
                                    <button className="btn btn-primary w-100" onClick={() => setModalProject(true)}>
                                ...
                                <SimpleBar className="px-4 mx-n4" style={{ height: 'calc(100vh - 468px)' }}>
                                    <ul className="to-do-menu list-unstyled" id="projectlist-data">
                                        {(projects || []).map((item, key) => (
                                            <li key={key}>
                                                <Link to="#" className="nav-link fs-13" id={'todos' + key}>
                                                    {item.title}
                                                </Link>
                                                <UncontrolledCollapse toggler={'#todos' + key}>
                                                    <ul className="mb-0 sub-menu list-unstyled ps-3 vstack gap-2 mb-2">
                                                        {(item.subItem || []).map((item, key) => (
                                                            <li key={key}>
                                                                <Link to="#">
                                                                    <i className={'ri-stop-mini-fill align-middle fs-15 text-' + item.iconClass}></i>{' '}
                                                                    {item.version}
                                                                </Link>
                                                            </li>
                                                        ))}
                        ...
                        <div className="file-manager-content w-100 p-4 pb-0 border">
                            <Row className="mb-4">
                                ...
                                <div className="col-sm order-3 order-sm-2 mt-3 mt-sm-0">
                                    <h5 className="fw-semibold mb-0">
                                        Velzon Admin & Dashboard <span className="badge bg-primary align-bottom ms-2">v2.0.0</span>
                                    </h5>
                                </div>
                                                            ...
                                                            <div className="d-flex align-items-start">
                                                                ...
                                                                <div className="flex-grow-1">
                                                                    <div className="form-check">
                                                                        ...
                                                                        <label className="form-check-label" htmlFor={'todo' + item.id}>
                                                                            {item.task}{' '}
                                                                        </label>
                                                                    </div>
                                                                </div>
                ...
                <ModalBody>
                    ...
                    >
                        ...
                        <div className="hstack gap-2 justify-content-end">
                            <button type="button" className="btn btn-ghost-danger" onClick={() => setModalTodo(false)}>
            ...
            >
                ...
                <ModalBody>
                    ...
                    >
                        ...
                        <div className="hstack gap-2 justify-content-end">
                            <button type="button" className="btn btn-ghost-success" onClick={() => setModalProject(false)}>
