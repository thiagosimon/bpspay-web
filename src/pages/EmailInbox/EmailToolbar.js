    ...
    return (
        <React.Fragment>
                ...
                <div className="p-4 d-flex flex-column h-100">
                    ...
                    <SimpleBar className="mx-n4 px-4 email-menu-sidebar-scroll" data-simplebar>
                        <div className="mail-list mt-3">
                            ...
                            >
                                <i className="ri-mail-fill me-3 align-middle fw-medium"></i> <span className="mail-list-link">All </span>
                            ...
                            >
                                <i className="ri-inbox-archive-fill me-3 align-middle fw-medium"></i> <span className="mail-list-link">Inbox </span>
                                <span className="badge badge-soft-success ms-auto">5</span>
                            </Link>
                            <Link
                                to="#"
                            ...
                            >
                                <i className="ri-send-plane-2-fill me-3 align-middle fw-medium"></i> <span className="mail-list-link">Sent</span>
                            </Link>
                            <Link
                                to="#"
                                onClick={() => {
                        ...
                        <div className="border-top border-top-dashed pt-3 mt-3">
                            <Link to="#" className="btn btn-icon btn-sm btn-soft-info btn-rounded float-end">
                            ...
                            <div className="mt-2 vstack email-chat-list mx-n4">
                                {chatData.map((item, key) => (
                                    <Link to="#" className="d-flex align-items-center" key={key}>
                                        ...
                                        <div className="flex-grow-1 chat-user-box overflow-hidden" onClick={() => chatBox('block', setInfo(item))}>
                                            ...
                                            <small className="text-muted text-truncate mb-0">{item.caption}</small>
                                        </div>
                                    </Link>
                                ))}
                            </div>
                            ...
                            <Col>
                                <div id="mail-filter-navlist">
                                    <Nav className="nav nav-tabs nav-tabs-custom nav-primary gap-1 text-center border-bottom-0" role="tablist">
                                        <NavItem>
                                            <NavLink
                                                className={classnames({ active: isTypeTab === 'primary' }, 'fw-semibold')}
                                                onClick={() => {
                                        ...
                                        <NavItem>
                                            <NavLink
                                                className={classnames({ active: isTypeTab === 'social' }, 'fw-semibold')}
                                                onClick={() => {
                                        ...
                                        <NavItem>
                                            <NavLink
                                                className={classnames({ active: isTypeTab === 'promotions' }, 'fw-semibold')}
                                                onClick={() => {
                                ...
                                {mailList
                                    .filter(
                                        ({ category, type, label }) =>
                                            ...
                                            (displayCategory === 'all' &&
                                                (displaytype === type || displaytype === 'all') &&
                                                (displaylabel === label || displaylabel === 'all'))
                                    )
                                    .map((item, key) => (
                                        <li className={item.unread ? 'unread' : null} key={key} id={item.forId}>
                                            <div className="col-mail col-mail-1">
                                                ...
                                                <button
                                                    type="button"
                                                    className="btn avatar-xs p-0 favourite-btn fs-15"
                                            ...
                                            >
                                                <Link to="#" className="subject">
                                                    {' '}
                                                    {item.badge ? (
                                                        <span className={'badge me-2 bg-' + item.badgeClass}>{item.badge}</span>
                                                    ) : null}{' '}
                                ...
                                <UncontrolledCollapse toggler="#email-collapseOne">
                                    <div className="accordion-body text-body px-0">
                                        <div>
                                            <p>Hi,</p>
                                            <p>
                                                Praesent dui ex, dapibus eget mauris ut, finibus vestibulum enim. Quisque arcu leo, facilisis in
                                                fringilla id, luctus in tortor.
                                            </p>
                                            <p>
                                                Sed elementum turpis eu lorem interdum, sed porttitor eros commodo. Nam eu venenatis tortor, id
                                                lacinia diam. Sed aliquam in dui et porta. Sed bibendum orci non tincidunt ultrices.
                                            </p>
                                            <p>Sincerly,</p>
                                            ...
                                            <div className="d-flex gap-3">
                                                <div className="border rounded avatar-xl h-auto">
                                                    ...
                                                    <div className="py-2 text-center">
                                                        <a href="/#" className="d-block fw-semibold">
                                                            Download
                                                        </a>
                                                    </div>
                                                </div>
                            ...
                            <div>
                                ...
                                <div className="bg-light px-2 py-1 rouned-bottom border">
                                    <Row>
                                        <Col>
                                            <ButtonGroup>
                                                <Button size="sm" color="light" className="py-0 fs-15" id="Bold1">
                                                    <i className="ri-bold align-bottom"></i>
                                                </Button>
                                                <Button size="sm" color="light" className="py-0 fs-15" id="Italic1">
                                                    <i className="ri-italic align-bottom"></i>
                                                </Button>
                                                <Button size="sm" color="light" className="py-0 fs-15" id="Link1">
                                                    <i className="ri-link align-bottom"></i>
                                                </Button>
                                                <Button size="sm" color="light" className="py-0 fs-15" id="Image1">
                                                    <i className="ri-image-2-line align-bottom"></i>
                                                </Button>
                                            </ButtonGroup>
                                            <UncontrolledTooltip placement="top" target="Bold1">
                                                {' '}
                                                Bold{' '}
                                            </UncontrolledTooltip>
                                            <UncontrolledTooltip placement="top" target="Italic1">
                                                {' '}
                                                Italic{' '}
                                            </UncontrolledTooltip>
                                            <UncontrolledTooltip placement="top" target="Link1">
                                                {' '}
                                                Link{' '}
                                            </UncontrolledTooltip>
                                            <UncontrolledTooltip placement="top" target="Image1">
                                                {' '}
                                                Image{' '}
                                            </UncontrolledTooltip>
                                        </Col>
                                        <Col className="col-auto">
                                            <UncontrolledButtonDropdown>
                                                ...
                                                <DropdownToggle tag="button" className="btn btn-success btn-sm" split></DropdownToggle>
                                                <DropdownMenu>
                                                    <DropdownItem>
                                                        <i className="ri-timer-line text-muted me-1 align-bottom" /> Schedule Send
                                                    </DropdownItem>
                                                </DropdownMenu>
                                            </UncontrolledButtonDropdown>
                                        </Col>
            ...
            <div className="email-chat-detail" id="emailchat-detailElem" style={{ display: 'block' }}>
                <Card className="mb-0 card-bg-fill">
            ...
            <Modal id="composemodal" className="modal-lg" isOpen={modal} toggle={toggle} centered>
                ...
                <ModalBody>
                    <div>
                        <div className="mb-3 position-relative">
                            <Input type="text" className="form-control email-compose-input" defaultValue="support@themesbrand.com" />
                            <div className="position-absolute top-0 end-0">
                                <div className="d-flex">
                                    <button className="btn btn-link text-reset fw-semibold px-2" type="button">
                                        Cc
                                    </button>
                                    <button className="btn btn-link text-reset fw-semibold px-2" type="button">
                                        Bcc
                        ...
                        <div className="collapse" id="CcRecipientsCollapse">
                            <div className="mb-3">
                                <label>Cc:</label>
                                <Input type="text" className="form-control" placeholder="Cc recipients" />
                            </div>
                        </div>
                        <div className="collapse" id="BccRecipientsCollapse">
                            <div className="mb-3">
                                <label>Bcc:</label>
                                <Input type="text" className="form-control" placeholder="Bcc recipients" />
                            </div>
                        </div>
                ...
                <div className="modal-footer">
                    ...
                    <UncontrolledDropdown className="btn-group">
                        ...
                        <DropdownToggle tag="button" type="button" className="btn btn-success" split>
                            <span className="visually-hidden">Toggle Dropdown</span>
                        </DropdownToggle>
                        <DropdownMenu className="dropdown-menu-end">
                            <li>
                                <DropdownItem href="#">
                                    <i className="ri-timer-line text-muted me-1 align-bottom"></i> Schedule Send
                                </DropdownItem>
                            </li>
                        </DropdownMenu>
                    </UncontrolledDropdown>
