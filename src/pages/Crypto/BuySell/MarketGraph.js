            ...
            <Col xl={12}>
                <Card className="card-height-100">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-muted text-uppercase fw-medium mb-0">
                                                ...
                                                <small className="badge badge-soft-success">
                                                    <i className="ri-arrow-right-up-line align-bottom"></i> 2.15%
                                                </small>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="d-flex">
                                        <div className="d-flex justify-content-end text-end flex-wrap gap-4 ms-auto">
                                            ...
                                            <div>
                                                ...
                                                <h5 className="text-primary mb-0">$888,411,910</h5>
                                            </div>
                                        </div>
                                    </div>
                                </Col>
                    ...
                    <CardBody className="p-0 pb-3">
                        <div dir="ltr">
                            <ReactApexChart dir="ltr" options={options} series={series} type="candlestick" height="360" className="apex-charts" />
                        </div>
                    </CardBody>
                </Card>
            </Col>
