...
import { Card, CardBody, Col, Modal, ModalBody, ModalHeader, Nav, NavItem, NavLink, Row, TabContent, TabPane, Label, Input } from 'reactstrap'
...
const KYCVerification = () => {
    ...
    return (
        <React.Fragment>
                                ...
                                <Row className="justify-content-center">
                                    <Col lg={9}>
                                        ...
                                        <p className="text-muted mt-3">
                                            When you get your KYC verification process done, you have given the crypto exchange in this case,
                                            information.{' '}
                                        </p>
                                        <div className="mt-4">
                                            <button
            ...
            <Modal isOpen={isKycVerification} toggle={toggleKycVerification} centered={true} size="lg">
                <ModalHeader className="p-3 text-uppercase" toggle={toggleKycVerification}>
                    Verify your Account
                </ModalHeader>
                                ...
                                <Row className="g-3">
                                    ...
                                    <Col lg={6}>
                                        <div>
                                            ...
                                            <Input type="text" className="form-control" id="vatNo" placeholder="Enter your VAT/TIN no" />
                                        </div>
                                    </Col>
                                    <Col lg={6}>
                                        <div>
                                            ...
                                            <Input type="text" className="form-control" id="serviceTax" placeholder="Enter your service tax no" />
                                        </div>
                                    </Col>
                                    <Col lg={12}>
                                        <div>
                                ...
                                <Row className="text-center justify-content-center">
                                    <Col lg={12}>
                                        ...
                                        <p className="text-muted mb-4">
                                            To stay verified, don't remove the meta tag form your site's home page. To avoid losing verification, you
                                            may want to add multiple methods form the <span className="fw-medium">Crypto KYC Application.</span>
                                        </p>
