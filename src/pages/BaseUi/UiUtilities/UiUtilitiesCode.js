...
const StacksVerticalExample = () => <PrismCode code={stacksVerticalCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const StacksHorizontalExample = () => <PrismCode code={stacksHorizontalCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const TextSelectionExample = () => <PrismCode code={textSelectionCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const PointerEventsExample = () => <PrismCode code={pointerEventsCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const OverflowExample = () => <PrismCode code={overflowCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const PositionExample = () => <PrismCode code={positionCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const ShadowsExample = () => <PrismCode code={shadowsCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const WidthExample = () => <PrismCode code={widthCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
