                                    ...
                                    <div className="live-preview">
                                        <div>
                                            <div>
                                                <div className="d-flex align-items-start flex-wrap gap-4">
                                                    <div className="text-center">
                                                        <img src={avatar2} className="avatar-md rounded" alt="rounded" />
                                                        <p>
                                                            <code>.rounded</code>
                                                        </p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2} className="avatar-md rounded-top" alt="rounded-top" />
                                                        <p>
                                                            <code>.rounded-top</code>
                                                        </p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2} className="avatar-md rounded-end" alt="rounded-end" />
                                                        <p>
                                                            <code>.rounded-end</code>
                                                        </p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2} className="avatar-md rounded-bottom" alt="rounded-bottom" />
                                                        <p>
                                                            <code>.rounded-bottom</code>
                                                        </p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2} className="avatar-md rounded-start" alt="rounded-start" />
                                                        <p>
                                                            <code>.rounded-start</code>
                                                        </p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar2} className="avatar-md rounded-circle" alt="rounded-circle" />
                                                        <p>
                                                    ...
                                                    <div className="text-center">
                                                        <img src={img2} className="avatar-md w-auto rounded-pill" alt="rounded-pill" />
                                                        <p>
                                            ...
                                            <div>
                                                ...
                                                <div className="d-flex align-items-start flex-wrap gap-4">
                                                    <div className="text-center">
                                                        <img src={avatar1} className="avatar-md rounded-0" alt="rounded-0" />
                                                        <p>
                                                            <code>.rounded-0</code>
                                                        </p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1} className="avatar-md rounded-1" alt="rounded-1" />
                                                        <p>
                                                            <code>.rounded-1</code>
                                                        </p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1} className="avatar-md rounded-2" alt="rounded-2" />
                                                        <p>
                                                            <code>.rounded-2</code>
                                                        </p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1} className="avatar-md rounded-3" alt="rounded-3" />
                                                        <p>
                                                            <code>.rounded-3</code>
                                                        </p>
                                                    </div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use below-mentioned class to an element to display the value of components and more with our display
                                        utilities.
                                    </p>
                                    <div className="live-preview">
                                        <div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the below-mentioned class to an element to custom display the value of components and more with our
                                        display utilities.
                                    </p>
                                    <div className="live-preview">
                                        <div>
                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted mb-3">
                                        Use <code>vstack</code> class to create vertical layouts. Stacked items are full-width by default. Use{' '}
                                        <code>gap-</code> class with variation to add space between items.
                                    </p>
                                    <div className="live-preview">
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted mb-3">
                                        Use <code>hstack</code> class to create horizontal layouts. Stacked items are full-width by default. Use{' '}
                                        <code>gap-</code> class with variation to add space between items.
                                    </p>
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted mb-3">
                                        Use <code>user-select-all</code>,<code>user-select-auto</code>, or <code>user-select-none</code> class to the
                                        content which is selected when the user interacts with it.
                                    </p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div>
                                            <p>
                                                <Link to="#" className="text-success pe-none" tabIndex="-1">
                                                    This link
                                                </Link>{' '}
                                                can not be clicked.
                                            </p>
                                                    ...
                                                    <div className="mt-4 mt-xl-0">
                                                        ...
                                                        <div className="d-md-flex bg-light">
                                                            <div className="overflow-auto p-3 mb-0 bg-light" style={{ height: '100px' }}>
                                                                ...
                                                                on an element with set width and height dimensions. By design, this content will
                                                                vertically scroll. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean
                                                    ...
                                                    <div className="mt-4 mt-xl-0">
                                                        ...
                                                        <div className="d-md-flex bg-light">
                                                            <div className="overflow-visible p-3 mb-0 bg-light" style={{ height: '100px' }}>
                                                                ...
                                                                dimensions.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        utility classes. Includes support for <code>.shadow-none</code> and three default sizes (which have associated
                                        variables to match).
                                    </p>
                                    <div className="live-preview">
                                        <Row className="gy-3">
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        <code>w-auto</code> class to set width <code>25%</code>, <code>50%</code>,<code>75%</code>, <code>100%</code>,
                                        or <code>auto</code> by default respectively.
                                    </p>
                                    <div className="live-preview">
                                        <div>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        <code>h-auto</code> class to set height <code>25%</code>, <code>50%</code>,<code>75%</code>, <code>100%</code>
                                        , or <code>auto</code> by default respectively.
                                    </p>
                                    <div className="live-preview">
