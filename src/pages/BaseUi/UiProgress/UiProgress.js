                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>color="Required Color"</code> attribute to progress bar class with the below-mentioned color
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>progress-sm</code>, <code>progress-lg</code>, or <code>progress-xl</code> class to set the different
                                        heights of progress.
                                    </p>
                                    <div className="live-preview">
                                        <div className="mb-4">
                    ...
                    <Row>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>animated-progess custom-progess progress-label</code> class to show custom progress with animation
                                        and label.
                                    </p>
                                    <div className="live-preview">
                                        <div className="d-flex align-items-center pb-2 mt-4">
                                            ...
                                            <div className="flex-grow-1">
                                                <div>
                                                    <Progress value={15} color="primary" className="animated-progess custom-progress progress-label">
                                        ...
                                        <div className="d-flex align-items-center py-2">
                                            ...
                                            <div className="flex-grow-1">
                                                <div>
                                                    <Progress value={25} color="success" className="animated-progess custom-progress progress-label">
                                        ...
                                        <div className="d-flex align-items-center py-2">
                                            ...
                                            <div className="flex-grow-1">
                                                <div>
                                                    <Progress value={50} color="info" className="animated-progess custom-progress progress-label">
                                        ...
                                        <Card className="bg-light overflow-hidden shadow-none">
                                            <CardBody>
                                                <div className="d-flex">
                                                    <div className="flex-grow-1">
                                                        <h6 className="mb-0">
                                                            <b className="text-secondary">30%</b> Update in progress...
                                                        </h6>
                                                    </div>
                                        ...
                                        <Card className="bg-light overflow-hidden shadow-none">
                                            <CardBody>
                                                <div className="d-flex">
                                                    <div className="flex-grow-1">
                                                        <h6 className="mb-0">
                                                            <b className="text-success">60%</b> Update in progress...
                                                        </h6>
                                                    </div>
                                                    <div className="flex-shrink-0">
                                        ...
                                        <Card className="bg-light overflow-hidden shadow-none">
                                            <CardBody>
                                                <div className="d-flex">
                                                    <div className="flex-grow-1">
                                                        <h6 className="mb-0">
                                                            <b className="text-danger">82%</b> Update in progress...
                                                        </h6>
                                                    </div>
                                                    <div className="flex-shrink-0">
