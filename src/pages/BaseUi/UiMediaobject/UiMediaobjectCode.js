...
const DefultExample = () => <PrismCode code={defultCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const NestingExample = () => <PrismCode code={nestingCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const MediaExample = () => <PrismCode code={mediaCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
