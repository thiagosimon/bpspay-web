                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted mb-4">
                                        ...
                                        <code>d-flex align-items-start</code> within the <code>flex-grow-1</code> of a parent media object.
                                    </p>
                                    <div className="live-preview">
                                        <div className="d-flex align-items-start text-muted mb-4">
                                            <div className="flex-shrink-0 me-3">
                                            ...
                                            <div className="flex-grow-1">
                                                ...
                                                <div className="d-flex align-items-start text-muted mt-3">
                                                    ...
                                                    <div className="flex-grow-1">
                                                        <h5 className="fs-14">Media heading</h5>
                                                        This is some content from a media component. You can replace this with any content and adjust
                                                        it as needed.
                                                    </div>
                                                </div>
                                            </div>
