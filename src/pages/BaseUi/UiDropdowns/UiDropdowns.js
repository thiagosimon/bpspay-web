                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>btn-</code> class with below mentioned variation to color dropdown toggle.
                                    </p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-3">
                                            <ButtonGroup>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>divider</code> attribute to DropdownItem to create split button dropdowns as a single button
                                        dropdown.{' '}
                                    </p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-3">
                                            <ButtonGroup>
                                                <UncontrolledButtonDropdown>
                                                    ...
                                                    <DropdownToggle tag="button" className="btn btn-primary" split></DropdownToggle>
                                                    <DropdownMenu>
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                                        <DropdownItem>Something else here</DropdownItem>
                                            ...
                                            <ButtonGroup>
                                                <UncontrolledButtonDropdown>
                                                    ...
                                                    <DropdownToggle tag="button" className="btn btn-success" split></DropdownToggle>
                                                    <DropdownMenu>
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                                        <DropdownItem>Something else here</DropdownItem>
                                            ...
                                            <ButtonGroup>
                                                <UncontrolledButtonDropdown>
                                                    ...
                                                    <DropdownToggle tag="button" className="btn btn-light" split></DropdownToggle>
                                                    <DropdownMenu>
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                                        <DropdownItem>Something else here</DropdownItem>
                                            ...
                                            <ButtonGroup>
                                                <UncontrolledButtonDropdown>
                                                    ...
                                                    <DropdownToggle tag="button" className="btn btn-secondary" split></DropdownToggle>
                                                    <DropdownMenu>
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                                        <DropdownItem>Something else here</DropdownItem>
                                            ...
                                            <ButtonGroup>
                                                <UncontrolledButtonDropdown>
                                                    ...
                                                    <DropdownToggle tag="button" className="btn btn-warning" split></DropdownToggle>
                                                    <DropdownMenu>
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                                        <DropdownItem>Something else here</DropdownItem>
                                            ...
                                            <ButtonGroup>
                                                <UncontrolledButtonDropdown>
                                                    ...
                                                    <DropdownToggle tag="button" className="btn btn-danger" split></DropdownToggle>
                                                    <DropdownMenu>
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                                        <DropdownItem>Something else here</DropdownItem>
                                            ...
                                            <ButtonGroup>
                                                <UncontrolledButtonDropdown>
                                                    ...
                                                    <DropdownToggle tag="button" className="btn btn-dark" split></DropdownToggle>
                                                    <DropdownMenu>
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                                        <DropdownItem>Something else here</DropdownItem>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>btn-lg</code> class to create a large size dropdown button and <code>btn-sm</code> to create a small
                                        ...
                                        <div className="d-flex flex-wrap gap-3 align-items-center">
                                            ...
                                            <ButtonGroup>
                                                <UncontrolledButtonDropdown>
                                                    ...
                                                    <DropdownToggle tag="button" className="btn btn-light btn-lg" split></DropdownToggle>
                                                    <DropdownMenu>
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                                        <DropdownItem>Something else here</DropdownItem>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>dropdown-menu-dark</code> class onto an existing dropdown-menu to create dropdown items dark.
                                    </p>
                                    <div className="live-preview">
                                        <UncontrolledDropdown>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Dropdown demo with various <code>dropdown alignment</code> options.
                                    </p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-3">
                                            <ButtonGroup>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>data-bs-offset</code> or <code>data-bs-reference</code> to change the position of the dropdown.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Example of dropdown menu containing <code>Headers, Text and Forms</code> content.
                                    </p>
                                    <div className="live-preview">
                                            ...
                                            <ButtonGroup>
                                                <UncontrolledDropdown>
                                                    ...
                                                    <DropdownMenu className="dropdown-menu-md p-4">
                                                        <form>
                                                            <div className="mb-2">
                                                                <label className="form-label" htmlFor="exampleDropdownFormEmail">
                                                                    Email address
                                                                </label>
                                                                <Input
                                                                    type="email"
                                                            ...
                                                            <div className="mb-2">
                                                                <label className="form-label" htmlFor="exampleDropdownFormPassword">
                                                                    Password
                                                                </label>
                                                                <Input
                                                                    type="password"
                                                            ...
                                                            <div className="mb-2">
                                                                <div className="form-check custom-checkbox">
                                                                    ...
                                                                    <label className="form-check-label" htmlFor="rememberdropdownCheck">
                                                                        Remember me
                                                                    </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <TabContent activeTab={NotificationTab} id="notificationItemsTabContent1">
                                                        <TabPane tabId="1" id="all-noti-tab2" className="py-2 ps-2">
                                                            <SimpleBar style={{ maxHeight: '300px' }} className="pe-2">
                                                                ...
                                                                <div className="my-3 text-center">
                                                                    <Button color="success" className="btn btn-soft-success">
                                                                        View All Notifications <i className="ri-arrow-right-line align-middle"></i>
                                                                    </Button>
                                                                </div>
                                                            </SimpleBar>
