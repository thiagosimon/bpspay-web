                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use<code> slide</code> class to set carousel with slides. Note the presence of the <code>d-block</code> and{' '}
                                        <code>w-100</code> class on carousel images to prevent browser default image alignment.
                                    </p>
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>carousel-control-prev</code> and <code>carousel-control-next</code> class with &lt;button&gt; or
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>carousel-indicators</code> class with &lt;ol&gt; element to show carousel with indicators.
                                    </p>
                                    <div className="live-preview">
                                        <Slidewithindicator />
                                    </div>
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>carousel-caption</code> class to add captions to the carousel.
                                    </p>
                                    <div className="live-preview">
                                        <Slidewithcaption />
                                    </div>
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>carousel-fade</code> class to the carousel to animate slides with a fade transition instead of a
                                        slide.
                                    </p>
                                    <div className="live-preview">
                                        <CrossfadeAnimation />
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>data-bs-interval=" "</code> to a carousel-item to change the amount of time to delay between
                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        the <code>data-bs-touch</code> attribute. The example below also does not include the
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>carousel-dark</code> class to the carousel for darker controls, indicators, and captions.
                                    </p>
                                    <div className="live-preview">
                                        <SlideDark />
                                    </div>
