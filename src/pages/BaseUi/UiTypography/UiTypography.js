                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <h1 className="mb-3">
                                            h1. Bootstrap heading <small className="text-muted">Semibold 2.03125rem (32.5px)</small>
                                        </h1>
                                        <h2 className="mb-3">
                                            h2. Bootstrap heading <small className="text-muted">Semibold 1.625rem (26px)</small>
                                        </h2>
                                        <h3 className="mb-3">
                                            h3. Bootstrap heading <small className="text-muted">Semibold 1.42188rem (22.8px)</small>
                                        </h3>
                                        <h4 className="mb-3">
                                            h4. Bootstrap heading <small className="text-muted">Semibold 1.21875rem (19.5px)</small>
                                        </h4>
                                        <h5 className="mb-3">
                                            h5. Bootstrap heading <small className="text-muted">Semibold 1.01563rem (16.25px)</small>
                                        </h5>
                                        <h6 className="mb-1">
                                            h6. Bootstrap heading <small className="text-muted">Semibold 0.8125rem (13px)</small>
                                        </h6>
                                    </div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>&lt;blockquote className="blockquote"&gt;</code> class for quoting blocks of content from another
                                        source within your document .
                                    </p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted text-muted">
                                        Use <code>blockquote-</code> class with the below-mentioned color variation to set the blockquote background
                                        color.
                                    </p>
                                    <div className="live-preview">
                    ...
                    <Row>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>list-unstyled</code> class Remove the default list-style and left margin on list items (immediate
                                        children only). <strong>This only applies to immediate children list items</strong>, meaning you will need to
                                        add the class for any nested lists.
                                    </p>
                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <div>
                                            <p className="text-muted">
                                                Use <code>text-break</code> class to prevent long strings of text from breaking your components'
                                                layout.
                                            </p>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>fs-1</code>, <code>fs-2</code>, <code>fs-3</code>, <code>fs-4</code>, <code>fs-5</code>, or{' '}
                                        <code>fs-6</code>, class to change the font-size respectively.
                                    </p>
                                    <div className="live-preview">
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>fst-</code>with modifier class to change font-style and Use <code>fw-</code>with modifier class to
                                        change font-weight.
                                    </p>
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>text-lowercase</code>, <code>text-uppercase</code>, or <code>text-capitalize</code> to transform the
                                        text.
                                    </p>
                                    <div className="live-preview">
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>text-decoration-underline</code>, <code>text-decoration-line-through</code>, or{' '}
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        <code>display: inline-block</code> or <code>display: block</code>.
                                    </p>

                                    <div className="live-preview">
                                        {/* <!-- Block level --> */}
                                        <Row>
                                            <div className="col-2 text-truncate">This text is quite long, and will be truncated once displayed.</div>
                                        </Row>
