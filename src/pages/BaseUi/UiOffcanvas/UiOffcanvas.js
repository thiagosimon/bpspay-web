...
const UiOffcanvas = () => {
    ...
    return (
        <React.Fragment>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>direction="start"</code> , <code>direction="top"</code>, <code>direction="bottom"</code>, or{' '}
                                        <code>direction="end"</code>, to offcanvas attribute to set different Offcanvas Placement.
                                    </p>
                                    <div className="live-preview">
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <Button className="btn btn-light" onClick={toggleEnableScroll}>
                                                Enable Body Scrolling
                                            </Button>
                                            <Button className="btn btn-light" onClick={toggleBackdrop}>
                                                Enable Backdrop (Default)
                                            </Button>
                                            <Button className="btn btn-light" onClick={toggleScrollBackDrop}>
                            ...
                            <div className="acitivity-item py-3 d-flex">
                                ...
                                <div className="flex-grow-1 ms-3">
                                    ...
                                    <p className="text-muted mb-2">
                                        <i className="ri-file-text-line align-middle ms-2"></i> Create new project Buildng product
                                    </p>
                            ...
                            <div className="acitivity-item py-3 d-flex">
                                ...
                                <div className="flex-grow-1 ms-3">
                                    <h6 className="mb-1">
                                        ...
                                        <span className="badge bg-soft-danger text-danger align-middle ms-1">Out of Delivery</span>
                                    </h6>
            ...
            {/* Top offcanvas */}
            <Offcanvas isOpen={isTop} direction="top" toggle={toggleTopCanvas} id="offcanvasTop" style={{ minHeight: '46vh' }}>
            ...
            {/* Right offcanvas */}
            <Offcanvas isOpen={isRight} direction="end" toggle={toggleRightCanvas} id="offcanvasRight" className="border-bottom">
            ...
            {/* Bottom offcanvas */}
            <Offcanvas isOpen={isBottom} direction="bottom" toggle={toggleBottomCanvas} id="offcanvasBottom" style={{ minHeight: '46vh' }}>
            ...
            {/* Left offcanvas */}
            <Offcanvas isOpen={isLeft} direction="start" toggle={toggleLeftCanvas} id="offcanvasLeft">
            ...
            {/* Enable body scrolling */}
            <Offcanvas isOpen={isEnableScroll} scrollable backdrop={false} toggle={toggleEnableScroll} id="offcanvasScrolling">
                <OffcanvasHeader toggle={toggleEnableScroll} id="offcanvasScrollingLabel" className="border-bottom">
                    Customer Activity
                </OffcanvasHeader>
                <OffcanvasBody className="p-0 overflow-hidden">
                    <div>
                            ...
                            <div className="acitivity-timeline p-4">
                                ...
                                <div className="acitivity-item py-3 d-flex">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        <h6 className="mb-1">Lewis Pratt</h6>
                                        <p className="text-muted mb-2">
                                            They all have something to say beyond the words on the page. They can come across as casual or neutral,
                                            exotic or graphic.{' '}
                                        </p>
                                        <small className="mb-0 text-muted">22 Oct</small>
                                    </div>
            ...
            {/* Enable backdrop (default) */}
            <Offcanvas isOpen={isBackdrop} toggle={toggleBackdrop} id="offcanvasWithBackdrop" className="border-bottom">
            ...
            {/* Enable both scrolling & backdrop */}
            <Offcanvas isOpen={isScrollBackDrop} scrollable toggle={toggleScrollBackDrop} id="offcanvasWithBothOptions">
