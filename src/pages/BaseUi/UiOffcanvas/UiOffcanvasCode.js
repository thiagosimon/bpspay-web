...
const DefaultOffcanvasExample = () => <PrismCode code={defaultOffcanvasCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const PlacementOffcanvasExample = () => <PrismCode code={placementOffcanvasCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const BackdropOffcanvasExample = () => <PrismCode code={backdropOffcanvasCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
