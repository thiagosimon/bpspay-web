...
const DefaultBadgesExample = () => <PrismCode code={defaultBadgesCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const SoftBadgesExample = () => <PrismCode code={softBadgesCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const OutlineBadgesExample = () => <PrismCode code={outlineBadgesCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const RoundedPillBadgesExample = () => <PrismCode code={roundedPillBadgesCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
<span className="badge rounded-pill text-bg-light text-dark">Light</span>

`

const LabelBadgesExample = () => <PrismCode code={labelPillBadgesCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const HTMLBadgesExample = () => <PrismCode code={htmlBadgesCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const RoundSoftBadgesExample = () => <PrismCode code={roundSoftBadgesCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const SoftBorderBadgesExample = () => <PrismCode code={softBorderBadgesCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const OutlinePillBadgesExample = () => <PrismCode code={outlinePillBadgesCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const ButtonPositionBadgesExample = () => <PrismCode code={buttonPositionBadgesCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const ButtonBadgesExample = () => <PrismCode code={buttonBadgesCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const GradientBadgesExample = () => <PrismCode code={gradientBadgesCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
