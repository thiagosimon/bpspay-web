                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the <code>alert-borderless</code> class to set alert without border.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the <code>UncontrolledAlert</code> tag to add dismissing button to the alert.
                                    </p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <UncontrolledAlert color="danger" className="mb-xl-0">
                                                    <strong> Something is very wrong! </strong> A simple <b>Dismissible danger alert</b> —check it
                                                    out!
                                                </UncontrolledAlert>
                                            </Col>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the <code>alert-link</code> class at &lt;a&gt; tag to show matching colored links within the given alert.
                                    </p>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div id="liveAlertPlaceholder">
                                            ...
                                            <button type="button" className="btn btn-primary" id="liveAlertBtn" onClick={() => setShow(true)}>
                                                Show live alert
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the <code>alert-outline</code> class to set an alert with outline.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the <code>alert-border-left </code> class to set an alert with the left border.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the <code>alert-label-icon</code> class to set an alert with a label icon.
                                    </p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the <code>alert-additional</code> class and Use the <code>alert-</code> class to HTML elements like
                                        headings, paragraphs, dividers etc.
                                    </p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the <code>alert-top-border</code> class to set an alert with the top border and outline.
                                    </p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the <code>alert-label-icon label-arrow</code> class to show an alert with label icon and arrow.
                                    </p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the <code>alert-label-icon rounded-label</code> class to set an alert with a rounded label icon.
                                    </p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the <code>alert-solid</code> class to set an alert with solid style.
                                    </p>
