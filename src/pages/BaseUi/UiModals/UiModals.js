    ...
    return (
        <React.Fragment>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>modal-fullscreen</code>, <code>modal-xl</code>, <code>modal-lg</code>, or <code>modal-sm</code>{' '}
                                        class to modal-dialog class to set different size modal respectively.
                                    </p>
                                    <div className="live-preview">
                                        <div>
                                            <div className="hstack flex-wrap gap-2">
                                                {/*
                                                // <!-- Fullscreen modal --> */}
                                                <Button color="primary" onClick={() => tog_fullscreen(true)}>
                                                    Fullscreen Modal
                                                </Button>
                                    ...
                                    <div className="live-preview">
                                        <div>
                                            <div className="hstack gap-2 flex-wrap">
                                                ...
                                                <Button color="primary" onClick={() => tog_fullscreen_sm()}>
                                                    Full Screen Below sm
                                                </Button>
                                                <Button color="primary" onClick={() => tog_fullscreen_md()}>
                                                    Full Screen Below md
                                                </Button>
                                                <Button color="primary" onClick={() => tog_fullscreen_lg()}>
                                                    Full Screen Below lg
                                                </Button>
                                                <Button color="primary" onClick={() => tog_fullscreen_xl()}>
                                                    Full Screen Below xl
                                                </Button>
                                                <Button color="primary" onClick={() => tog_fullscreen_xxl()}>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>fadeInRight</code>, <code>fadeInLeft</code>, <code>fadeInUp</code>, <code>flip</code>, or{' '}
                                        <code>zoomIn</code> class to modal class to set different modal with animation effect respectively.
                                    </p>
                                    <div className="live-preview">
                                        <div>
                                            <div className="hstack gap-2 flex-wrap">
                                                <Button color="primary" onClick={() => tog_animationRight()}>
                                                    Fade In Right Modal
                                                </Button>
                                                <Button color="primary" onClick={() => tog_animationLeft()}>
                                                    Fade In Left Modal
                                                </Button>
                                                <Button color="primary" onClick={() => tog_animationUp()}>
                                                    Fade In Up Modal
                                                </Button>
                                                <Button color="primary" onClick={() => tog_animationFlip()}>
                                                    Flip Modal
                                                </Button>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted text-muted">
                                        Use <code>modal-dialog-right</code>, <code>modal-dialog-bottom</code>, or{' '}
                                        <code>modal-dialog-bottom-right</code> class to modal-dialog class to set modal at different positions
                                        respectively.
                                    </p>
                                    <div className="live-preview">
                                        <div>
                                            <div className="hstack gap-2 flex-wrap">
                                                ...
                                                <Button color="secondary" onClick={() => tog_positionTopRight()}>
                                                    Top Right Modal
                                                </Button>
                                                <Button color="success" onClick={() => tog_positionBottom()}>
                                                    Bottom Modal
                                                </Button>
                                                <Button color="danger" onClick={() => tog_positionBottomRight()}>
                                                    Bottom Right Modal
                                                </Button>
                                            </div>
                                        </div>
            ...
            >
                ...
                <ModalBody className="text-center p-5">
                    ...
                    <div className="mt-4">
                        ...
                        <div className="hstack gap-2 justify-content-center">
                            <Link to="#" className="btn btn-link link-success fw-medium" onClick={() => setmodal_backdrop(false)}>
                                <i className="ri-close-line me-1 align-middle"></i> Close
                            </Link>
                            <Link to="#" className="btn btn-success" onClick={() => setmodal_backdrop(false)}>
                                Completed
                            </Link>
                        </div>
                    </div>
            ...
            >
                ...
                <ModalBody className="text-center p-5">
                    ...
                    <div className="mt-4 pt-3">
                        ...
                        <p className="text-muted mb-4">
                            Hide this modal and show the first with the button below Automatically Send your invitees a follow -Up email.
                        </p>
                        <div className="hstack gap-2 justify-content-center">
                            <Button
                                color="danger"
            ...
            >
                ...
                <ModalBody>
                    ...
                    <p className="text-muted">
                        ...
                        you do every day. So let's get started. First, some common types of fonts and what you need to know about them triggers a
                        popover on click.
                    </p>
            ...
            >
                ...
                <ModalBody>
                    ...
                    <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">
                                Too much or too little spacing, as in the example below, can make things unpleasant for the reader. The goal is to
                    ...
                    <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">
                                In some designs, you might adjust your tracking to create a certain artistic effect. It can also help you fix fonts
                    ...
                    <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">
                                For that very reason, I went on a quest and spoke to many different professional graphic designers and asked them what
                    ...
                    <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">
                                You've probably heard that opposites attract. The same is true for fonts. Don't be afraid to combine font styles that
                                are different but complementary, like sans serif with serif, short with tall, or decorative with simple. Qui photo
                                booth letterpress, commodo enim craft beer mlkshk aliquip jean shorts ullamco ad vinyl cillum PBR.
                            </p>
                        </div>
                    </div>
                    <div className="d-flex mt-2">
                    ...
                    <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">
                                Opposites attract, and that’s a fact. It’s in our nature to be interested in the unusual, and that’s why using
                                contrasting colors in Graphic Design is a must. It’s eye-catching, it makes a statement, it’s impressive graphic
                    ...
                    <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">
                                Trust fund seitan letterpress, keytar raw denim keffiyeh etsy art party before they sold out master cleanse
                    ...
                    <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">
                                Just like in the image where we talked about using multiple fonts, you can see that the background in this graphic
                                design is blurred. Whenever you put text on top of an image, it’s important that your viewers can understand.
                            </p>
                        </div>
                    </div>
                    <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">
                                Keytar raw denim keffiyeh etsy art party before they sold out master cleanse gluten-free squid scenester freegan cosby
                                sweater.
                            </p>
                        </div>
                    </div>
            ...
            >
                ...
                <div className="modal-footer">
                    <Link to="#" className="btn btn-link link-success fw-medium" onClick={() => setmodal_xlarge(false)}>
                        <i className="ri-close-line me-1 align-middle"></i> Close
                    </Link>
                    <Button color="primary">Save changes</Button>
                </div>
            ...
            >
                ...
                <div className="modal-footer">
                    <Link to="#" className="btn btn-link link-success fw-medium" onClick={() => setmodal_large(false)}>
                        <i className="ri-close-line me-1 align-middle"></i> Close
                    </Link>
                    <Button color="primary">Save changes</Button>
                </div>
            ...
            >
                ...
                <div className="modal-footer">
                    <Link to="#" className="btn btn-link link-success fw-medium" onClick={() => setmodal_small(false)}>
                        <i className="ri-close-line me-1 align-middle"></i> Close
                    </Link>
                    <Button color="primary">Save changes</Button>
                </div>
            ...
            >
                ...
                <ModalBody className="text-center p-5">
                    ...
                    <div className="mt-4">
                        ...
                        <div className="hstack gap-2 justify-content-center">
                            <Link to="#" className="btn btn-link link-success fw-medium" onClick={() => setmodal_positionBottom(false)}>
                                <i className="ri-close-line me-1 align-middle"></i> Close
                            </Link>
                            <Link to="#" className="btn btn-success">
                                Completed
            ...
            >
                ...
                <ModalBody className="text-center p-5">
                    ...
                    <div className="mt-4">
                        ...
                        <div className="hstack gap-2 justify-content-center">
                            <Link to="#" className="btn btn-link link-success fw-medium" onClick={() => setmodal_positionBottomRight(false)}>
                                <i className="ri-close-line me-1 align-middle"></i> Close
                            </Link>
                            <Link to="#" className="btn btn-success">
                                Completed
                ...
                <ModalBody className="text-center p-5">
                    ...
                    <div className="mt-2">
                        ...
                        <p className="text-muted fs-15 mb-4">
                            Successful transaction is the status of operation whose result is the payment of the amount paid by the customer in favor
                            of the merchant.
                        </p>
                        <div className="hstack gap-2 justify-content-center">
                    ...
                    <Col lg={7}>
                        <div className="modal-body p-5">
                            <h2 className="lh-base">
                                Subscribe now today to get <span className="text-danger">20% off</span> experiences!
                            </h2>
                            <p className="text-muted mb-4">
                                A free bet is a bet which is provided by a betting site for a customer to place and then benefit from the winnings.
                                Free bets are commonly used as welcome offers.
                            </p>
                            ...
                            <div className="form-check">
                                ...
                                <label className="form-check-label" htmlFor="exampleCheck1">
                                    By subscribing to a particular channel or user on YouTube, you can receive instant updates.
                                </label>
                            </div>
                        </div>
                    </Col>
            ...
            >
                ...
                <Alert color="success" className="rounded-0 mb-0">
                    <p className="mb-0">
                        Up to <span className="fw-semibold">50% OFF</span>, Hurry up before the stock ends
                    </p>
                </Alert>
                <ModalBody>
                    <form>
                        ...
                        <div className="mb-3 form-check">
                            ...
                            <label className="form-check-label" htmlFor="checkTerms">
                                I agree to the <span className="fw-semibold">Terms of Service</span> and Privacy Policy
                            </label>
                        </div>
                        <div className="text-end">
