...
const DefaultModalExample = () => <PrismCode code={defaultModalCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const CenteredModalExample = () => <PrismCode code={centeredModalCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const GridsModalExample = () => <PrismCode code={gridsModalCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const StaticBackdropModalExample = () => <PrismCode code={staticBackdropModalCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const TogglebetweenExample = () => <PrismCode code={togglebetweenCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const TooltipModalExample = () => <PrismCode code={tooltipModalCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const ScrollableModalExample = () => <PrismCode code={scrollableModalCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const VaryingModalExample = () => <PrismCode code={varyingModalCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const OptionalModalExample = () => <PrismCode code={optionalModalCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const FullscreenResponsiveExample = () => <PrismCode code={fullscreenResponsiveCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const AnimationModalExample = () => <PrismCode code={animationModalCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const PositionModalExample = () => <PrismCode code={positionModalCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
