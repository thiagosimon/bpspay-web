                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>ListGroup</code> attribute in an unordered list and <code>ListGroupItem</code> attribute to create a
                                        default list group.
                                    </p>
                                    <div className="live-preview">
                                        <ListGroup>
                                            <ListGroupItem>
                                                <i className="ri-bill-line align-middle me-2"></i> Send the billing agreement
                                            </ListGroupItem>
                                            <ListGroupItem>
                                                <i className="ri-file-copy-2-line align-middle me-2"></i>Send over all the documentation.
                                            </ListGroupItem>
                                            <ListGroupItem>
                                                <i className="ri-question-answer-line align-middle me-2"></i>Meeting with daron to review the intake
                                                form
                                            </ListGroupItem>
                                            <ListGroupItem>
                                                <i className="ri-secure-payment-line align-middle me-2"></i>Check uikings theme and give customer
                                                support
                                            </ListGroupItem>
                                        </ListGroup>
                                    </div>
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>active</code> attribute to <code>ListGroupItem</code> to indicate the current active selection.
                                    </p>
                                    <div className="live-preview">
                                        <ListGroup>
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>disabled</code> attribute to <code>ListGroupItem</code> to make it <em>appear</em> disabled.
                                    </p>
                                    <div className="live-preview">
                                        <ListGroup>
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>tag="a"</code> to create actionable list group items with hover, disabled, and active states by
                                    ...
                                    <div className="live-preview">
                                        <ListGroup className="list-group-fill-success">
                                            <ListGroupItem tag="a" to="#" className="list-group-item-action active">
                                                <i className="ri-download-2-fill align-middle me-2"></i>Category Download
                                            </ListGroupItem>
                                            <ListGroupItem tag="a" to="#" className="list-group-item-action">
                                                <i className="ri-shield-check-line align-middle me-2"></i>Security Access
                                            </ListGroupItem>
                                            <ListGroupItem tag="a" to="#" className="list-group-item-action">
                                                <i className="ri-database-2-line align-middle me-2"></i>Storage folder
                                            </ListGroupItem>
                                            <ListGroupItem tag="a" to="#" className="list-group-item-action">
                                                <i className="ri-notification-3-line align-middle me-2"></i>Push Notification
                                            </ListGroupItem>
                                            <ListGroupItem tag="a" to="#" className="list-group-item-action disabled" tabIndex="-1">
                                                <i className="ri-moon-fill align-middle me-2"></i>Dark Mode
                                            </ListGroupItem>
                                        </ListGroup>
                                    </div>
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>tag="button"</code> to create actionable list group items with hover, disabled, and active states by
                                        adding list-group-item-action.
                                    </p>
                                    <div className="live-preview">
                                        <ListGroup>
                                            <ListGroupItem tag="button" className="list-group-item-action active">
                                                <i className="ri-reply-fill align-middle me-2"></i>Reply
                                            </ListGroupItem>
                                            <ListGroupItem tag="button" className="list-group-item-action">
                                                <i className="ri-share-forward-fill align-middle me-2"></i>Forward Message
                                            </ListGroupItem>
                                            <ListGroupItem tag="button" className="list-group-item-action">
                                                <i className="ri-equalizer-line align-middle me-2"></i>Filter Message
                                            </ListGroupItem>
                                            <ListGroupItem tag="button" className="list-group-item-action">
                                                <i className="ri-delete-bin-5-line align-middle me-2"></i>Delete Message
                                            </ListGroupItem>
                                            <ListGroupItem tag="button" className="list-group-item-action" disabled>
                                                <i className="ri-forbid-line align-middle me-2"></i>Block "Mark Spencer
                                            </ListGroupItem>
                                        </ListGroup>
                                    </div>
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>flush</code> attribute to ListGroup to remove some borders and rounded corners to render list group
                                        items.
                                    </p>
                                    <div className="live-preview">
                                        <ListGroup flush>
                    ...
                    <Row>
                        <Col xl={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>horizontal</code> attribute to ListGroup to change the layout of list group items from vertical to
                    ...
                    <Row>
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>color="Required color"</code> to style list items with a stateful background and color.
                                    </p>
                                    <div className="live-preview">
                                        <ListGroup>
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>tag="a" to="#"</code> to add link. Note the addition of the hover styles here not present in the
                                        previous example.
                                    </p>
                                    <div className="live-preview">
                                        <ListGroup>
                                            ...
                                            <ListGroupItem color="primary" tag="a" to="#" className="list-group-item-action">
                                                A simple primary list group item
                                            </ListGroupItem>
                                            <ListGroupItem color="secondary" tag="a" to="#" className="list-group-item-action">
                                                A simple secondary list group item
                                            </ListGroupItem>
                                            <ListGroupItem color="success" tag="a" to="#" className="list-group-item-action">
                                                A simple success list group item
                                            </ListGroupItem>
                                            <ListGroupItem color="danger" tag="a" to="#" className="list-group-item-action">
                                                A simple danger list group item
                                            </ListGroupItem>
                                            <ListGroupItem color="warning" tag="a" to="#" className="list-group-item-action">
                                                A simple warning list group item
                                            </ListGroupItem>
                                            <ListGroupItem color="info" tag="a" to="#" className="list-group-item-action">
                                                A simple info list group item
                                            </ListGroupItem>
                                            <ListGroupItem color="light" tag="a" to="#" className="list-group-item-action">
                                                A simple light list group item
                                            </ListGroupItem>
                                            <ListGroupItem color="dark" tag="a" to="#" className="list-group-item-action">
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>list-group-fill-</code> with modifier class to style list items with a stateful background and
                                        color.
                                    </p>
                                    <div className="live-preview">
                                        <ListGroup>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        <Link to="https://getbootstrap.com/docs/5.1/utilities/flex/">flexbox utilities</Link>.
                                    </p>
                                    <div className="live-preview">
                                        <ListGroup>
                                            <ListGroupItem tag="a" to="#" className="list-group-item-action active">
                                                ...
                                                <p className="list-text mb-0">
                                                    ...
                                                    neutral, exotic or graphic. That's why it's important to think about your message, then choose a
                                                    font that fits. Cosby sweater eu banh mi, qui irure terry richardson ex squid.
                                                </p>
                                            </ListGroupItem>
                                            <ListGroupItem tag="a" to="#" className="list-group-item-action">
                                                <div className="float-end">Pending</div>
                                            ...
                                            <ListGroupItem tag="a" to="#" className="list-group-item-action">
                                                ...
                                                <p className="list-text mb-0">
                                                    Big July earthquakes confound zany experimental vow. My girl wove six dozen plaid jackets before
                                                    she quit. Six big devils from Japan quickly forgot how to waltz. try again until it looks right,
                                                    and each assumenda labore aes Homo nostrud organic, assumenda labore aesthetic magna elements,
                                                    buttons, everything.
                                                </p>
                                            </ListGroupItem>
                                            <ListGroupItem tag="a" to="#" className="list-group-item-action">
                                                ...
                                                <p className="list-text mb-0">
                                                    ...
                                                    your viewers can understand the text, and sometimes that means applying a gaussian readable.
                                                </p>
                                            </ListGroupItem>
                                        </ListGroup>
                                    </div>
                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        <Link to="https://getbootstrap.com/docs/5.1/utilities/">utilities</Link>.
                                    </p>
                                    <div className="live-preview">
                                        <ListGroup>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <ListGroup>
                                            <ListGroupItem>
                                                <i className="mdi mdi-check-bold align-middle lh-1 me-2"></i> Send the billing agreement
                                            </ListGroupItem>
                                            <ListGroupItem>
                                                <i className="mdi mdi-check-bold align-middle lh-1 me-2"></i> Send over all the documentation.
                                            </ListGroupItem>
                                            <ListGroupItem>
                                                <i className="mdi mdi-check-bold align-middle lh-1 me-2"></i> Meeting with daron to review the intake
                                                form
                                            </ListGroupItem>
                                            <ListGroupItem>
                                                <i className="mdi mdi-check-bold align-middle lh-1 me-2"></i> Check uikings theme and give customer
                                                support
                                            </ListGroupItem>
                                            <ListGroupItem>
                                                <i className="mdi mdi-check-bold align-middle lh-1 me-2"></i> Start making a presentation
                                            </ListGroupItem>
                                        </ListGroup>
                                    </div>
                        ...
                        <Col xxl={4} xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>list-group-numbered</code> class (optionally use an <code>&lt;ol&gt;</code> element) to show
