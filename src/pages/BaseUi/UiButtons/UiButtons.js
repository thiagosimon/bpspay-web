                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>outline</code> atrribute with the below-mentioned variation to create a button with the outline.
                                    </p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>btn-soft-</code> class with the below-mentioned variation to create a button with the soft
                                        background.
                                    </p>{' '}
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>btn-ghost-</code> class with the below-mentioned variation to create a button with the transparent
                                        background.
                                    </p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <Button color="primary" outline className="btn btn-ghost-primary">
                                                Primary
                                            </Button>
                                            <Button color="secondary" outline className="btn btn-ghost-secondary">
                                                Secondary
                                            </Button>
                                            <Button color="success" outline className="btn btn-ghost-success">
                                                Success
                                            </Button>
                                            <Button color="info" outline className="btn btn-ghost-info">
                                                Info
                                            </Button>
                                            <Button color="warning" outline className="btn btn-ghost-warning">
                                                Warning
                                            </Button>
                                            <Button color="danger" outline className="btn btn-ghost-danger">
                                                Danger
                                            </Button>
                                            <Button color="dark" outline className="btn btn-ghost-dark">
                                                Dark
                                            </Button>
                                        </div>
                                    </div>
                                            ...
                                            <Col lg={4}>
                                                <div className="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                                                    <Button color="primary" className="btn-label">
                                                        {' '}
                                                        <i className="ri-user-smile-line label-icon align-middle fs-16 me-2"></i> Primary{' '}
                                                    </Button>
                                                    <Button color="success" className="btn-label">
                                                        {' '}
                                                        <i className="ri-check-double-line label-icon align-middle fs-16 me-2"></i> Success{' '}
                                                    </Button>
                                                    <Button color="warning" className="btn-label">
                                                        {' '}
                                                        <i className="ri-error-warning-line label-icon align-middle fs-16 me-2"></i> Warning{' '}
                                                    </Button>
                                                </div>
                                            </Col>
                                            <Col lg={4}>
                                                <div className="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                                                    <Button color="primary" className="btn-label rounded-pill">
                                                        {' '}
                                                        <i className="ri-user-smile-line label-icon align-middle fs-16 me-2"></i> Primary{' '}
                                                    </Button>
                                                    <Button color="success" className="btn-label rounded-pill">
                                                        {' '}
                                                        <i className="ri-check-double-line label-icon align-middle fs-16 me-2"></i> Success{' '}
                                                    </Button>
                                                    <Button color="warning" className="btn-label rounded-pill">
                                                        {' '}
                                                        <i className="ri-error-warning-line label-icon align-middle fs-16 me-2"></i> Warning{' '}
                                                    </Button>
                                                </div>
                                            ...
                                            <Col lg={4}>
                                                <div className="d-flex flex-wrap gap-2">
                                                    <Button color="primary" className="btn-label right">
                                                        {' '}
                                                        <i className="ri-user-smile-line label-icon align-middle fs-16 ms-2"></i> Primary{' '}
                                                    </Button>
                                                    <Button color="success" className="btn-label right rounded-pill">
                                                        {' '}
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            ...
                                            <Col lg={6}>
                                                <div className="hstack flex-wrap gap-2 mb-3 mb-lg-0">
                                                    <Button color="primary" outline className="btn-border">
                                                        Primary
                                                    </Button>
                                                    <Button color="secondary" outline className="btn-border">
                                                        Secondary
                                                    </Button>
                                                    <Button color="success" outline className="btn-border">
                                                        Success
                                                    </Button>
                                                ...
                                                <div className="d-flex flex-wrap align-items-center gap-2">
                                                    <Button color="primary" className="custom-toggle active" onClick={e => favouriteBtn(e.target)}>
                                                        <span className="icon-on">
                                                            <i className="ri-alarm-line align-bottom"></i> Active
                                                        </span>
                                                    ...
                                                    <Button color="secondary" className="custom-toggle active" onClick={e => favouriteBtn(e.target)}>
                                                        <span className="icon-on">
                                                            <i className="ri-user-add-line align-bottom me-1"></i> Connect
                                                        </span>
                                                        <span className="icon-off">
                                                            <i className="ri-check-fill align-bottom me-1"></i> Unconnect
                                                        </span>
                                                    </Button>
                                                    <Button color="success" className="custom-toggle" onClick={e => favouriteBtn(e.target)}>
                                                        <span className="icon-on">
                                                            <i className="ri-thumb-up-line align-bottom me-1"></i> Yes
                                                        </span>
                                                        <span className="icon-off">
                                                            <i className="ri-thumb-down-line align-bottom me-1"></i> No
                                                        </span>
                                                    </Button>
                                                    <Button color="warning" className="custom-toggle active" onClick={e => favouriteBtn(e.target)}>
                                                        ...
                                                        <span className="icon-off">
                                                            <i className="ri-user-unfollow-line align-bottom me-1"></i> Unfollow
                                                        </span>
                                                    </Button>
                                                    ...
                                                    <Button color="dark" className="custom-toggle" onClick={e => favouriteBtn(e.target)}>
                                                        <span className="icon-on">
                                                            <i className="ri-bookmark-line align-bottom me-1"></i> Bookmark
                                                        </span>
                                                        <span className="icon-off">
                                                            <i className="ri-bookmark-3-fill align-bottom me-1"></i> Unbookmark
                                                        </span>
                                                    </Button>
                                                </div>
                                            </Col>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>btn-lg</code> class to create a large size button and <code>btn-sm</code> class to create a small
                                        size button.
                                    </p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap align-items-center gap-2">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>btn</code> class with different HTML elements. (though some browsers may apply a slightly different
                                        rendering)
                                    </p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="d-none code-view">
                                        <pre className="language-markup">
                                            <code>
                                                &lt;!-- Toggle Button Status --&gt; &lt;button type=&quot;button&quot; className=&quot;btn btn-primary
                                                waves-effect waves-light&quot; data-bs-toggle=&quot;button&quot; aria-pressed=&quot;false&quot;&gt;
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        <a href="https://getbootstrap.com/docs/5.1/forms/checks-radios/">toggle buttons</a> into a seamless looking
                                        button group.
                                    </p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap align-items-center gap-2">
                                            ...
                                            <ButtonGroup>
                                                ...
                                                <Button color="secondary" className="mb-0" id="btnradio1" outline>
                                                    {' '}
                                                    Radio 1{' '}
                                                </Button>

                                                <Input type="radio" className="btn-check" name="btnradio" id="btnradio2" />
                                                <Button color="secondary" className="mb-0" id="btnradio2" outline>
                                                    {' '}
                                                    Radio 2{' '}
                                                </Button>

                                                <Input type="radio" className="btn-check" name="btnradio" id="btnradio3" />
                                                <Button color="secondary" className="mb-0" id="btnradio3" outline>
                                                    {' '}
                                                    Radio 3{' '}
                                                </Button>
                                            </ButtonGroup>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>btn-group-</code> class with the below-mentioned variation to set the different sizes of button
                                        groups.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Make a set of buttons appear <code>vertically</code> stacked .Split button dropdowns are not supported here.
                                    </p>
                                    <div className="live-preview">
                                        <Row>
                                            ...
                                            <div className="col-auto">
                                                <ButtonGroup vertical>
                                                    ...
                                                    <Button color="secondary" htmlFor="vbtn-radio1" outline>
                                                        Radio 1
                                                    </Button>
                                                    <Input type="radio" className="btn-check" name="vbtn" id="vbtn-radio2" />
                                                    <Button color="secondary" htmlFor="vbtn-radio2" outline>
                                                        Radio 2
                                                    </Button>
                                                    <Input type="radio" className="btn-check" name="vbtn" id="vbtn-radio3" />
                                                    <Button color="secondary" htmlFor="vbtn-radio3" outline>
                                                        Radio 3
                                                    </Button>
                                                </ButtonGroup>
                                            </div>
