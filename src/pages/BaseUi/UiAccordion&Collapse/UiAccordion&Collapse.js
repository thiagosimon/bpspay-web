                                        ...
                                        <Accordion id="default-accordion-example">
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={col1} className="accordion-collapse" id="collapseOne">
                                                    <div className="accordion-body">
                                                        Although you probably won’t get into any legal trouble if you do it just once, why risk it? If
                                                        you made your subscribers a promise, you should honor that. If not, you run the risk of a
                                                        drastic increase in opt outs, which will only hurt you in the long run.
                                                    </div>
                                                </Collapse>
                                            </AccordionItem>
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={col2} className="accordion-collapse">
                                                    <div className="accordion-body">
                                                        No charges are put in place by SlickText when subscribers join your text list. This does not
                                                        mean however that charges 100% will not occur. Charges that may occur fall under part of the
                                            ...
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={col3} className="accordion-collapse">
                                                    <div className="accordion-body">
                                                        Now that you have a general idea of the amount of texts you will need per month, simply find a
                                                        plan size that allows you to have this allotment, plus some extra for growth. Don't worry,
                                                        there are no mistakes to be made here. You can always upgrade and downgrade.
                                                    </div>
                                                </Collapse>
                                            </AccordionItem>
                                        </Accordion>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>accordion-flush</code> class to remove the default background-color, some borders, and some rounded
                                        ...
                                        <Accordion id="default-accordion-example" flush>
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={col4} className="accordion-collapse" id="collapseOne">
                                                    <div className="accordion-body">
                                                        The renewal of your SlickText service happens on the anniversary of your original paid sign up
                                                        date. Upgrading in the middle of your billing period will not change the billing date.
                                                        Upgrading does however force an immediate, pro-rated charge to take place on your account.
                                                    </div>
                                                </Collapse>
                                            </AccordionItem>
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={col5} className="accordion-collapse">
                                                    <div className="accordion-body">
                                                        If you had signed up on a free account with Slicktext, then upgraded to a paid plan at a later
                                                        date, your bill will renew based on the date you had upgraded to a paid plan. All invoices are
                                                        able to be viewed under your plan options in your SlickText account.
                                                    </div>
                                                </Collapse>
                                            </AccordionItem>
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={col6} className="accordion-collapse">
                                                    <div className="accordion-body">
                                                        No, we cannot provide this information. Opting out from a list is an anonymous, private act.
                                                        This prevents further harassment. Providing this information is considered bad practice, and
                                                        further communication after they opt out would be considered against compliance.
                                                    </div>
                                                </Collapse>
                                            </AccordionItem>
                                        </Accordion>
                                            ...
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={iconCol1} className="accordion-collapse" id="collapseOne">
                                                    <div className="accordion-body">
                                                        ...
                                                        looks right, and each assumenda labore aes Homo nostrud organic, assumenda labore aesthetic
                                            ...
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={iconCol2} className="accordion-collapse">
                                                    <div className="accordion-body">
                                                        ...
                                                        augue velit cursus nunc, quis gravida magna mi a libero. Fusce vulputate eleifend sapien.
                                                    </div>
                                                </Collapse>
                                            </AccordionItem>
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={iconCol3} className="accordion-collapse">
                                                    <div className="accordion-body">
                                                        ...
                                                        turpis et arcu arcu tortor, suscipit eget, imperdiet nec, imperdiet iaculis aliquam ultrices
                                                        mauris.
                                                    </div>
                                                </Collapse>
                                            </AccordionItem>
                                            ...
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={iconCol4} className="accordion-collapse" id="accor_withouticoncollapse1">
                                                    <div className="accordion-body">
                                                        ...
                                                        opportunity to be creative and make your own style choices. For that very reason, I went on a
                                            ...
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={iconCol5} className="accordion-collapse" id="accor_withouticoncollapse2">
                                                    <div className="accordion-body">
                                                        ...
                                                        I lie close to the earth, a thousand unknown.
                                                    </div>
                                                </Collapse>
                                            </AccordionItem>
                                            <AccordionItem>
                                            ...
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={plusiconCol1} className="accordion-collapse" id="accor_plusExamplecollapse1">
                                                    <div className="accordion-body">
                                                        ...
                                                        before she quit. Six big devils from Japan quickly forgot how to waltz. try again until it
                                                        looks right, and each assumenda labore aes Homo nostrud organic, assumenda labore aesthetic
                                                        magna elements, buttons, everything.
                                                    </div>
                                                </Collapse>
                                            ...
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={plusiconCol2} className="accordion-collapse" id="accor_plusExamplecollapse2">
                                                    <div className="accordion-body">
                                                        ...
                                                        perfect spot of its own. commodo enim craft beer mlkshk aliquip jean shorts ullamco.
                                                    </div>
                                                </Collapse>
                                            </AccordionItem>
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={plusiconCol3} className="accordion-collapse" id="accor_plusExamplecollapse3">
                                                    <div className="accordion-body">
                                                        Spacing depending on the situation and try, try again until it looks right, and each. next
                                                        level wes anderson artisan four loko farm-to-table craft beer twee. commodo enim craft beer
                                                        mlkshk aliquip jean shorts ullamco. omo nostrud organic, assumenda labore aesthetic magna
                                            ...
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={lefticonCol1} className="accordion-collapse" id="accor_lefticonExamplecollapse1">
                                                    <div className="accordion-body">
                                                        ...
                                                        nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua nulla assumenda shoreditch
                                                        et.
                                                    </div>
                                                </Collapse>
                                            </AccordionItem>
                                        ...
                                        <Accordion className="custom-accordionwithicon accordion-border-box" id="accordionnesting">
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={nestingCol1} className="accordion-collapse" id="accor_nestingExamplecollapse1">
                                                    <div className="accordion-body">
                                                        This opt in method is perfect for those looking to integrate a different software such Shopify
                                                        or Hubspot with Slicktext. For example, upon cashing out online, a subscriber may submit to
                                                        have their mobile number to receive marketing messages. The API will pass this information
                                                        ...
                                                        >
                                                            <AccordionItem>
                                                                ...
                                                                >
                                                                    <div className="accordion-body">
                                                                        When you are in need of finding a specific subscriber, you will want to use
                                                                        the help of SlickText's search navigation tool, located under the Contacts tab
                                                                        of your Slicktext account. Once here, you will have options to sort by,
                                                            ...
                                                            <AccordionItem>
                                                                ...
                                                                <Collapse isOpen={anestingCol2} className="accordion-collapse">
                                                                    <div className="accordion-body">
                                                                        Opting out a subscriber will allow SlickText to maintain the history of the
                                                                        subscriber as it pertains to the textword you are opting them out of. If this
                                                                        user was to text to join again, the initial text they are met with will be a
                                                                        "welcome back" message instead of the auto reply.
                                                                    </div>
                                                                </Collapse>
                                                            </AccordionItem>
                                                        </div>
                                            ...
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={nestingCol2} className="accordion-collapse">
                                                    <div className="accordion-body">
                                                        Personalization allows you to provide a personal touch to your outbound text marketing
                                                        campaigns. SlickText uses merge tags as placeholders that are replaced with contact-specific
                                                        information when a text message is sent. These merge tags may also be known as personalization
                                                        fields.
                                                        <div
                                            ...
                                            <AccordionItem>
                                                ...
                                                <Collapse isOpen={nestingCol3} className="accordion-collapse">
                                                    <div className="accordion-body">
                                                        When you run out of messages, you will not be able to send any outbound campaigns. This would
                                                        include any scheduled messages, drip campaigns, and birthday messages. However, we will
                                                        continue to deliver your auto-reply messages to allow your subscriber list to continue to
                                                        grow.
                                                    </div>
                                                </Collapse>
                                            </AccordionItem>
                                                ...
                                                <Accordion className="custom-accordionwithicon accordion-fill-success" id="accordionFill">
                                                    <AccordionItem>
                                                        ...
                                                        <Collapse isOpen={fillCol1} className="accordion-collapse" id="accor_fill1">
                                                            <div className="accordion-body">
                                                                Webhooks allow you to gather real time data on key interactions that happen with your
                                                                Slick Text account. Simply provide us with a url where you'd like the data to be sent,
                                                                choose which events you'd like to be informed of, and click save.{' '}
                                                            </div>
                                                        </Collapse>
                                                    </AccordionItem>
                                                    <AccordionItem>
                                                        ...
                                                        <Collapse isOpen={fillCol2} className="accordion-collapse" id="accor_fill2">
                                                            <div className="accordion-body">
                                                                Head over to the Textwords page. Click options on the right hand side, and then click
                                                                Settings. This will redirect you to your Textword Setting page. Now, go check your
                                                                url, and the textword ID will be the number after "word=". Too much or too little
                                                    ...
                                                    <AccordionItem>
                                                        ...
                                                        <Collapse isOpen={fillCol5} className="accordion-collapse" id="accor_fill22">
                                                            <div className="accordion-body">
                                                                ...
                                                                design, and tie them all together and make them work. In an awareness campaign, it is
                                                                vital for people to begin put 2 and 2 together and begin to recognize your cause.
                                                    ...
                                                    <AccordionItem>
                                                        ...
                                                        <Collapse isOpen={fillCol6} className="accordion-collapse" id="accor_fill23">
                                                            <div className="accordion-body">
                                                                ...
                                                                lacinia. Nam pretium turpis et arcu arcu tortor, suscipit eget, imperdiet nec,
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <div className="d-flex gap-2 flex-wrap mb-3">
                                            ...
                                            <Button color="primary" onClick={t_coll1} style={{ cursor: 'pointer' }}>
                                        ...
                                        <Collapse isOpen={coll1} id="collapseExample">
                                            <div className="card mb-0">
                                                <CardBody>
                                                    When designing, the goal is to draw someone’s attention and portray to them what you’re trying to
                                                    say. You can make a big statement by using little tricks, like this one. Use contrasting fonts.
                                                    you can use a bold sanserif font with a cursive.
                                                </CardBody>
                                            </div>
                                        </Collapse>
                                    </div>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <p>
                                            <Button onClick={t_coll2} color="primary" style={{ cursor: 'pointer' }}>
                                                {' '}
                    ...
                    <Row>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Collapse isOpen={coll6} id="collapseWithicon">
                                            <div className="card mb-0">
                                                <CardBody>
                                                    If you enter text including symbols in the search criteria, the search criteria is interpreted
                                                    exactly as you entered it, and the search is case sensitive as a case insensitive search that
                                                    contains certain text but does also provide a lot of search criteria options.
                                                </CardBody>
                                            </div>
                                        </Collapse>
                                        <Collapse isOpen={coll7} id="collapseWithicon2">
                                            <div className="card mb-0 mt-3">
                                                <CardBody>
                                                    When you want to search for data, such as customer names, addresses, or product groups, you enter
                                                    criteria. In search criteria you can use all the numbers and letters that you normally use in the
                                                    specific field. In addition, you can use special symbols to further filter the results.
                                                </CardBody>
                                            </div>
                                        </Collapse>
                                    </div>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Inline element collapse takes all horizontal space hence you can activate the collapse within by clicking on
                                        full-width horizontal space. Block element collapse can be activated by clicking on collapse toggle only.
                                    </p>
                                    <div className="live-preview">
                                        <div className="mb-3">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        A <code>&lt;button&gt;</code> or <code>&lt;a&gt;</code> can show and hide multiple elements by referencing
                                        them with a selector in its href or data-bs-target attribute. Multiple <code>&lt;button&gt;</code> or{' '}
                                        <code>&lt;a&gt;</code> can show and hide an element if they each reference it with their href or
                                        data-bs-target attribute.
                                    </p>
                                    <div className="live-preview">
                                        <div className="d-flex gap-2 flex-wrap mb-3">
                                            <Link to="#" onClick={t_coll3} style={{ cursor: 'pointer' }} className="btn btn-primary">
                                                {' '}
                                                Toggle First Element{' '}
                                            </Link>
                                            <Button onClick={t_coll4} color="primary" style={{ cursor: 'pointer' }}>
                                                {' '}
                                                Toggle Second Element{' '}
                                            </Button>
                                            <Button onClick={t_coll5} color="primary" style={{ cursor: 'pointer' }}>
                                                {' '}
