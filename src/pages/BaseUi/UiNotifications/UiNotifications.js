...
const UiNotifications = () => {
    ...
    const defaultnotify = () =>
        toast('Welcome Back! This is a Toast Notification', { position: 'top-right', hideProgressBar: true, className: 'bg-primary text-white' })
    const successnotify = () =>
    ...
    const errornotify = () =>
        toast('Error ! An error occurred.', { position: 'top-center', hideProgressBar: true, closeOnClick: false, className: 'bg-danger text-white' })

    const topleftnotify = () =>
        toast('Welcome Back ! This is a Toast Notification', { position: 'top-left', hideProgressBar: true, className: 'bg-success text-white' })
    const topcenternotify = () =>
        toast('Welcome Back ! This is a Toast Notification', { position: 'top-center', hideProgressBar: true, className: 'bg-success text-white' })
    const toprightnotify = () =>
        toast('Welcome Back ! This is a Toast Notification', { position: 'top-right', hideProgressBar: true, className: 'bg-success text-white' })
    const bottomleftnotify = () =>
        toast('Welcome Back ! This is a Toast Notification', { position: 'bottom-left', hideProgressBar: true, className: 'bg-success text-white' })
    const bottomcenternotify = () =>
        toast('Welcome Back ! This is a Toast Notification', { position: 'bottom-center', hideProgressBar: true, className: 'bg-success text-white' })
    const bottomrightnotify = () =>
        toast('Welcome Back ! This is a Toast Notification', { position: 'bottom-right', hideProgressBar: true, className: 'bg-success text-white' })

    const offsetnotify = () =>
        toast('Welcome Back ! This is a Toast Notification', { position: 'top-right', hideProgressBar: true, className: 'bg-success text-white m-5' })
                                        ...
                                        <div className="mt-5">
                                            ...
                                            <Row className="g-3">
                                                <Col xxl={6}>
                                                    <div>
                                                        <p className="text-muted">
                                                            ...
                                                            time, put the positioning styles right on the <code>.toast</code>.
                                                        </p>
                                                ...
                                                <Col xxl={6}>
                                                    <div>
                                                        <p className="text-muted">
                                                            You can also get fancy with flexbox utilities to align toasts horizontally and/or
                                                            vertically.
                                                        </p>
                                                        <div
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>toast-border-</code> with below-mentioned color variation to set a toast with border and icon.
                                    </p>
                                    <div className="live-preview">
                                        <div className="position-relative">
                                            <div className="hstack flex-wrap gap-2">
                                                ...
                                                <Button className="btn btn-success" id="borderedToast2Btn" onClick={() => setToast8(!toast8)}>
                                                    Success Toast
                                                </Button>
                                                <Button className="btn btn-warning" id="borderedTost3Btn" onClick={() => setToast9(!toast9)}>
                                                    Warning Toast
                                                </Button>
                                                <Button className="btn btn-danger" id="borderedToast4Btn" onClick={() => setToast10(!toast10)}>
                                                    Danger Toast
                                                </Button>
                                            </div>
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <div className="hstack flex-wrap gap-2">
                                            <Button color="light" className="w-xs" onClick={defaultnotify}>
                                                Default
                                            </Button>
                                            <Button color="light" className="w-xs" onClick={successnotify}>
                                                Success
                                            </Button>
                                            <Button color="light" className="w-xs" onClick={warningnotify}>
                                                Warning
                                            </Button>
                                            <Button color="light" className="w-xs" onClick={errornotify}>
                                                Error
                                            </Button>
                                            <ToastContainer />
                                        </div>
                                        <div className="mt-4 pt-2">
                                            ...
                                            <div className="hstack flex-wrap gap-2">
                                                <Button color="light" className="w-xs" onClick={topleftnotify}>
                                                    Top Left
                                                </Button>
                                                <Button color="light" className="w-xs" onClick={topcenternotify}>
                                                    Top Center
                                                </Button>
                                                <Button color="light" className="w-xs" onClick={toprightnotify}>
                                                    Top Right
                                                </Button>
                                                <Button color="light" className="w-xs" onClick={bottomleftnotify}>
                                                    Bottom Left
                                                </Button>
                                                <Button color="light" className="w-xs" onClick={bottomcenternotify}>
                                                    Bottom Center
                                                </Button>
                                                <Button color="light" className="w-xs" onClick={bottomrightnotify}>
                                                    Bottom Right
                                                </Button>
                                            </div>
                                        </div>
                                        ...
                                        <Row className="mt-3">
                                            <Col lg={4}>
                                                <div className="mt-4">
                                                    ...
                                                    <div className="d-flex align-items-center flex-wrap gap-2">
                                                        <Button color="light" className="w-xs" onClick={offsetnotify}>
                                                            Click Me
                                                        </Button>
                                                    </div>
                                                </div>
                                            ...
                                            <Col lg={4}>
                                                <div className="mt-4">
                                                    ...
                                                    <div className="d-flex align-items-center flex-wrap gap-2">
                                                        <Button color="light" className="w-xs" onClick={closeiconnotify}>
                                                            Click Me
                                                        </Button>
                                                    </div>
                                                </div>
                                            ...
                                            <Col lg={4}>
                                                <div className="mt-4">
                                                    ...
                                                    <div className="d-flex align-items-center flex-wrap gap-2">
                                                        <Button color="light" className="w-xs" onClick={durationnotify}>
                                                            Click Me
                                                        </Button>
                                                    </div>
                                                </div>
