...
const BootstrapToastsExample = () => <PrismCode code={bootstrapToastsCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const ToastPlacementExample = () => <PrismCode code={toastPlacementCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const BorderIconExample = () => <PrismCode code={borderIconCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const ToastifyExample = () => <PrismCode code={toastifyCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
