...
const DefaultPlaceholderExample = () => <PrismCode code={defaultPlaceholderCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const SizingExample = () => <PrismCode code={sizingCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const ColorExample = () => <PrismCode code={colorCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
