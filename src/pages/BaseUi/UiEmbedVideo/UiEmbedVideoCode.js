...
const Ratio169Example = () => <PrismCode code={ratio169Code} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const Ratio219Example = () => <PrismCode code={ratio219Code} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const Ratio43Example = () => <PrismCode code={ratio43Code} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const Ratio11Example = () => <PrismCode code={ratio11Code} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const CustomRationExample = () => <PrismCode code={customRationCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
