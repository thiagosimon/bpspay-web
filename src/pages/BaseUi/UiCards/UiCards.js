                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="card-text mb-0">
                                        Whether article spirits new her covered hastily sitting her. Money witty books nor son add. Chicken age had
                        ...
                        <Col sm={6} xl={3}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="card-text">
                                        We quickly learn to fear and thus automatically avoid potentially stressful situations of all kinds, including
                        ...
                        <Col sm={6} xl={3}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="card-text">
                                        Objectively pursue diverse catalysts for change for interoperable meta-services. Distinctively re-engineer
                                    ...
                                    <Card>
                                        ...
                                        <CardBody>
                                            ...
                                            <p className="card-text text-muted mb-0">
                                                ...
                                                Miss told ham dull knew see she spot near can. Spirit her entire her called.
                                            </p>
                                        </CardBody>
                                        <div className="card-footer">
                                            <Link to="#" className="link-success float-end">
                                                Read More <i className="ri-arrow-right-s-line align-middle ms-1 lh-1"></i>
                                            </Link>
                                ...
                                <Col lg={6} xxl={4}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            ...
                                            <p className="card-text text-muted mb-0">
                                                Intrinsically incubate intuitive opportunities and real-time potentialities for change for
                                                interoperable meta-services itself or distract the viewer's attention from the layout.
                                            </p>
                                        </CardBody>
                                        <div className="card-footer">
                                            <Link to="#" className="link-success float-end">
                                                Payment Now <i className="ri-arrow-right-s-line align-middle ms-1 lh-1"></i>
                                            </Link>
                                            ...
                                            <blockquote className="card-blockquote mb-0">
                                                ...
                                                <figure className="mb-0">
                                                    <blockquote className="blockquote">
                                                        <p className="lead">
                                                            "A business consulting agency is involved in the planning, implementation, and education
                                                            of businesses."
                                                        </p>
                                                    </blockquote>
                    ...
                    <Row>
                            ...
                            <Card>
                                <CardBody>
                                    <h4 className="card-title mb-3">
                                        <i className="ri-user-3-fill align-middle me-1 text-muted"></i> Natasha Carey
                                    </h4>
                                ...
                                <div className="card-footer text-center">
                                    <Link to="#" className="link-secondary">
                                        View All Notification (2) <i className="ri-arrow-right-s-line align-middle ms-1 lh-1"></i>
                                    </Link>
                                </div>
                            </Card>
                        </Col>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        by using complicated 3D elements. Flat design is your friend. Remember that. And the great thing about flat
                                        design is that it has become more and more popular over the years.
                                    </p>
                                    <p className="text-muted mb-0">
                        ...
                        <Col xl={4}>
                            <Card>
                                <CardHeader>
                                    <h6 className="card-title mb-0">
                                        <i className="ri-gift-line align-middle me-1 lh-1"></i> You've made it!
                                    </h6>
                                </CardHeader>
                                <CardBody>
                                    <p className="text-muted">
                                        After gathering lots of different opinions and graphic design basics, I came up with a list of 30 graphic
                                        design tips that you can start implementing. Each design is a new, unique piece of art birthed into this
                                        world.
                                    </p>
                            ...
                            <Card>
                                ...
                                <Collapse isOpen={coll1} className="card-body" id="collapseexample1">
                                    ...
                                    <div className="d-flex mt-2">
                                        ...
                                        <div className="flex-grow-1 ms-2 text-muted">
                                            This may be the most commonly encountered tip I received from the designers I spoke with. They highly
                                            encourage that you use different fonts in one design, but do not over-exaggerate and go overboard.
                                        </div>
                                    </div>
                                        ...
                                        <div className="card-img-overlay p-0 d-flex flex-column">
                                            ...
                                            <CardBody>
                                                <p className="card-text text-white mb-2">
                                                    ...
                                                    opportunity to be creative and make your unpleasant for the reader.{' '}
                                                </p>
                                                <p className="card-text">
                                    ...
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="card-text text-muted">
                                                {' '}
                                                Exercitation +1 labore velit, blog sartorial PBR leggings next level wes anderson artisan four loko
                                                farm-to-table craft beer twee. ommodo enim craft beer mlkshk aliquip jean shorts ullamco.
                                            </p>
                                            <p className="card-text mb-0">Last updated 3 mins ago</p>
                                        </CardBody>
                                    ...
                                    <Card className="card-primary">
                                        <CardBody>
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <p className="card-text">
                                                        <span className="fw-medium">Jeffrey Montgomery</span> (Graphic Designer) started a new
                                                        conversation.
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div className="card-footer">
                                            <div className="text-center">
                                                <Link to="#" className="link-light">
                                                    Connect Now <i className="ri-arrow-right-s-line align-middle lh-1"></i>
                                                </Link>
                                            </div>
                                        </div>
                                    </Card>
                                    ...
                                    <Card className="card-success">
                                        <CardBody>
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <p className="card-text">
                                                        <span className="fw-medium">Charles Dickens</span> (Financial Analyst) started a new
                                                        conversation.
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <Card className="card-info">
                                        <CardBody>
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <p className="card-text">
                                                        <span className="fw-medium">Oliver Phillips</span> (UI/UX Designer) started a new
                                                        conversation.
                                                    </p>
                                                </div>
                                            </div>
                            ...
                            <Card className="card-warning">
                                <CardBody>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <p className="card-text">
                                                <span className="fw-medium">Rebecca Swartz</span> (Graphic Designer) started a new conversation.
                                            </p>
                                        </div>
                                    </div>
                                </CardBody>
                            ...
                            <Card className="card-danger">
                                <CardBody>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <p className="card-text">
                                                <span className="fw-medium">Betty Richards</span> (Back End Developer) started a new conversation.
                                            </p>
                                        </div>
                                    </div>
                                </CardBody>
                            ...
                            <Card className="card-dark">
                                <CardBody>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <p className="card-text">
                                                <span className="fw-medium">Brooke Hayes</span> (Founder & CEO) started a new conversation.
                                            </p>
                                        </div>
                                    </div>
                                </CardBody>
                            ...
                            <Card className="card-secondary">
                                <CardBody>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <p className="card-text">
                                                <span className="fw-medium">Bethany Johnson</span> (Team Leader) started a new conversation.
                                            </p>
                                        </div>
                                    </div>
                                </CardBody>
                            ...
                            <Card className="card-light">
                                <CardBody>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <p className="card-text">
                                                <span className="fw-medium">Amelie Townsend</span> (UI/UX Designer) started a new conversation.
                                            </p>
                                        </div>
                                    </div>
                                </CardBody>
                            ...
                            <Row>
                                <Col xxl={4}>
                                    <Card className="border card-border-primary">
                                        <CardHeader>
                                            ...
                                            <h6 className="card-title mb-0">
                                                Handle to Forcast <span className="badge bg-danger align-middle fs-10">Poor</span>
                                            </h6>
                                        </CardHeader>
                                        <CardBody>
                                            <p className="card-text">
                                                Whether article spirits new her covered hastily sitting her. Money witty books nor son add build on
                                                the card Chicken age had evening believe but proceed pretend mrs.
                                            </p>
                                            <div className="text-end">
                                ...
                                <Col xxl={4}>
                                    <Card className="border card-border-success">
                                        <CardHeader>
                                            ...
                                            <h6 className="card-title mb-0">
                                                Quality Forcast <span className="badge bg-success align-middle fs-10">Excellent</span>
                                            </h6>
                                        </CardHeader>
                                        <CardBody>
                                            <p className="card-text">
                                                They all have something to say beyond the words on the page. They can come across as casual or
                                                neutral, exotic or graphic. Cosby sweater eu banh mi, qui irure terry richardson ex squid.
                                            </p>
                                            <div className="text-end">
                                ...
                                <Col xxl={4}>
                                    <Card className="border card-border-info">
                                        <CardHeader>
                                            <h6 className="card-title mb-0">
                                                Check your E-mails <span className="badge bg-info align-middle fs-10">In Process</span>
                                            </h6>
                                        </CardHeader>
                                        <CardBody>
                                            <p className="card-text">
                    ...
                    <Row>
                        <Col xxl={4}>
                            <Card className="border card-border-warning">
                                <CardHeader>
                                    <h6 className="card-title mb-0">
                                        Check your Payment <span className="badge bg-warning align-middle fs-10">Pending</span>
                                    </h6>
                                </CardHeader>
                                <CardBody>
                                    <p className="card-text">
                                        They all have something to say beyond the words on the page. They can come across as casual or neutral, exotic
                                        or graphic. Cosby sweater eu banh mi, qui irure terry richardson ex squid.
                                    </p>
                                    <div className="text-end">
                        ...
                        <Col xxl={4}>
                            <Card className="border card-border-danger">
                                <CardHeader>
                                    <h6 className="card-title mb-0">
                                        Your Ordered Cancel <span className="badge bg-danger align-middle fs-10">Cancel</span>
                                    </h6>
                                </CardHeader>
                                <CardBody>
                                    <p className="card-text">
