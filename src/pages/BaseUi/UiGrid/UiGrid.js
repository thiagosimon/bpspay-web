                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>align-items-start</code> class to vertically align-items at the start.
                                    </p>
                                    <div className="live-preview">
                                        <div className="bg-light p-3 text-center">
                                            <Row className="align-items-start" style={{ minHeight: '6rem' }}>
                                                <Col sm={4}>
                                                    <div className="bg-soft-primary text-primary rounded p-2">col-sm-4</div>
                                                </Col>
                                                <Col sm={4}>
                                                    <div className="bg-soft-primary text-primary rounded p-2 mt-2 mt-sm-0">col-sm-4</div>
                                                </Col>
                                                <Col sm={4}>
                                                    <div className="bg-soft-primary text-primary rounded p-2 mt-2 mt-sm-0">col-sm-4</div>
                                                </Col>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>align-items-center</code> class to vertically align-items at the center.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>align-items-end</code> class to vertically align-items at the end.
                                    </p>
                                    <div className="live-preview">
                                        <div className="bg-light p-3 text-center">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the <code>align-self-start</code>,<code>align-self-center</code>, or <code>align-self-end</code> class
                                        respectively to vertically align items with a different position.
                                    </p>
                                        ...
                                        <div className="bg-light p-3 text-center">
                                            <Row className="g-2" style={{ minHeight: '9rem' }}>
                                                <div className="col-sm-4 align-self-start">
                                                    <div className="bg-soft-primary text-primary rounded p-2">align-self-start</div>
                                                </div>
                                                <div className="col-sm-4 align-self-center">
                                                    <div className="bg-soft-primary text-primary rounded p-2">align-self-center</div>
                                                </div>
                                                <div className="col-sm-4 align-self-end">
                                                    <div className="bg-soft-primary text-primary rounded p-2">align-self-end</div>
                                                </div>
                                            </Row>
                                        </div>
                                    </div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the <code>justify-content-start</code>,<code>justify-content-center</code>, or{' '}
                                    ...
                                    <div className="live-preview">
                                        <div className="bg-light p-3 text-center">
                                            <Row className="justify-content-start">
                                                <Col sm={4}>
                                                    <div className="bg-soft-primary text-primary rounded p-2">justify-content-start</div>
                                                </Col>
                                            </Row>
                                            ...
                                            <Row className="justify-content-end">
                                                <Col sm={4}>
                                                    <div className="bg-soft-primary text-primary rounded p-2 mt-2 mt-sm-0">justify-content-end</div>
                                                </Col>
                                            </Row>
                                        </div>
                                    </div>
