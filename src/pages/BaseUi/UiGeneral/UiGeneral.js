                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col lg={6}>
                                                ...
                                                <p className="text-muted">
                                                    Use <code>Pagination</code> attribute to ul element to indicate a series of related content exists
                                            ...
                                            <Col lg={6}>
                                                <div className="mt-4 mt-lg-0">
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>disabled</code> attribute to PaginationItem to links that appear un-clickable and{' '}
                                                        <code>active</code> class to indicate the current page.
                                                    </p>
                                                    <Pagination>
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <div className="mt-4">
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>pagination-lg</code> or <code>pagination-sm</code> to set different pagination
                                                        sizes.
                                                    </p>
                                            ...
                                            <Col lg={6}>
                                                <div className="mt-4">
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>justify-content-start</code>, <code>justify-content-start</code>, or{' '}
                                                        <code>justify-content-start</code>, class to pagination class to change the alignment of
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <div className="mt-4">
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>pagination-separated</code> class to pagination class to set custom separated
                                                        pagination.
                                                    </p>
                                            ...
                                            <Col lg={6}>
                                                <div className="mt-4">
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>pagination-rounded</code> class to pagination class to set custom rounded
                                                        pagination.
                                                    </p>
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <div>
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>Spinner</code> attribute for a lightweight loading indicator.
                                                    </p>
                                            ...
                                            <Col lg={6}>
                                                <div>
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>spinner-grow</code> class for a lightweight spinner with growing effect.
                                                    </p>
                                                    <div className="d-flex flex-wrap gap-3 mb-2">
                                                        {/* <!-- Growing spinner --> */}
