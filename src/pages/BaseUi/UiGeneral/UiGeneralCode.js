...
const PopoversExample = () => <PrismCode code={popoversCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const TooltipsExample = () => <PrismCode code={tooltipsCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const BreadcrumbExample = () => <PrismCode code={breadcrumbCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const PaginationExample = () => <PrismCode code={paginationCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const SpinnersExample = () => <PrismCode code={spinnersCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
