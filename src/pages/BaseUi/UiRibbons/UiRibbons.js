                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            <p className="text-muted">
                                                Use <code>ribbon-box</code> class with <code>ribbon-two</code> class at child element to show
                                                ...
                                                <div className="card ribbon-box border shadow-none mb-lg-0">
                                                    <div className="card-body text-muted">
                                                        ...
                                                        <p className="mb-0">
                                                            Quisque nec turpis at urna dictum luctus. Suspendisse convallis dignissim eros at
                                                            volutpat. In egestas mattis dui. Aliquam mattis dictum aliquet. Nulla sapien mauris,
                                                            eleifend et sem ac, commodo dapibus odio. Vivamus pretium nec odio cursus.
                                                        </p>
                                                    </div>
                                                </div>
                                            </Col>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            <p className="text-muted">
                                                Use <code>ribbon-box</code> class with <code>ribbon-three</code> class at child element to show
                                                below-mentioned shaped ribbon.
                                            </p>
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border shadow-none mb-lg-0">
