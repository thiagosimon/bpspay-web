...
const RoundedRibbonExample = () => <PrismCode code={roundedRibbonCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const RibbonShapeExample = () => <PrismCode code={ribbonShapeCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const FilledRibbonsExample = () => <PrismCode code={filledRibbonsCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const BoxedRibbonsExample = () => <PrismCode code={boxedRibbonsCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const RibbonsExample = () => <PrismCode code={ribbonsCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const RibbonsHoverExample = () => <PrismCode code={ribbonsHoverCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
