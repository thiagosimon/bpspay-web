                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use
                                        <code> rounded</code> class and <code>rounded-circle</code> class to show an image with a round border and
                                        rounded shape respectively.
                                    </p>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>img-thumbnail</code> class to give an image rounded 1px border appearance.
                                    </p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted mb-4">
                                        Use <code>avatar-xxs</code>, <code>avatar-xs</code>, <code>avatar-sm</code>, <code>avatar-md</code>,{' '}
                                        <code>avatar-lg</code>, <code>avatar-xl</code> class for different image sizes.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>avatar-xxs, avatar-xs,avatar-sm,avatar-md,avatar-lg,avatar-xl</code> class to set different avatar
                                        content.
                                    </p>
                                        ...
                                        <Row className="g-3">
                                            <Col xxl={2} md={4} className="col-6">
                                                <div className="avatar-xxs mt-3">
                                                    <div className="avatar-title rounded bg-soft-primary text-primary fs-10">XXS</div>
                                                </div>
                                            </Col>
                                            <Col xxl={2} md={4} className="col-6">
                                                <div className="avatar-xs mt-3">
                                                    <div className="avatar-title rounded bg-soft-secondary text-secondary">XS</div>
                                                </div>
                                            </Col>
                                            <Col xxl={2} md={4} className="col-6">
                                                <div className="avatar-sm mt-3">
                                                    <div className="avatar-title rounded bg-soft-success text-success fs-14">SM</div>
                                                </div>
                                            </Col>
                                            <Col xxl={2} md={4} className="col-6">
                                                <div className="avatar-md mt-3">
                                                    <div className="avatar-title rounded bg-soft-info text-info fs-16">MD</div>
                                                </div>
                                            </Col>
                                            <Col xxl={2} md={4} className="col-6">
                                                <div className="avatar-lg mt-3">
                                                    <div className="avatar-title rounded bg-soft-warning text-warning fs-20">LG</div>
                                                </div>
                                            </Col>
                                            <Col xxl={2} md={4} className="col-6">
                                                <div className="avatar-xl mt-3">
                                                    <div className="avatar-title rounded bg-soft-danger text-danger fs-22">XL</div>
                                                </div>
                                            </Col>
                                        </Row>
                                    </div>
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <div className="mt-lg-0 mt-3">
                                                    <p className="text-muted">
                                                        Use <code>avatar-group</code> class to show avatar images with the group.
                                                    </p>
                                                    <div className="avatar-group">
                                                        ...
                                                        <div className="avatar-group-item">
                                                            <div className="avatar-sm">
                                                                <div className="avatar-title rounded-circle bg-light text-primary">A</div>
                                                            </div>
                                                        </div>
                                                        <div className="avatar-group-item">
                                            ...
                                            <Col lg={6}>
                                                <div className="mt-lg-0 mt-3">
                                                    <p className="text-muted">
                                                        Use <code>avatar-group</code> class with <code>data-bs-toggle="tooltip"</code> to show avatar
                                                    ...
                                                    <div className="avatar-group">
                                                        ...
                                                        <Link to="#" className="avatar-group-item" id="img3">
                                                            <div className="avatar-sm">
                                                                <div className="avatar-title rounded-circle bg-light text-primary">C</div>
                                                            </div>
                                                        </Link>
                    ...
                    <Row>
                        ...
                        <Col xl={4}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="card-title-desc text-muted">
                                        Responsive Images with <code>img-fluid,max-width: 100%; and height: auto;</code> to the image so that it
