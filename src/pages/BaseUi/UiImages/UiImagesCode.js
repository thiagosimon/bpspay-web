...
const ImgRoundedCircleExample = () => <PrismCode code={imgRoundedCircleCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const ImgThumbnailsExample = () => <PrismCode code={imgThumbnailsCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const ImgSizesExample = () => <PrismCode code={imgSizesCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const AvatarExample = () => <PrismCode code={avatarCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const AvatarGroupExample = () => <PrismCode code={avatarGroupCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const FiguresExample = () => <PrismCode code={figuresCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
...
const ResponsiveExample = () => <PrismCode code={responsiveCode} language={('js', 'css', 'html')} plugins={['line-numbers']} />
