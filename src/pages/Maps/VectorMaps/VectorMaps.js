                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div id="world-map-line-markers" data-colors='["--vz-light"]' style={{ height: '420px', position: 'relative' }}>
                                        <Vector value="world_mill" width="500" color="#f3f6f9" />
                                    </div>
                                </CardBody>
                            </Card>
                        </Col>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div id="canada-vectormap" style={{ height: '350px' }}>
                                        <Vector value="ca_lcc" width="500" color="#3fa7d6" />
                                    </div>
                                </CardBody>
                            </Card>
                        </Col>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div id="russia-vectormap">
                                        <Vector value="ru_mill" width="500" color="#40bb82" />
                                    </div>
                                </CardBody>
                            </Card>
                        </Col>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div id="spain-vectormap">
                                        <Vector value="es_mill" width="500" color="#4788ff" />
                                    </div>
                                </CardBody>
                            </Card>
                        </Col>
