                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div id="gmaps-markers" className="gmaps" style={{ position: 'relative' }}>
                                        <Map google={props.google} zoom={8} style={mapStyles} initialCenter={{ lat: 34.134117, lng: -118.321495 }}>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div id="gmaps-overlay" className="gmaps" style={{ position: 'relative' }}>
                                        <Map google={props.google} zoom={8} style={mapStyles} initialCenter={{ lat: 54.526, lng: 15.2551 }} />
                                    </div>
                                </CardBody>
                            </Card>
                        </Col>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div id="panorama" className="gmaps-panaroma" style={{ position: 'relative' }}>
                                        <Map google={props.google} zoom={8} style={mapStyles} initialCenter={{ lat: 8.7832, lng: 34.5085 }} />
                                    </div>
                                </CardBody>
                            </Card>
                        </Col>
                            ...
                            <Card>
                                ...
                                <div className="card-body">
                                    <div id="gmaps-types" className="gmaps" style={{ position: 'relative' }}>
                                        <Map google={props.google} zoom={8} style={mapStyles} initialCenter={{ lat: 19.076, lng: 72.8777 }} />
                                    </div>
                                </div>
                            </Card>
                        </Col>
