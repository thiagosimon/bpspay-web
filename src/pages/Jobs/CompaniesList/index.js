                ...
                <Container fluid className="container-fluid">
                    ...
                    <Row className="row">
                        <Col className="col-xxl-9">
                                        ...
                                        <Row className="row g-3">
                                            ...
                                            <Col className="col-xxl-2 col-sm-4">
                                                <div className="input-light">
                                                    <select className="form-control" name="choices-single-default" id="idType">
                                            ...
                                            <CardBody className="card-body">
                                                <div className="avatar-sm mx-auto">
                                                    <div className="avatar-title bg-light rounded">
                                                        <img src={item.image_src} alt="" className="avatar-xxs companyLogo-img" />
                                                    </div>
                                                </div>
                                                <div className="text-center">
                                                    ...
                                                    <div className="d-none company-desc">{item.company_info}</div>
                                                    <p className="text-muted industry-type">{item.industry_type}</p>
                                                ...
                                                <div>
                                                    <button type="button" className="btn btn-soft-primary w-100 viewcompany-list">
                                                        <span className="vacancy">{item.vacancy}</span> Jobs Available
                                                    </button>
                                                </div>
                                            </CardBody>
                                        </Card>
                            ...
                            <Row className="row g-0 justify-content-end mb-4" id="pagination-element">
                        ...
                        <Col className="col-xxl-3">
                            <Card className="card" id="company-overview">
                                <CardBody className="card-body">
                                    <div className="avatar-lg mx-auto mb-3">
                                        <div className="avatar-title bg-light rounded">
                                            <img src={img6} alt="" className="avatar-sm company-logo" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-muted overview-industryType">IT Department</p>

                                        <ul className="list-inline mb-0">
                                            <li className="list-inline-item avatar-xs">
                                                <NavLink to="" className="avatar-title bg-soft-dark text-dark fs-15 rounded">
                                                    <i className="ri-global-line"></i>
                                                </NavLink>
                                            </li>
                                            <li className="list-inline-item avatar-xs">
                                                <NavLink to="" className="avatar-title bg-soft-danger text-danger fs-15 rounded">
                                                    <i className="ri-mail-line"></i>
                                                </NavLink>
                                            </li>
                                            <li className="list-inline-item avatar-xs">
                                                <NavLink to="" className="avatar-title bg-soft-warning text-warning fs-15 rounded">
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="text-muted mb-4 overview-companydesc">
                                        The IT department of NavLink company ensures that the network of computers within the organisation are
                                        well-connected and functioning properly. All the other departments within the company rely on them to ensure
                                        that their respective functions can go on seamlessly.
                                    </p>
                                        ...
                                        <Table className="table table-borderless mb-4">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td className="overview-industryType">Chemical Industries</td>
                                                </tr>
                                                <tr>
                                                    <td className="fw-semibold">Location</td>
                                                    <td className="overview-company_location">Damascus, Syria</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <NavLink to="" className="link-primary text-decoration-underline overview-website">
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="overview-email">info@syntycesolution.com</td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div className="hstack gap-3">
                                        <button type="button" className="btn btn-soft-primary custom-toggle w-100" data-bs-toggle="button">
                            ...
                            <Card className="card overflow-hidden shadow-none">
                                ...
                                <CardBody className="card-body bg-soft-danger border-top border-danger border-opacity-25 border-top-dashed">
                                    <NavLink to="#!" className="d-flex justify-content-between align-items-center text-body">
