                    ...
                    <>
                        <div className="d-flex align-items-center">
                            <div className="flex-shrink-0">
                                <img src={appList.row.original.company[0]} alt="" className="avatar-xxs rounded-circle image_src object-cover" />
                            </div>
                            <div className="flex-grow-1 ms-2 ">{appList.row.original.company[1]}</div>
                        </div>
                    </>
                )
            },
                ...
                Cell: cellProps => {
                    return (
                        <div className="d-flex gap-3">
                            <Link to="/apps-job-details" className="text-primary d-inline-block">
                            ...
                            <Card>
                                <CardHeader className="border-0">
                                    <div className="d-md-flex align-items-center">
                                        <h5 className="card-title mb-3 mb-md-0 flex-grow-1">Job Application</h5>
                                        <div className="flex-shrink-0">
                                            <div className="d-flex gap-1 flex-wrap">
                                                ...
                                                >
                                                    <i className="ri-add-line align-bottom me-1"></i> Create Application
                                                </Button>
                                ...
                                <CardBody className="border border-dashed border-end-0 border-start-0">
                                    <Form>
                                        <Row className="g-3">
                                            ...
                                            <Col className="col-xxl-2 col-sm-4">
                                                <div>
                                                    <Select options={option1} name="choices-single-default" id="idType"></Select>
                                                </div>
                                            </Col>
                                ...
                                <CardBody className="pt-0">
                                    <div>
                                        <Nav className="nav nav-tabs nav-tabs-custom nav-success mb-3" role="tablist">
                                            ...
                                            <NavItem>
                                                <NavLink className="py-3 New" data-bs-toggle="tab" id="New" to="#" role="tab" aria-selected="false">
                                                    New
                                                </NavLink>
                                            </NavItem>
                                            <NavItem>
                                                <NavLink
                                                    ...
                                                    aria-selected="false"
                                                >
                                                    Pending <span className="badge bg-danger align-middle ms-1">2</span>
                                                </NavLink>
                                            </NavItem>
                                            <NavItem>
                                                <NavLink
                                                        ...
                                                        <div className="gy-4 mb-3">
                                                            ...
                                                            <div className="col-md-6">
                                                                <div>
                                                                    ...
                                                                    <Select className="form-control" data-trigger name="type-input" id="type-input">
