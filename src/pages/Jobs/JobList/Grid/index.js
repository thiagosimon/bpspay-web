...
import { Card, CardBody, Col, DropdownItem, DropdownMenu, DropdownToggle, Form, Input, Row, UncontrolledDropdown } from 'reactstrap'
                                ...
                                <CardBody className="card-body bg-soft-light">
                                    <Form>
                                        <Row className="row g-3">
                                            <Col className="col-xxl-4 col-sm-12">
                                            ...
                                            <Col className="col-xxl-3 col-sm-4">
                                                <Flatpickr
                            ...
                            <div className="d-flex align-items-center mb-4">
                                ...
                                <div className="flex-shrink-0">
                                    <UncontrolledDropdown className="dropdown">
                                        ...
                                        <DropdownMenu className="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            <li>
                                ...
                                <Card className="card">
                                    <CardBody className="card-body">
                                        ...
                                        <div className="d-flex gap-4 mb-3">
                                            <div>
                                                <i className="ri-map-pin-2-line text-primary me-1 align-bottom"></i> {item.location}
                                            </div>
                                            <div>
                                                <i className="ri-time-line text-primary me-1 align-bottom"></i> {item.postDate}
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-4 hstack gap-2">
                                            ...
                                            <Link href="/apps-job-details" className="btn btn-soft-success w-100">
                                                Overview
                                            </Link>
                                        </div>
                                    </CardBody>
