            ...
            <div className="page-content">
                <div className="container-fluid">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                <CardBody className="card-body bg-soft-light">
                                    <div className="d-flex align-items-center">
                                        <h6 className="card-title mb-0 flex-grow-1 fw-bold">Search Jobs</h6>
                                        <div className="flex-shrink-0">
                                            <button className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#CreateJobModal">
                                    ...
                                    <Row className="mt-3 gy-3">
                                        ...
                                        <Col className="col-xxl-2 col-md-6">
                    ...
                    <Row>
                                ...
                                {jobList.map((item, key) => (
                                    <Card className="joblist-card" key={key}>
                                        <CardBody>
                                            <div className="d-flex mb-4">
                                                <div className="avatar-sm">
                                                    <div className="avatar-title bg-light rounded">
                                                        <img src={item.companyLogo} alt="" className="avatar-xxs companyLogo-img" />
                                                    </div>
                                                </div>
                                                <div className="ms-3 flex-grow-1">
                                                    <img src={item.coverImg} alt="" className="d-none cover-img" />
                                                    <Link to="#!">
                                                        <h5 className="job-title">{item.jobTitle}</h5>
                                                    </Link>
                                                    <p className="company-name text-muted mb-0">{item.companyName}</p>
                                                </div>
                                                <div>
                                                    <button
                                                        type="button"
                                            ...
                                            <p className="text-muted job-description">{item.description}</p>
                                            <div>
                                                {(item.tags || []).map((subItem, key) => (
                                                    <span key={key} className="badge badge-soft-primary me-1">
                                                        {subItem}
                                                    </span>
                                                ))}
                                            </div>
                                        ...
                                        <CardHeader className="card-footer border-top-dashed">
                                            <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                                ...
                                                <div className="d-none">
                                                    <span className="job-experience">{item.experience}</span>
                                                </div>
                                                <div>
                                                ...
                                                <div>
                                                    <Link to="#!" className="btn btn-primary viewjob-list">
                                                        View More <i className="ri-arrow-right-line align-bottom ms-1"></i>
                                                    </Link>
                                                </div>
                                            </div>
                                        </CardHeader>
                        ...
                        <Col xxl={3}>
                            <Card className="job-list-view-card overflow-hidden" id="job-overview">
                                <img src={img10} alt="" id="cover-img" className="img-fluid background object-cover" />
                                <CardBody>
                                    <div className="avatar-md mt-n5">
                                        <div className="avatar-title bg-light rounded-circle">
                                            <img src={img7} alt="" className="avatar-xs view-companylogo" />
                                        </div>
                                    </div>
                                    <div className="mt-3">
                                        ...
                                        <p className="text-muted view-desc">
                                            A UI/UX designer's job is to create user-friendly interfaces that enable users to understand how to use
                                            complex technical products. If you're passionate about the latest technology trends and devices, you'll
                                            find great fulfillment in being involved in the design process for the next hot gadget.
                                        </p>
                                        <div className="py-3 border border-dashed border-start-0 border-end-0 mt-4">
                                            <Row className="row">
                                                <Col lg={4} sm={6}>
                                                    <div>
                                                        <p className="mb-2 text-uppercase fw-semibold fs-12 text-muted">Job Type</p>
                                                        <h5 className="fs-14 mb-0 view-type">Full Time</h5>
                                                    </div>
                                                </Col>
                                                <Col lg={4} sm={6}>
                                                    <div>
                                                        <p className="mb-2 text-uppercase fw-semibold fs-12 text-muted">Post Date</p>
                                                        <h5 className="fs-14 mb-0 view-postdate">15 Sep, 2022</h5>
                                                    </div>
                                                </Col>
                                                <Col lg={4} sm={6}>
                                                    <div>
                                                        <p className="mb-2 text-uppercase fw-semibold fs-12 text-muted">Experience</p>
                                                        <h5 className="fs-14 mb-0 view-experience">0 - 5 Year</h5>
                                                    </div>
                                                </Col>
                                            </Row>
                                        </div>
