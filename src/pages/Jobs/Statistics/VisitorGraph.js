            ...
            <Col className="col-xl-8">
                <Card className="card">
                        ...
                        <div className="d-flex">
                            ...
                            <div className="flex-shrink-0">
                                <UncontrolledDropdown className="card-header-dropdown">
                                    <DropdownToggle className="text-reset dropdown-btn" tag="a" type="a" href="#">
                    ...
                    <CardBody className="card-body">
                        <ReactApexChart dir="ltr" className="apex-charts" series={series} options={options} type="treemap" height={350} />
                    </CardBody>
                </Card>
            </Col>
        </React.Fragment>
