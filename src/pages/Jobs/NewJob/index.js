                                ...
                                <Form action="#">
                                    ...
                                    <CardBody className="card-body">
                                        <Row className="row g-4">
                                            ...
                                            <Col className="col-lg-6">
                                                <div>
                                                    <Label htmlFor="job-position-Input" className="form-label">
                                            ...
                                            <Col className="col-lg-6">
                                                <div>
                                                    <Label htmlFor="job-category-Input" className="form-label">
                                                        Job Category <span className="text-danger">*</span>
                                                    </Label>
                                                    <select className="form-control" data-choices name="job-category-Input" required>
                                            ...
                                            <Col className="col-lg-6">
                                                <div>
                                                    <Label htmlFor="job-type-Input" className="form-label">
                                                        Job Type <span className="text-danger">*</span>
                                                    </Label>
                                                    <select className="form-control" data-choices name="job-type-Input" required>
                                            ...
                                            <Col className="col-md-6">
                                                <div>
                                                    <Label htmlFor="vancancy-Input" className="form-label">
                                            ...
                                            <Col className="col-md-6">
                                                <div>
                                                    <Label htmlFor="experience-Input" className="form-label">
                                                        Experience <span className="text-danger">*</span>
                                                    </Label>
                                                    <select className="form-control" data-choices name="experience-Input">
                                            ...
                                            <Col className="col-lg-6">
                                                <div>
                                                    <Label htmlFor="last-apply-date-Input" className="form-label">
                                                        Last Date of Apply <span className="text-danger">*</span>
                                                    </Label>
                                                    <Flatpickr
                                                        className="form-control"
                                            ...
                                            <Col className="col-lg-6">
                                                <div>
                                                    <Label htmlFor="close-date-Input" className="form-label">
                                            ...
                                            <Col className="col-md-6">
                                                <div>
                                                    <Label htmlFor="start-salary-Input" className="form-label">
                                                        Start Salary
                                                    </Label>
                                                    <Input
                                                        type="number"
                                            ...
                                            <Col className="col-md-6">
                                                <div>
                                                    <Label htmlFor="last-salary-Input" className="form-label">
                                                        Last Salary
                                                    </Label>
                                                    <Input
                                                        type="number"
                                            ...
                                            <Col className="col-md-6">
                                                <div>
                                                    ...
                                                    <Input type="text" className="form-control" id="city-Input" placeholder="Enter city" required />
                                                </div>
                                            </Col>
