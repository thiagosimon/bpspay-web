                                    ...
                                    <Row className="justify-content-between gy-3">
                                        <Col lg={3}>
                                            <div className="search-box">
                                                <Input type="text" className="form-control search" placeholder="Search for job categories..." />
                                                <i className="ri-search-line search-icon"></i>
                                            </div>
                                        </Col>
                                        <Col className="col-lg-auto">
                                            <div className="d-md-flex text-nowrap gap-2">
                                                <button className="btn btn-primary add-btn" data-bs-toggle="modal" data-bs-target="#showModal">
                                                    <i className="ri-add-fill me-1 align-bottom"></i> Add Categories
                                                </button>
                                                ...
                                                <UncontrolledDropdown>
                                                    ...
                                                    <DropdownMenu className="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <li>
                    ...
                    <Row>
                        <Col lg={12}>
                            <div className="text-center mb-3">
                                <button className="btn btn-link text-info mt-2" id="loadmore">
