...
const EcommerceCheckout = () => {
    ...
    return (
        <React.Fragment>
                                            ...
                                            <Nav className="nav-pills nav-justified custom-nav" role="tablist">
                                                <NavItem role="presentation">
                                                    <NavLink
                                                        ...
                                                        className={classnames(
                                                            { active: activeTab === 1, done: activeTab <= 4 && activeTab >= 0 },
                                                            'fs-15 p-3'
                                                        )}
                                                        onClick={() => {
                                                            toggleTab(1)
                                                ...
                                                <NavItem role="presentation">
                                                    <NavLink
                                                        href="#"
                                                        className={classnames(
                                                            { active: activeTab === 2, done: activeTab <= 4 && activeTab > 1 },
                                                            'fs-15 p-3'
                                                        )}
                                                        onClick={() => {
                                                            toggleTab(2)
                                                ...
                                                <NavItem role="presentation">
                                                    <NavLink
                                                        href="#"
                                                        className={classnames(
                                                            { active: activeTab === 3, done: activeTab <= 4 && activeTab > 2 },
                                                            'fs-15 p-3'
                                                        )}
                                                        onClick={() => {
                                                            toggleTab(3)
                                                ...
                                                <NavItem role="presentation">
                                                    <NavLink
                                                        href="#"
                                                        className={classnames(
                                                            { active: activeTab === 4, done: activeTab <= 4 && activeTab > 3 },
                                                            'fs-15 p-3'
                                                        )}
                                                        onClick={() => {
                                                            toggleTab(4)
                                                ...
                                                <div className="mt-4">
                                                    <div className="d-flex align-items-center mb-2">
                                                        ...
                                                        <div className="flex-shrink-0">
                                                            <button type="button" className="btn btn-sm btn-primary mb-3" onClick={togglemodal}>
                                                                Add Address
                                                            </button>
                                                        </div>
                                                    </div>
                                                    <Row className="gy-3">
                                                        <Col lg={4} sm={6}>
                                                            ...
                                                            <div className="d-flex flex-wrap p-2 py-1 bg-light rounded-bottom border mt-n1">
                                                                <div>
                                                                    <Link to="#" className="d-block text-body p-1 px-2" onClick={togglemodal}>
                                            ...
                                            <TabPane tabId={3}>
                                                ...
                                                <div className="collapse show" id="paymentmethodCollapse">
                                                    ...
                                                    <div className="text-muted mt-2 fst-italic">
                                                        <i data-feather="lock" className="text-muted icon-xs"></i> Your transaction is secured with
                                                        SSL encryption
                                                    </div>
                                                </div>
                                            ...
                                            <TabPane tabId={4} id="pills-finish">
                                                <div className="text-center py-5">
                                                    ...
                                                    <h3 className="fw-semibold">
                                                        Order ID:{' '}
                                                        <a href="apps-ecommerce-order-details" className="text-decoration-underline">
                                                            VZ2451
                                                        </a>
                                                    </h3>
                                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div className="avatar-md bg-light rounded p-1">
                                                                    <img src={product.img} alt="" className="img-fluid d-block" />
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <h5 className="fs-14">
            ...
            <Modal isOpen={deletemodal} role="dialog" autoFocus={true} centered id="removeItemModal" toggle={toggledeletemodal}>
                <ModalHeader
                    toggle={() => {
                        setDeleteModal(!deletemodal)
                    }}
                ...
                <ModalBody>
                    <div>
                        ...
                        <div className="mb-3">
                            ...
                            <textarea className="form-control" id="addaddress-textarea" placeholder="Enter Address" rows="2"></textarea>
                        </div>
