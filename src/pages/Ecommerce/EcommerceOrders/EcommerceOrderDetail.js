                            ...
                            <CardHeader>
                                <div className="d-sm-flex align-items-center">
                                    ...
                                    <div className="flex-shrink-0 mt-2 mt-sm-0">
                                        <Link to="#" className="btn btn-soft-primary btn-sm mt-2 mt-sm-0">
                                            <i className="ri-map-pin-line align-middle me-1"></i> Change Address
                                        </Link>{' '}
                                        <Link to="#" className="btn btn-soft-secondary btn-sm mt-2 mt-sm-0">
                                            <i className="mdi mdi-archive-remove-outline align-middle me-1"></i> Cancel Order
                                        </Link>
                                    </div>
                                </div>
                            </CardHeader>
                                    ...
                                    <div className="accordion accordion-flush" id="accordionFlushExample">
                                        <div className="accordion-item border-0" onClick={togglecol1}>
                                            ...
                                            <Collapse id="collapseOne" className="accordion-collapse" isOpen={col1}>
                                                <div className="accordion-body ms-2 ps-5 pt-0">
                                                    ...
                                                    <h6 className="mb-1">Seller has proccessed your order.</h6>
                                        ...
                                        <div className="accordion-item border-0" onClick={togglecol2}>
                                            <div className="accordion-header" id="headingTwo">
                                                <Link
                                                    to="#"
                                                    className={classnames('accordion-button', 'p-2', 'shadow-none', { collapsed: !col2 })}
                                                    href="#collapseTwo"
                                                >
                                                    <div className="d-flex align-items-center">
                                                        <div className="flex-shrink-0 avatar-xs">
                                            ...
                                            <Collapse id="collapseTwo" className="accordion-collapse" isOpen={col2}>
                                                <div className="accordion-body ms-2 ps-5 pt-0">
                                                    <h6 className="mb-1">Your Item has been picked up by courier patner</h6>
                                        ...
                                        <div className="accordion-item border-0" onClick={togglecol3}>
                                            <div className="accordion-header" id="headingThree">
                                                <Link
                                                    to="#"
                                                    className={classnames('accordion-button', 'p-2', 'shadow-none', { collapsed: !col3 })}
                                                    href="#collapseThree"
                                                >
                                                    <div className="d-flex align-items-center">
                                                        <div className="flex-shrink-0 avatar-xs">
                                        ...
                                        <div className="accordion-item border-0">
                                            <div className="accordion-header" id="headingFive">
                                                <Link className="accordion-button p-2 shadow-none" to="#">
                                                    <div className="d-flex align-items-center">
                                                        <div className="flex-shrink-0 avatar-xs">
                                                            <div className="avatar-title bg-light text-primary rounded-circle">
