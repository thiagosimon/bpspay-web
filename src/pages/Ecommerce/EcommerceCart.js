...
import { Card, CardBody, Col, Container, Input, Row, CardHeader, UncontrolledAlert } from 'reactstrap'
...
const EcommerceCart = () => {
    ...
    function countUP(id, prev_data_attr, itemPrice) {
        setproductList(productList.map(p => (p.id === id ? { ...p, data_attr: prev_data_attr + 1, total: (prev_data_attr + 1) * itemPrice } : p)))
    }
                        ...
                        <Col xl={8}>
                            <Row className="align-items-center gy-3 mb-3">
                                ...
                                <div className="col-sm-auto">
                                    <Link to="/apps-ecommerce-products" className="link-primary text-decoration-underline">
                                        Continue Shopping
                                    </Link>
                                </div>
                            </Row>
                                            ...
                                            <Row className="gy-3">
                                                <div className="col-sm-auto">
                                                    <div className="avatar-lg bg-light rounded p-1">
                                                        <img src={cartItem.img} alt="" className="img-fluid d-block" />
                                                    </div>
                                                </div>
                                                <div className="col-sm">
                                                    ...
                                                    <ul className="list-inline text-muted">
                                                        <li className="list-inline-item">
                                                            Color : <span className="fw-medium">{cartItem.color}</span>
                                                        </li>
                                                        <li className="list-inline-item">
                                                            Size : <span className="fw-medium">{cartItem.size}</span>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div className="col-sm-auto">
                                                    <div className="d-flex align-items-center gap-2 text-muted">
                                                        ...
                                                        <h5 className="fs-14 mb-0">
                                                            $<span className="product-line-price"> {cartItem.total.toFixed(2)}</span>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div className="text-end mb-4">
                                <Link to="/apps-ecommerce-checkout" className="btn btn-primary btn-label right ms-auto">
                                    <i className="ri-arrow-right-line label-icon align-bottom fs-16 ms-2"></i> Checkout
                                </Link>
                            </div>
                        </Col>
                            ...
                            <div className="sticky-side-div">
                                        ...
                                        <div className="table-responsive">
                                            <table className="table table-borderless mb-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            Discount <span className="text-muted">(VELZON15)</span> :{' '}
                                                        </td>
                                ...
                                <UncontrolledAlert color="primary" className="border-dashed">
                                    <div className="d-flex align-items-center">
                                        ...
                                        ></lord-icon>
                                        <div className="ms-2">
                                            <h5 className="fs-14 text-primary fw-semibold"> Buying for a loved one?</h5>
                                            <p className="text-black mb-1">
                                                Gift wrap and personalised message on card, <br />
                                                Only for <span className="fw-semibold">$9.99</span> USD
                                            </p>
                                            <button type="button" className="btn ps-0 btn-sm btn-link text-primary text-uppercase">
                                                Add Gift Wrap
                                            </button>
                                        </div>
                                    </div>
