...
import { Rating, Published, Price } from '../EcommerceProducts/EcommerceProductCol'
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <div className="flex-grow-1">
                                <h5 className="fs-14 mb-1">
                                    <a href="apps-ecommerce-product-details" className="text-dark">
                                        {' '}
                    ...
                    return (
                        <UncontrolledDropdown>
                            ...
                            <DropdownMenu className="dropdown-menu-end">
                                ...
                                <DropdownItem href="#" data-bs-toggle="modal" data-bs-target="#removeItemModal">
                            ...
                            <Card>
                                            ...
                                            <div className="mt-3">
                                                    ...
                                                    <div className="col">
                                                        <div className="p-1">
                                                            <div className="progress animated-progess progress-sm">
                                                                <Progress bar color="success" value="50.16"></Progress>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-auto">
                                                ...
                                                <Row className="align-items-center g-2">
                                                    ...
                                                    <div className="col">
                                                        <div className="p-1">
                                                            <div className="progress animated-progess progress-sm">
                                                                <Progress bar color="success" value="29.32"></Progress>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-auto">
                                                ...
                                                <Row className="align-items-center g-2">
                                                    ...
                                                    <div className="col">
                                                        <div className="p-1">
                                                            <div className="progress animated-progess progress-sm">
                                                                <Progress bar color="warning" value="18.12"></Progress>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-auto">
                                                ...
                                                <Row className="align-items-center g-2">
                                                    ...
                                                    <div className="col">
                                                        <div className="p-1">
                                                            <div className="progress animated-progess progress-sm">
                                                                <Progress bar color="success" value="4.98"></Progress>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <Row className="align-items-center g-2">
                                                    ...
                                                    <div className="col">
                                                        <div className="p-1">
                                                            <div className="progress animated-progess progress-sm">
                                                                <Progress bar color="danger" value="7.42"></Progress>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-auto">
                                ...
                                <CardBody className="p-4 border-top border-top-dashed">
                                    ...
                                    <div className="text-center mt-3">
                                        <Link to="#" className="link-primary">
                                            View All Reviews <i className="ri-arrow-right-line align-bottom ms-1"></i>
                                        </Link>
                                    </div>
                                </CardBody>
                                <CardBody className="p-4 border-top border-top-dashed">
                                    ...
                                    <form action="#">
                                        ...
                                        <div className="text-end">
                                            <button type="submit" className="btn btn-primary">
                                                <i className="ri-mail-send-line align-bottom me-1"></i> Send Messages
                                            </button>
                                        </div>
                                    </form>
                                </CardBody>
                        ...
                        <div className="col-xxl-9">
                            ...
                            <Row className="g-4 mb-3">
                                <div className="col-sm-auto">
                                    <div>
                                        <a href="apps-ecommerce-add-product" className="btn btn-primary">
