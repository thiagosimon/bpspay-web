                ...
                <Container>
                        ...
                        <Col lg={8}>
                            <div className="text-center mb-5">
                                ...
                                <div className="hstack gap-2 justify-content-center">
                                    ...
                                    <button type="button" className="btn btn-soft-secondary btn-label rounded-pill"><i className="ri-twitter-line label-icon align-middle rounded-pill fs-16 me-2"></i> Send Us Tweet</button>
                                </div>
                            </div>
                        </Col>
                    </Row>
                    ...
                    <Row className="g-lg-5 g-4">
                        <Col lg={6}>
                            <div className="d-flex align-items-center mb-2">
                                <div className="flex-shrink-0 me-1">
                                    <i className="ri-question-line fs-24 align-middle text-primary me-1"></i>
                                </div>
                        ...
                        <Col lg={6}>
                            <div className="d-flex align-items-center mb-2">
                                <div className="flex-shrink-0 me-1">
                                    <i className="ri-shield-keyhole-line fs-24 align-middle text-primary me-1"></i>
                                </div>
                                <div className="flex-grow-1">
