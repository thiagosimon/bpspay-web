...
//import action
import { getProjectList as onGetProjectList, deleteProjectList as onDeleteProjectList } from '../../../store/actions'
...
const List = () => {
    ...
    return (
        <React.Fragment>
            ...
            <DeleteModal show={deleteModal} onDeleteClick={() => handleDeleteProjectList()} onCloseClick={() => setDeleteModal(false)} />
                                        ...
                                        <div className="d-flex flex-column h-100">
                                            ...
                                            <div className="mt-auto">
                                                <div className="d-flex mb-2">
                                                    ...
                                                    <div className="flex-shrink-0">
                                                        <div>
                                                            <i className="ri-list-check align-bottom me-1 text-muted"></i> {item.number}
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <Col sm={6}>
                    <div>
                        <p className="mb-sm-0 text-muted">
                            Showing <span className="fw-semibold">1</span> to <span className="fw-semibold">10</span> of{' '}
