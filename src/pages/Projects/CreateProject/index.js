                    ...
                    <Row>
                            ...
                            <Card>
                                <CardBody>
                                    <div className="mb-3">
                                        ...
                                        <Input type="text" className="form-control" id="project-title-input" placeholder="Enter project title" />
                                    </div>
                                    ...
                                    <Row>
                                        <Col lg={4}>
                                            <div className="mb-3 mb-lg-0">
                                                ...
                                                <select className="form-select" data-choices data-choices-search-false id="choices-priority-input">
                                        ...
                                        <Col lg={4}>
                                            <div className="mb-3 mb-lg-0">
                                                ...
                                                <select className="form-select" data-choices data-choices-search-false id="choices-status-input">
                                        ...
                                        <Col lg={4}>
                                            <div>
                                                <Label htmlFor="datepicker-deadline-input" className="form-label">
                                                    Deadline
                                                </Label>
                                                <Flatpickr
                                                    className="form-control"
                        ...
                        <Col lg={4}>
                            <div className="card">
                                ...
                                <CardBody>
                                    <div>
                                        <Label htmlFor="choices-privacy-status-input" className="form-label">
                                            Status
                                        </Label>
                                        <select className="form-select" data-choices data-choices-search-false id="choices-privacy-status-input">
                            ...
                            <div className="card">
                                ...
                                <CardBody>
                                    <div className="mb-3">
                                        ...
                                        <select className="form-select" data-choices data-choices-search-false id="choices-categories-input">
                                ...
                                <CardBody>
                                    ...
                                    <div>
                                        ...
                                        <div className="avatar-group">
                                            ...
                                            >
                                                <div className="avatar-xs">
                                                    <div className="avatar-title rounded-circle text-bg-primary">S</div>
                                                </div>
                                            </Link>
                                            <Link
                                                to="#"
