                    ...
                    <Card className="overflow-hidden">
                        <CardBody className="bg-marketplace d-flex">
                            <div className="flex-grow-1">
                                <h4 className="fs-18 lh-base mb-0">Discover, Collect, Sell and Create <br /> your own <span className="text-primary">NFTs.</span> </h4>
                                ...
                                <div className="d-flex gap-3 mt-4">
                                    ...
                                    <Link to="/#" className="btn btn-soft-primary">Create Your Own</Link>
                                </div>
                            </div>
