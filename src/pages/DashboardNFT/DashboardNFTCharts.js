...
const PopularityChart = ({ dataColors }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="bar" height={260} className="apex-charts mt-n4" />
        </React.Fragment>
    )
}
...
const TopArtworkChart = ({ seriesData, chartsColor }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={[...seriesData]} type="line" height="30" width="80" className="apex-charts" />
        </React.Fragment>
    )
}
