...
const AxisChart = ({ dataColors }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="area" height="320" className="apex-charts" />
        </React.Fragment>
    )
}
...
const GithubStyleCharts = ({ dataColors }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="area" height="120" className="apex-charts" />
        </React.Fragment>
    )
}
...
const GithubStyleCharts1 = ({ dataColors }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="area" height="170" className="apex-charts" />
        </React.Fragment>
    )
}
