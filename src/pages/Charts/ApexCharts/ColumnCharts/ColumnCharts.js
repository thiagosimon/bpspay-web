...
const BasicColumn = ({ dataColors }) => {
    ...
    return <ReactApexChart className="apex-charts" dir="ltr" series={series} options={options} type="bar" height={350} />
}
...
const ColumnMarker = ({ dataColors }) => {
    ...
    return <ReactApexChart dir="ltr" className="apex-charts" options={options} series={series} type="bar" height={350} />
}
...
const RangeColumn = ({ dataColors }) => {
    ...
    return <ReactApexChart className="apex-charts" dir="ltr" options={options} series={series} type="rangeBar" height={335} />
}
...
const Quarter = ({ dataColors }) => {
    ...
    return <ReactApexChart className="apex-charts" dir="ltr" series={series} options={optionsQuarter} type="bar" height={330} />
}
