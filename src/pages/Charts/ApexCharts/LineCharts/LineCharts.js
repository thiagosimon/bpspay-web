...
const ZoomableTimeseries = ({ dataColors }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="area" height="350" className="apex-charts" />
        </React.Fragment>
    )
}
...
const LinewithDataLabels = ({ dataColors }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="line" height="380" className="apex-charts" />
        </React.Fragment>
    )
}
...
const BrushChart = ({ dataColors }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="line" height={220} className="apex-charts" />
        </React.Fragment>
    )
}
...
const BrushChart1 = ({ dataColors }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="area" height={130} className="apex-charts" />
        </React.Fragment>
    )
}
...
const ChartSyncingLine = ({ dataColors }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="line" height="160" className="apex-charts" />
        </React.Fragment>
    )
}
...
const ChartSyncingArea = ({ dataColors }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="area" height="160" className="apex-charts" />
        </React.Fragment>
    )
}
