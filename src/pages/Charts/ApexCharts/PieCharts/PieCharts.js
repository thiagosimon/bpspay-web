...
const SimplePie = ({ dataColors }) => {
    ...
    return <ReactApexChart dir="ltr" className="apex-charts" series={series} options={options} type="pie" height={267.7} />
}
...
const SimpleDonut = ({ dataColors }) => {
    ...
    return <ReactApexChart dir="ltr" className="apex-charts" series={series} options={options} type="donut" height={267.7} />
}
...
const MonochromePie = ({ dataColors }) => {
    ...
    return <ReactApexChart dir="ltr" className="apex-charts" series={series} options={options} type="pie" height={287.7} />
}
