...
const BasicHeatmap = ({ dataColors }) => {
    ...
    return <ReactApexChart dir="ltr" className="apex-charts" series={series} options={options} type="heatmap" height={450} />
}
...
const ColorRange = ({ dataColors }) => {
    ...
    return <ReactApexChart dir="ltr" className="apex-charts" series={series} options={options} type="heatmap" height={350} />
}
