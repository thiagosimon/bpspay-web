...
const Basic = ({ dataColors }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="candlestick" height={350} className="apex-charts" />
        </React.Fragment>
    )
}
...
const ComboCandlestick = ({ dataColors }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="candlestick" height={200} className="apex-charts" />
        </React.Fragment>
    )
}
...
const ComboCandlestick1 = ({ dataColors }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" options={options} series={series} type="bar" height={150} className="apex-charts" />
        </React.Fragment>
    )
}
...
export { Basic, ComboCandlestick, ComboCandlestick1, Category, CandlestickLine }
