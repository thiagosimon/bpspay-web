...
const Basic = ({ dataColors }) => {
    ...
    return (
        <React.Fragment>
            <ReactApexChart dir="ltr" className="apex-charts" options={options} series={series} type="rangeBar" height={350} />
        </React.Fragment>
    )
}
...
export { Basic, DifferentColor, MultiSeries, Advanced, MultipleSeries }
