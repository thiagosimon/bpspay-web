                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>table-dark</code> class to set dark color table body and <code>table-success</code> class to set
                                        success color table body respectively. use <code>table-</code> class with different color variation to set
                                        required table body color.
                                    </p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                    ...
                    <Row>
                        ...
                        <Col xl={6}>
                            <div className="card">
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        You can also put the <code>&lt;caption&gt;</code> attribute on the top of the table with{' '}
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Example of basic table nesting. Border styles, active styles, and table variants are not inherited by nested
                                        tables.
                                    </p>
                                    <div className="live-preview">
                                        <div className="table-responsive">
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <div className="card-body">
                                    <p className="text-muted">
                                        Use <code>table-</code> class with below-mentioned color variation class within &lt;tr&gt; to set color on
                                        table row.
                                    </p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        <code>&lt;tbody&gt;</code> inherit their alignment from <code>&lt;table&gt;</code> and are aligned to the the
                                        top by default. Use the vertical align classes to re-align where needed.
                                    </p>
                                    <div className="live-preview">
                                        <div className="table-responsive">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            demonstrate how the vertical alignment works in the preceding cells. Use the vertical
                                                            align classes to re-align where needed. inherit their alignment from and are aligned to
                                                            the the top by default.
                                                        </td>
                                                    </tr>
                    ...
                    <Row>
                        <Col xl={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>table-responsive</code> class to make any table responsive across all viewports. Responsive tables
                                        allow tables to be scrolled horizontally with ease.
                                    </p>
                                    <div className="live-preview">
                                        <div className="table-responsive">
                                            <Table className="align-middle table-nowrap mb-0">
