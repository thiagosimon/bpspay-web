                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Rater-js is a star rating widget for the browser. here are the various examples of rating shown below with
                                        variation.
                                    </p>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div dir="ltr">
                                                                ...
                                                                <Badge color="info" className="ratingnum align-middle ms-2">
                                                                    {customize}
                                                                </Badge>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div dir="ltr">
                                                                ...
                                                                <Button
                                                                    ...
                                                                    size="sm"
                                                                    className="ms-2"
                                                                    onClick={() => setreset('mdi mdi-star-outline text-muted ')}
                                                                >
                                                                    Reset
                                                                </Button>
                                                            </div>
                                    ...
                                    <div className="d-none code-view">
                                        <pre>
                                            <code className="language-markup">
                                                &lt;div data-simplebar style=&quot;max-height: 220px;&quot;&gt; ... &lt;/div&gt;
                                            </code>
                                        </pre>
                                    </div>
                                </CardBody>
