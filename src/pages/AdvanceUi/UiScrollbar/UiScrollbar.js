                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>data-simplebar</code> attribute and add <code>max-height: **px</code> to set default scrollbar.
                                    </p>
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>data-simplebar-auto-hide="false"</code> attribute and add <code>max-height: **px</code> to show
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>data-simplebar-direction="rtl"</code> attribute and add <code>max-height: **px</code> to set
                            ...
                            <Row>
                                <Col xl={4} lg={6}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">
                                                Use <code>data-simplebar-track="primary"</code> attribute to set primary color simplebar track.
                                            </p>
                                                ...
                                                <SimpleBar autoHide={false} className="simplebar-track-primary" style={{ maxHeight: '275px' }}>
                                                    <Link to="#!" className="text-reset notification-item d-block dropdown-item">
                                                        <div className="d-flex">
                                                            ...
                                                            <div className="flex-grow-1 text-muted">
                                                                <p className="m-0">
                                                                    Your <span className="fw-semibold text-dark">Elite</span> author Graphic
                                                    ...
                                                    <Link to="#!" className="text-reset notification-item d-block dropdown-item">
                                                        <div className="d-flex">
                                                            ...
                                                            <div className="flex-grow-1 text-muted">
                                                                <p className="m-0">
                                                                    You have received <span className="fw-semibold text-success">20</span> new
                                ...
                                <Col xl={4} lg={6}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">
                                                Use <code>data-simplebar-track="secondary"</code> attribute to set secondary color simplebar track.
                                            </p>
                                                    ...
                                                    <div className="list-group list-group-flush">
                                                            ...
                                                            <div className="d-flex align-items-start">
                                                                <div className="flex-shrink-0 align-self-center me-3">
                                                                    <div className="avatar-xs">
                                                                        <span className="avatar-title rounded-circle bg-light text-primary">M</span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <Link to="#" className="list-group-item text-muted py-3">
                                                            <div className="d-flex align-items-start">
                                                                <div className="flex-shrink-0 align-self-center me-3">
                                                                    <div className="avatar-xs">
                                                                        <span className="avatar-title rounded-circle bg-light text-primary">D</span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <Link to="#" className="list-group-item text-muted py-3">
                                                            <div className="d-flex align-items-start">
                                                                <div className="flex-shrink-0 align-self-center me-3">
                                                                    <div className="avatar-xs">
                                                                        <span className="avatar-title rounded-circle bg-light text-primary">P</span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <Link to="#" className="list-group-item text-muted py-3">
                                                            <div className="d-flex align-items-start">
                                                                <div className="flex-shrink-0 align-self-center me-3">
                                                                    <div className="avatar-xs">
                                                                        <span className="avatar-title rounded-circle bg-light text-primary">T</span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <Link to="#" className="list-group-item text-muted py-3">
                                                            <div className="d-flex align-items-start">
                                                                <div className="flex-shrink-0 align-self-center me-3">
                                                                    <div className="avatar-xs">
                                                                        <span className="avatar-title rounded-circle bg-light text-primary">C</span>
                                                                    </div>
                                                                </div>
                                ...
                                <Col xl={4} lg={6}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">
                                                Use <code>data-simplebar-track="success"</code> attribute to set success color simplebar track.
                                            </p>
                                ...
                                <Col xl={4} lg={6}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">
                                                Use <code>data-simplebar-track="info"</code> attribute to set info color simplebar track.
                                            </p>
                                ...
                                <Col xl={4} lg={6}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">
                                                Use <code>data-simplebar-track="warning"</code> attribute to set warning color simplebar track.
                                            </p>
                                ...
                                <Col xl={4} lg={6}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">
                                                Use <code>data-simplebar-track="danger"</code> attribute to set danger color simplebar track.
                                            </p>
                                ...
                                <Col xl={4} lg={6}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">
                                                Use <code>data-simplebar-track="dark"</code> attribute to set dark color simplebar track.
                                            </p>
                                                    ...
                                                    <ul className="list-group list-group-flush">
                                                        <li className="list-group-item">
                                                            <div>
                                                                <div className="d-flex align-items-start">
                                                                    <div className="flex-grow-1">
                                                                        <Badge color="success" className="bg-gradient mb-2">
                                                        ...
                                                        <li className="list-group-item">
                                                            <div>
                                                                ...
                                                                <p className="text-muted mb-4">
                                                                    Ut enim ad minima veniam, quis nostrum ullam corporis suscipit consequatur nisi ut
                                                                </p>
                                                                <div className="d-flex align-items-start">
                                                                    <div className="flex-grow-1">
