...
import { Row, Col, Card, CardBody, FormGroup, Button, Label, Input, Container, FormFeedback, Form, InputGroup } from 'reactstrap'
// Formik validation
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        you’ll see a slightly different style of feedback.While these feedback styles cannot be styled with CSS, you
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Block-level or inline-level form text can be created using <code>.form-text</code>.
                                    </p>
                                                ...
                                                <Col md="4">
                                                    <div className="mb-3 position-relative">
                                                        ...
                                                        <div
                                                            ...
                                                            id="validate1"
                                                        >
                                                            {validation['fnm'] === true ? 'Looks good!' : 'Please Enter Valid First Name'}
                                                        </div>
                                                    </div>
                                                </Col>
                                                <Col md="4">
                                                    <div className="mb-3 position-relative">
                                                        ...
                                                        <div
                                                            ...
                                                            id="validate2"
                                                        >
                                                            {validation['lnm'] === true ? 'Looks good!' : 'Please Enter Valid Last Name'}
                                                        </div>
                                                    </div>
                                                </Col>
                                                <Col md="4">
                                                ...
                                                <Col md="6">
                                                    <div className="mb-3 position-relative">
                                                        ...
                                                        <div
                                                            ...
                                                            id="validate5"
                                                        >
                                                            {validation['stateV'] === true ? 'Looks good!' : 'Please provide a valid state.'}
                                                        </div>
                                                    </div>
                                                </Col>
                                            </Row>
