                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        <span className="fw-medium">
                                            Requires the <code>$enable-grid-classes</code> Sass variable to be enabled
                                        </span>{' '}
                                        (on by default).
                                    </p>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <div className="card-body">
                                    <p className="text-muted">
                                        By adding{' '}
                                        <Link to="/docs/5.1/layout/gutters/" className="text-decoration-underline">
                                            gutter modifier classes
                                        </Link>
                                        , you can have control over the gutter width in as well the inline as block direction.{' '}
                                        <span className="fw-medium">
                                            Also requires the <code>$enable-grid-classes</code> Sass variable to be enabled
                                        </span>{' '}
                                        (on by default).
                                    </p>
                                    <div className="live-preview">
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Example of vertical form using <code>form-control</code> class. No need to specify row and col class to create
                                        vertical form.
                                    </p>
                                    <div className="live-preview">
                                        <Form action="#">
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        <code>col-*-*</code> class to specify the width of your labels and controls. Be sure to add{' '}
                                        <code>col-form-label</code> class to your <code>&lt;label&gt;</code>s as well so they’re vertically centered
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>col-form-label-sm</code> class to set small size form label or <code>col-form-label-lg</code> class
                                        to set large size form label to &lt;label&gt;. No such class is required for the default size form label.
                                    </p>
                                    <div className="live-preview">
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <div className="card-body">
                                    <p className="text-muted">
                                        Use <code>col-sm-</code> class with required size value to set column size as per your requirement.
                                    </p>
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            <Col sm={6}>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Change <code>col</code> class to <code>col-auto</code> class so that your columns only take up as much space
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>form-floating</code> class to enable floating labels with Bootstrap’s textual form fields.
                                    </p>
                                    <div className="live-preview">
                                        <Form action="#">
                                            <Row className="g-3">
