                                        ...
                                        <TabContent activeTab={activeTab}>
                                            ...
                                            <TabPane tabId={2}>
                                                <div>
                                                    ...
                                                    <div>
                                                        <Label className="form-label" htmlFor="gen-info-description-input">
                                                            Description
                                                        </Label>
                                                        <Input
                                                            type="textarea"
                                        ...
                                        <TabContent activeTab={activeArrowTab}>
                                            <TabPane id="steparrow-gen-info" tabId={4}>
                                                <div>
                                                    ...
                                                    <div className="mb-3">
                                                        <Label className="form-label" htmlFor="steparrow-gen-info-password-input">
                                                            Password
                                                        </Label>
                                                        <Input
                                                            type="password"
                                                    ...
                                                    <div>
                                                        <Label className="form-label" htmlFor="steparrow-gen-info-confirm-password-input">
                                                            Confirm Password
                                                        </Label>
                                                        <Input
                                                            type="password"
                                            ...
                                            <TabPane id="steparrow-description-info" tabId={5}>
                                                <div>
                                                    ...
                                                    <div>
                                                        <Label className="form-label" htmlFor="des-info-description-input">
                                                            Description
                                                        </Label>
                                                        <textarea
                                                            className="form-control"
                                                    ...
                                                    <TabContent activeTab={activeVerticalTab}>
                                                        ...
                                                        <TabPane tabId={9}>
                                                            ...
                                                            <div className="d-flex align-items-start gap-3 mt-4">
                                                                ...
                                                                >
                                                                    <i className="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i> Order
                                                                    Complete
                                                                </button>
                                                            </div>
                                                        </TabPane>
