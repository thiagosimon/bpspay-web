                            ...
                            <Card>
                                ...
                                <div className="card-body">
                                    <p className="text-muted">
                                        Use <code>form-control-lg</code> class to set large size input and Use <code>form-control-sm</code> class to
                                        set small size input. No class is needed for default size input.
                                    </p>
                                    <div className="live-preview">
                                        ...
                                        <Row className="align-items-center g-3">
                                            ...
                                            <Col lg={4}>
                                                <div>
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>multiple</code> attribute within the input attribute to select multiple files.
                                                    </p>
                                            ...
                                            <Col lg={4}>
                                                <div>
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>disabled</code> attribute within the input attribute to disable the file input.
                                                    </p>
                                        ...
                                        <Row className="mt-4 align-items-center g-3">
                                            ...
                                            <Col lg={4}>
                                                <div>
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>form-control-sm</code> class within the form-control class to set a small size file
                                                        input.
                                                    </p>
                                            ...
                                            <Col lg={4}>
                                                <div>
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>form-control </code>class and <code>type="file"</code> attribute within the input
                                            ...
                                            <Col lg={4}>
                                                <div>
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>form-control-lg</code> class within the form-control class to set a large size file
                                                        input.
                                                    </p>
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <div>
                                            ...
                                            <p className="text-muted">
                                                Use <code>input-group</code> class to div element which contains input attribute to wrap a default
                                                input in the group.
                                            </p>
                                            <Row className="g-3">
                                                <Col lg={6}>
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <p className="text-muted">
                                                Input groups wrap by default via <code>flex-wrap: wrap</code> in order to accommodate custom form
                                                field validation within an input group. You may disable this with <code>flex-nowrap</code> class.
                                            </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <div className="card-body">
                                    <p className="text-muted">
                                        Use <code>input-group-sm</code> class to set a small size input group and <code>input-group-lg</code> class to
                                        input-group class to set a large size input group respectively. no such class is required for a default size
                                        input group.
                                    </p>
                                    <div className="live-preview">
                                        <Row className="align-items-center g-3">
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <p className="text-muted">
                                        ...
                                        input groups with a single <code>&lt;input&gt;</code>.
                                    </p>
                                    <div className="live-preview">
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    <div className="live-preview">
                                        <div>
                                            <p className="text-muted">
                                                Use any checkbox, radio, or button option within an input group’s addon instead of text. We recommend
                                                adding <code>mt-0</code> class to the <code>form-check-input</code> when there’s no visible text next
                                                to the input.
                                            </p>
                                            <Row className="g-3">
                                                <Col lg={6}>
                                            ...
                                            <Row className="g-3">
                                                <Col lg={6}>
                                                    <UncontrolledDropdown className="input-group">
                                                        <DropdownToggle tag="button" className="btn btn-primary" type="button">
                                                            Dropdown
                                                        </DropdownToggle>
                                                        <DropdownMenu>
                                                            <li>
                                                ...
                                                <Col lg={12}>
                                                    <UncontrolledDropdown className="input-group">
                                                        ...
                                                        <DropdownMenu>
                                                            ...
                                                            <li>
                                                                <DropdownItem>Another action before</DropdownItem>
                                                            </li>
                                                            <li>
                                                                <DropdownItem>Something else here</DropdownItem>
                                                            </li>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <div className="card-body">
                                    <p className="text-muted">
                                        Input groups include support for custom selects and custom file inputs. Browser default versions of these are
                                        not supported.
                                    </p>
                                    <div className="live-preview">
                                        <div>
