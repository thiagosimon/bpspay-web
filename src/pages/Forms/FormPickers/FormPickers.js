                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <div className="mt-3">
                                                    ...
                                                    <p className="text-muted">
                                                        Set <code>data-provider="flatpickr" data-date-format="d M, Y" data-multiple-date="true"</code>{' '}
                                                        attribute.
                                                    </p>
                                                    <Flatpickr
                                                        className="form-control"
                                            ...
                                            <Col lg={6}>
                                                <div className="mt-3">
                                                    ...
                                                    <p className="text-muted">
                                                        Set <code>data-provider="flatpickr" data-date-format="d M, Y" data-range-date="true"</code>{' '}
                                                        attribute.
                                                    </p>
                                                    <Flatpickr
                                                        className="form-control"
                                        ...
                                        <Row>
                                            ...
                                            <Col lg={6}>
                                                <div className="mt-3">
                                                    ...
                                                    <p className="text-muted">
                                                        Set <code>data-provider="flatpickr" data-date-format="d M, Y" data-week-number</code>{' '}
                                                        attribute.
                                                    </p>
                                                    <Flatpickr
                                                        className="form-control"
                                        ...
                                        <Row>
                                            ...
                                            <Col lg={6}>
                                                <div className="mt-3">
                                                    ...
                                                    <p className="text-muted">
                                                        Set <code>data-provider="timepickr" data-default-time="Your Default Time"</code> attribute.
                                                    </p>
                                                    <Flatpickr
                                                        className="form-control"
                                                        options={{
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <div className="mt-3">
                                                    <label className="form-label mb-0">Inline</label>
                                                    <p className="text-muted">
                                                        Set <code>data-provider="timepickr" data-time-inline="Your Default Time"</code> attribute.
                                                    </p>
                                                    <Flatpickr
                                                        className="form-control"
                                                        options={{
                                            ...
                                            <Row className="g-4">
                                                <Col lg={4} md={6}>
                                                    <div>
                                                        ...
                                                        {simple_color ? (
                                                            <ColorPicker saturationHeight={100} saturationWidth={100} value={color} onDrag={onDrag} />
                                                        ) : null}
                                                    </div>
                                                </Col>
                                                <Col lg={4} md={6}>
