                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        <code>js-example-data-array</code>, <code>js-example-templating</code>, <code>select-flag-templating</code>,
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Select2 will respond to the disabled attribute on <code>&lt;select&gt;</code> elements. You can also
                                        initialize Select2 with disabled: true to get the same effect.
                                    </p>
