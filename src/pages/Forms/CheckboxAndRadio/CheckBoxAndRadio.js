                                        ...
                                        <Row>
                                            <Col lg={4} md={6}>
                                                <div>
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>type="checkbox"</code> attribute to set a checkbox and add <code>checked</code>
                                            ...
                                            <Col lg={4} md={6}>
                                                <div className="mt-4 mt-md-0">
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>disabled</code> attribute to set a checkbox disabled and add <code>checked</code>{' '}
                                                        attribute to set a checkbox checked by default.
                                                    </p>
                                                    <div>
                                            ...
                                            <Col lg={4} md={6}>
                                                <div className="mt-4 mt-md-0">
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>form-check-right</code> class to form-check class to set a checkbox on the right
                                                        side.
                                                    </p>
                                                    <div className="form-check form-check-right mb-2">
                                                        <Input
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            ...
                                            <Col md={6}>
                                                <div className="mt-4 mt-md-0">
                                                    <p className="text-muted">
                                                        Use <code>form-check-outline</code> class and <code>form-check-</code> class with
                                                        below-mentioned color variation to set a color checkbox with outline.
                                                    </p>
                                        ...
                                        <Row>
                                            <Col lg={4} md={6}>
                                                <div>
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>type="radio"</code> attribute to set a radio button and add{' '}
                                                        <code>defaultChecked</code> attribute to set a radio checked by default.
                                                    </p>
                                                    <div className="form-check mb-2">
                                                        <Input
                                                            className="form-check-input"
                                            ...
                                            <Col lg={4} md={6}>
                                                <div className="mt-4 mt-md-0">
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>form-check-right</code> class to form-check class to set a radio button on the right
                                                        side.
                                                    </p>
                                                    <div className="form-check form-check-right mb-2">
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col md={6}>
                                                <div>
                                                    <p className="text-muted">
                                                        Use <code>form-check-</code> class with below-mentioned color variation to set a color radio.
                                                    </p>
                                            ...
                                            <Col md={6}>
                                                <div className="mt-4 mt-md-0">
                                                    <p className="text-muted">
                                                        Use <code>form-check-outline</code> class and <code>form-check-</code> class with
                                                        below-mentioned color variation to set a color radio with outline.
                                                    </p>
                                        ...
                                        <Row>
                                                ...
                                                <div className="mt-4 mt-md-0">
                                                    ...
                                                    <div className="form-check form-switch">
                                                        <Input
                                                            ...
                                                            disabled
                                                        />
                                                        <Label className="form-check-label" htmlFor="flexSwitchCheckCheckedDisabled1">
                                            ...
                                            <Col lg={4} md={6}>
                                                <div className="mt-4 mt-md-0">
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>form-check-right</code> class to form-check class to set a switch button on the
                                                        right side.
                                                    </p>
                                                    <div>
                                                        <div className="form-check form-switch form-check-right mb-2">
                                                            <Input
                                                                ...
                                                                defaultChecked
                                                            />
                                                            <Label className="form-check-label" htmlFor="flexSwitchCheckRightDisabled">
                                                                Switch Right input
                                                            </Label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <div className="form-check form-switch form-check-right">
                                                            <Input
                                                                ...
                                                                disabled
                                                            />
                                                            <Label className="form-check-label" htmlFor="flexSwitchCheckCheckedDisabled2">
                                                                Disabled checked switch input
                                                            </Label>
                                                        </div>
                                                    </div>
                                            ...
                                            <Col lg={4} md={6}>
                                                <div className="mt-3">
                                                    ...
                                                    <p className="text-muted">
                                                        Use <code>form-switch-md</code> class to set a medium size switch button and
                                                        <code>form-switch-lg</code> class to form-check class to set a large size switch button
                                                        respectively. No such class is required for small size switch button.
                                                    </p>
                        ...
                        <div className="col-12">
                            <Card>
                                ...
                                <div className="card-body">
                                    <p className="text-muted">
                                        Use <code>form-check-</code> class with below-mentioned color variation to set a color switch.
                                    </p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col md={6}>
                                                ...
                                                <div>
                                                    <div className="form-check form-switch form-switch-danger mb-3">
                                                        <Input
                                                            ...
                                                            defaultChecked
                                                        />
                                                        <Label className="form-check-label" htmlFor="SwitchCheck5">
                                                            Switch Danger
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="form-check form-switch form-switch-dark mb-3">
                                                        <Input
                                                            ...
                                                            defaultChecked
                                                        />
                                                        <Label className="form-check-label" htmlFor="SwitchCheck7">
                                                            Switch Dark
                                                        </Label>
                                                    </div>
                                                </div>
                    ...
                    <Row>
                        <div className="col-12">
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>form-switch-custom</code> class &amp; <code>form-switch-</code> class with below-mentioned color
                                                ...
                                                <div>
                                                    <div className="form-check form-switch form-switch-custom form-switch-primary mb-3">
                                                        <Input
                                                            ...
                                                            defaultChecked
                                                        />
                                                        <Label className="form-check-label" htmlFor="SwitchCheck9">
                                                            Switch Primary
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="form-check form-switch form-switch-custom form-switch-secondary mb-3">
                                                        <Input
                                                            ...
                                                            defaultChecked
                                                        />
                                                        <Label className="form-check-label" htmlFor="SwitchCheck10">
                                                            Switch Secondary
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="form-check form-switch form-switch-custom form-switch-success mb-3">
                                                        <Input
                                                            ...
                                                            defaultChecked
                                                        />
                                                        <Label className="form-check-label" htmlFor="SwitchCheck11">
                                                            Switch Success
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="form-check form-switch form-switch-custom form-switch-warning mb-2 mb-md-0">
                                                        <Input
                                                            ...
                                                            defaultChecked
                                                        />
                                                        <Label className="form-check-label" htmlFor="SwitchCheck12">
                                                            Switch Warning
                                                        </Label>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="mt-4 mt-md-0">
                                                    <div className="form-check form-switch form-switch-custom form-switch-danger mb-3">
                                                        <Input
                                                            ...
                                                            defaultChecked
                                                        />
                                                        <Label className="form-check-label" htmlFor="SwitchCheck13">
                                                            Switch Danger
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="form-check form-switch form-switch-custom form-switch-info mb-3">
                                                        <Input
                                                            ...
                                                            defaultChecked
                                                        />
                                                        <Label className="form-check-label" htmlFor="SwitchCheck14">
                                                            Switch Info
                                                        </Label>
                                                    </div>
                                                    ...
                                                    <div className="form-check form-switch form-switch-custom form-switch-dark mb-3">
                                                        <Input
                                                            ...
                                                            defaultChecked
                                                        />
                                                        <Label className="form-check-label" htmlFor="SwitchCheck15">
                                                            Switch Dark
                                                        </Label>
                                                    </div>
                                                </div>
                    ...
                    <Row>
                        <Col xs={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>form-check-inline</code> class to form-check class to set horizontally align checkboxes, radios, or
                                        switches.
                                    </p>
                                    <div className="live-preview">
                                        <Row>
                                            ...
                                            <Col lg={4}>
                                                <div className="mt-4 mt-lg-0">
                                                    <div className="form-check form-switch form-check-inline" dir="ltr">
                                                        ...
                                                        <Label className="form-check-label" htmlFor="inlineswitch5">
                                                            1
                                                        </Label>
                                                    </div>
                                                    <div className="form-check form-switch form-check-inline" dir="ltr">
                                                        <Input type="checkbox" className="form-check-input" id="inlineswitch6" />
                                                        <Label className="form-check-label" htmlFor="inlineswitch6">
                                                            2
                                                        </Label>
                                                    </div>
                                                    <div className="form-check form-switch form-check-inline" dir="ltr">
                                                        <Input type="checkbox" className="form-check-input" id="inlineswitchdisabled2" disabled />
                                                        <Label className="form-check-label" htmlFor="inlineswitchdisabled2">
                                                            2
                                                        </Label>
                                                    </div>
                                                </div>
                    ...
                    <Row>
                        <Col xs={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Omit the wrapping, <code>form-check</code> class for checkboxes, radios, or switches that have no label text.
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Create button-like checkboxes and radio buttons by using <code>btn</code> styles rather than form-check-label
                                        class on the &lt;label&gt; elements. These toggle buttons can further be grouped in a{' '}
                                        <a href="https://getbootstrap.com/docs/5.1/components/button-group/">button group</a> if needed.
                                    </p>
                                    <div className="live-preview">
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Different variants of <code>btn</code> attribute, such as the various outlined styles, are supported.
                                    </p>
                                    <div className="live-preview">
                                        <div className="hstack gap-2 flex-wrap">
                                            ...
                                            <Label className="btn btn-outline-secondary" for="btn-check-2-outlined">
                                                Checked
                                            </Label>
