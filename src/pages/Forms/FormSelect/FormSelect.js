                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>&lt;select&gt;</code> attribute with numerous options to show value with choice's option.
                                    </p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>multiple</code> attribute to select multiple values and <code>size="your value"</code> attribute to
                                        show a number of choice option within a select area.{' '}
                                    </p>
                                    <div className="live-preview">
                                        <Row className="gy-4">
                                            <Col lg={6}>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use <code>form-select-sm</code> class to set small select size and <code>form-select-lg</code> class to
                                        form-select class to set large select size. No such class is required for default select size.
                                    </p>
                                    <div className="live-preview">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <div>
                                                ...
                                                <Select id={'dropdown'} options={options} isOptionDisabled={option => option.disabled}></Select>
                                            </div>
                                        </div>
                                    </div>
                                </CardBody>
