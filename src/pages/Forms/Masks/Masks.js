                                    ...
                                    <form action="#">
                                        <div>
                                            ...
                                            <Row>
                                                ...
                                                <Col xl={6}>
                                                    <div className="mb-3">
                                                        <label htmlFor="cleave-date-format" className="form-label">
                                                            Date Formatting
                                                        </label>
                                                        <Cleave
                                                            placeholder="MM/YY"
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <Row>
                                                <Col xl={6}>
                                                    <div className="mb-3">
                                                        <label htmlFor="cleave-ccard" className="form-label">
                                                            Credit Card
                                                        </label>
                                                        <Cleave
                                                ...
                                                <Col xl={6}>
                                                    <div className="mb-3">
                                                        <label htmlFor="cleave-delimiter" className="form-label">
                                                            Delimiter
                                                        </label>
                                                        <Cleave
                                            ...
                                            <Row>
                                                <Col xl={6}>
                                                    <div className="mb-3">
                                                        <label htmlFor="cleave-delimiters" className="form-label">
                                                            Delimiters
                                                        </label>
                                                        <Cleave
                                                ...
                                                <Col xl={6}>
                                                    <div className="mb-3">
                                                        <label htmlFor="cleave-prefix" className="form-label">
                                                            Prefix
                                                        </label>
                                                        <Cleave
                                                            options={{
