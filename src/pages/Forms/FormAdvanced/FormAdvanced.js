                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="input-step full-width">
                                                            <button
                                                                ...
                                                                className="minus"
                                                                onClick={() => {
                                                                    countDown(setfullwidthCounter, fullwidthCounter)
                                                                }}
                                                            >
                                                                –
                                                            </button>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="input-step full-width light">
                                                            <button
                                                                ...
                                                                className="minus"
                                                                onClick={() => {
                                                                    countDown(setlfullwidthCounter, lfullwidthCounter)
                                                                }}
                                                            >
                                                                –
                                                            </button>
                                                            ...
                                                            <button
                                                                ...
                                                                className="plus"
                                                                onClick={() => {
                                                                    countUP(setlfullwidthCounter, lfullwidthCounter)
                                                                }}
                                                            >
                                                                +
                                                            </button>
                                        ...
                                        <Row className="mt-4 pt-2">
                                            ...
                                            <div className="d-flex flex-wrap align-items-start gap-2">
                                                ...
                                                <div className="input-step step-secondary">
                                                    ...
                                                    <Input type="number" className="product-quantity" value={skyCounter} min="0" max="100" readOnly />
                                                    <button
                                                        type="button"
                                                        className="plus"
                                                        onClick={() => {
                                                ...
                                                <div className="input-step step-danger">
                                                    ...
                                                    <Input type="number" className="product-quantity" value={redCounter} min="0" max="100" readOnly />
                                                    <button
                                                        type="button"
                                                        className="plus"
                                                        onClick={() => {
